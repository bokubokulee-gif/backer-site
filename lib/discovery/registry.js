...
const { bilibili } = require('./providers/bilibili');
...
const { REVIEWED_SNAPSHOT_ADAPTERS } = require('./providers/reviewed-public-snapshot');
...
const ADAPTERS = Object.freeze({
  ...
  instagram,
  linkedin,
  tiktok: REVIEWED_SNAPSHOT_ADAPTERS.tiktok,
  spotify: REVIEWED_SNAPSHOT_ADAPTERS.spotify,
  soundcloud: REVIEWED_SNAPSHOT_ADAPTERS.soundcloud,
  patreon: REVIEWED_SNAPSHOT_ADAPTERS.patreon,
  kick: REVIEWED_SNAPSHOT_ADAPTERS.kick
});
