(function(){"use strict";let o=window.BACKER||null;const d=(t,e=document)=>e.querySelector(t),k=(t,e=document)=>Array.from(e.querySelectorAll(t)),v=d("#app");let M=null,T=null,L=null,P=null,S=null,H=!1,_=0,C="home";window.__backerLegacyArchiveAllowed=!0;function D(){return o||window.BACKER?(o=window.BACKER,Promise.resolve(o)):(S||(S=new Promise((t,e)=>{const s=document.createElement("script");s.src="js/data.js?v=20260821-lazy-1",s.dataset.backerLegacyData="true",s.onload=()=>{o=window.BACKER||null,o?t(o):e(new Error("Legacy homepage data did not initialize"))},s.onerror=()=>e(new Error("Legacy homepage data unavailable")),document.head.appendChild(s)}).catch(t=>{throw document.querySelectorAll("script[data-backer-legacy-data]").forEach(e=>e.remove()),S=null,t})),S)}async function O(){H||(await D(),I(),Le(),H=!0)}function ee(){const t=document.querySelector("link[data-backer-trades]");return t&&t.dataset.backerStyleReady==="true"?Promise.resolve():(t&&t.remove(),new Promise((e,s)=>{const a=document.createElement("link");a.rel="stylesheet",a.href="css/market.css?v=20260910-market-copy-1",a.dataset.backerTrades="true",a.media="print",a.onload=()=>{a.dataset.backerStyleReady="true",a.media="all",a.disabled=C!=="trades",e()},a.onerror=()=>s(new Error("Trades stylesheet unavailable")),document.head.appendChild(a)}))}function te(){const t=document.querySelector("link[data-backer-legacy-market]");return t&&t.dataset.backerStyleReady==="true"?Promise.resolve():(t&&t.remove(),new Promise((e,s)=>{const a=document.createElement("link");a.rel="stylesheet",a.href="css/market-archive.css?v=20260912-type-1",a.dataset.backerLegacyMarket="true",a.media="print",a.onload=()=>{a.dataset.backerStyleReady="true",a.media="all",a.disabled=C!=="market-archive",e()},a.onerror=()=>s(new Error("Legacy market archive stylesheet unavailable")),document.head.appendChild(a)}))}function R(t,e){return e==="catalog"&&window.BackerTradeCatalog||e==="store"&&window.BackerMarketDraftStore||e==="view"&&window.BackerMarket?Promise.resolve():new Promise((s,a)=>{const i=document.createElement("script");i.src=t,i.dataset.backerTrades=e,i.onload=s,i.onerror=()=>a(new Error("Trades script unavailable: "+t)),document.head.appendChild(i)})}function z(t,e){return e==="data"&&window.BACKER_MKT||e==="view"&&window.BackerLegacyMarket?Promise.resolve():new Promise((s,a)=>{const i=document.createElement("script");i.src=t,i.dataset.backerLegacyMarket=e,i.onload=s,i.onerror=()=>a(new Error("Legacy market archive script unavailable: "+t)),document.head.appendChild(i)})}function ae(){if(!M){const t=Promise.all([R("js/market-draft-store.js?v=20260821-1","store"),R("js/trades-catalog-model.js?v=20260826-perf-1","catalog")]);M=Promise.all([ee(),t]).then(()=>R("js/market.js?v=20260914-access-1","view")).then(()=>{T=null}).catch(e=>{throw document.querySelectorAll('link[data-backer-trades]:not([data-backer-style-ready="true"])').forEach(s=>s.remove()),document.querySelectorAll("script[data-backer-trades]").forEach(s=>s.remove()),M=null,e})}return M}function se(){return L||(L=D().then(()=>te()).then(()=>z("js/market-data.js?v=3","data")).then(()=>z("js/market-archive.js?v=20260914-access-1","view")).then(()=>{P=null}).catch(t=>{throw document.querySelectorAll('link[data-backer-legacy-market]:not([data-backer-style-ready="true"])').forEach(e=>e.remove()),document.querySelectorAll("script[data-backer-legacy-market]").forEach(e=>e.remove()),L=null,t})),L}function ie(t){var e=document.querySelector("link[data-backer-trades]"),s=document.querySelector("link[data-backer-legacy-market]");e&&e.dataset.backerStyleReady==="true"&&(e.disabled=t!=="trades"),s&&s.dataset.backerStyleReady==="true"&&(s.disabled=t!=="market-archive")}function F(t,e){try{window.BackerAnalytics&&window.BackerAnalytics.virtualPageView(t,e)}catch{}}function $(t,e){try{window.BackerAnalytics&&window.BackerAnalytics.track(t,e||{})}catch{}}function j(t){return t.split(" ").slice(0,2).map(e=>e[0]).join("").toUpperCase()}function A(t){return`radial-gradient(circle at 32% 26%, hsl(${t} 75% 64%), hsl(${t+28} 58% 34%) 62%, hsl(${t+10} 40% 16%))`}function N(t){return t>=80?{bg:"rgba(134,227,184,.92)",fg:"#0a1f15",word:"real"}:t>=60?{bg:"rgba(243,180,78,.92)",fg:"#241600",word:"mixed"}:{bg:"rgba(255,111,107,.95)",fg:"#2a0808",word:"flagged"}}function re(t){return t==="ok"?"#56d39a":t==="warn"?"#f3b44e":"#ff6f6b"}function oe(t,e,s){const a=d(".search-ex",t),i=d(".search-ex-toggle",t);a&&(a.addEventListener("click",r=>{const n=r.target.closest("[data-ex]");!n||!a.contains(n)||(e.value=n.dataset.ex,$("search_submitted",{source:"suggestion"}),s(n.dataset.ex))}),i&&i.addEventListener("click",()=>{const r=a.classList.toggle("is-paused");i.setAttribute("aria-pressed",String(r)),i.setAttribute("aria-label",r?"Resume scrolling suggestions":"Pause scrolling suggestions"),i.querySelector("span").textContent=r?"▶":"Ⅱ"}))}window.__backerBindPromptMarquee=oe;function ne(t){const e=t.getContext("2d"),s=t.width,a=t.height,i=+t.dataset.hue,r=e.createLinearGradient(0,0,s,a);r.addColorStop(0,`hsl(${i} 40% 11%)`),r.addColorStop(1,`hsl(${i+22} 32% 5%)`),e.fillStyle=r,e.fillRect(0,0,s,a);const n=e.createRadialGradient(s*.5,a*.08,0,s*.5,a*.08,a*1.25);n.addColorStop(0,`hsla(${i}, 82%, 60%, .34)`),n.addColorStop(1,"transparent"),e.fillStyle=n,e.fillRect(0,0,s,a),e.globalCompositeOperation="lighter";for(let c=0;c<64;c++){const l=Math.random()*s,f=1-Math.abs(l/s-.5)*2,h=a*(.3+Math.random()*.7),g=(a-h)*Math.random(),b=.6+Math.random()*1.9,m=Math.random()<.18?`hsl(${i+170} 55% 72%)`:`hsl(${i} 72% ${60+Math.random()*24}%)`,u=e.createLinearGradient(0,g,0,g+h);u.addColorStop(0,"transparent"),u.addColorStop(.5,m),u.addColorStop(1,"transparent"),e.globalAlpha=(.02+f*.13)*(.4+Math.random()),e.fillStyle=u,e.fillRect(l,g,b,h)}e.globalAlpha=1,e.globalCompositeOperation="source-over"}function ce(t){k(".cover-canvas",t).forEach(e=>{e.dataset.drawn||(ne(e),e.dataset.drawn="1")})}function le(t,e,s,a){const i=Math.min(...t),r=Math.max(...t),n=r-i||1,c=t.map((h,g)=>[a+g*(e-2*a)/(t.length-1),s-a-(h-i)/n*(s-2*a)]);let l=`M${c[0][0]},${c[0][1]}`;for(let h=1;h<c.length;h++){const[g,b]=c[h-1],[m,u]=c[h],X=(g+m)/2;l+=` C${X},${b} ${X},${u} ${m},${u}`}const f=`${l} L${c[c.length-1][0]},${s-a} L${c[0][0]},${s-a} Z`;return{line:l,area:f,last:c[c.length-1]}}function V(t,e){const r="g"+Math.random().toString(36).slice(2,7),{line:n,area:c,last:l}=le(t,640,200,16);return`<svg viewBox="0 0 640 200" preserveAspectRatio="none" style="width:100%;height:200px;display:block">
    ...
    </svg>`}function de(t,e){const a=2*Math.PI*52,i=a*(1-t/100),r="r"+Math.random().toString(36).slice(2,7);return`<svg viewBox="0 0 120 120" width="118" height="118">
    ...
    </svg>`}const K="backer_portfolio_v1";function I(){try{const t=localStorage.getItem(K);if(t)return JSON.parse(t)}catch{}return o.seedPortfolio.slice()}function ue(t){try{localStorage.setItem(K,JSON.stringify(t))}catch{}}function W(t){if(t.value!=null)return t.value;const e=o.byId(t.id);if(!e)return t.invested;const s=1+Math.max(-.25,Math.min(.6,(e.auth-70)/300+e.growth/900));return t.invested*s}function ve(t,e){if(!window.BackerAccessGate||window.BackerAccessGate.requireWaitlist("trade"))return;const s=I(),a=s.find(i=>i.id===t&&!i.value);a?a.invested+=e:s.push({id:t,invested:e,when:"Jun 2026"}),ue(s)}function pe(){const t=I();let e=0,s=0,a=0;t.forEach(c=>{e+=c.invested,s+=W(c);const l=o.byId(c.id);a+=l?l.auth:70});const i=e?(s-e)/e*100:0,r=i>=15?"A+":i>=8?"A":i>=3?"B+":i>=0?"B":"C",n=i>=15?7:i>=8?14:i>=3?28:45;return{p:t,inv:e,val:s,ret:i,grade:r,pctile:n,count:t.length}}function Ee(t){const e=o.fundPct(t),s=N(t.auth);return`<article class="ccard" data-creator="${t.id}">
      ...
      <div class="ccard-body">
        <div class="ccard-id">
          <span class="ccard-avatar" style="background:${A(t.hue)};display:grid;place-items:center;font-weight:700;font-size:14px;color:hsl(${t.hue} 60% 14%)">${j(t.name)}</span>
    ...
    </article>`}const x=d("#dock");function w(t){x&&k(".dock-btn",x).forEach(e=>e.classList.toggle("active",e.dataset.view===t)),document.dispatchEvent(new CustomEvent("backer:routechange",{detail:{view:t}})),window.BackerDock&&typeof window.BackerDock.refresh=="function"&&window.BackerDock.refresh()}async function p(t,e){if(t==="portfolio"){window.BackerAccessGate?window.BackerAccessGate.requireWaitlist("portfolio"):window.location.href="waitlist.html?source=portfolio";return}t==="market"&&(t="trades");const s=++_;let a=null;if(t==="trades")try{await ae()}catch(r){T=r}if(t==="market-archive")try{await se()}catch(r){P=r}if(t==="home"||t==="creator")try{await O()}catch(r){a=r}if(s===_){if(document.dispatchEvent(new CustomEvent("backer:routewillchange",{detail:{view:t}})),C=t,ie(t),t==="home"){if(a&&console.error(a),document.body.classList.remove("body-app","mkt-full","mkt2-full","search-full"),v.classList.add("hidden"),v.setAttribute("aria-hidden","true"),x){k(".dock-btn",x).forEach(r=>r.classList.remove("active"));var i=d(".dock-home",x);i&&i.classList.add("active")}try{history.replaceState(null,"",location.pathname)}catch{}window.scrollTo({top:0,behavior:"instant"}),F("home"),w("home");return}if(document.body.classList.add("body-app"),document.body.classList.toggle("mkt-full",t==="trades"||t==="market-archive"||t==="market2"),document.body.classList.toggle("mkt2-full",t==="market2"),document.body.classList.toggle("search-full",t==="search"),v.classList.remove("hidden"),v.setAttribute("aria-hidden","false"),window.scrollTo({top:0,behavior:"instant"}),t==="creator"&&a){v.innerHTML='<div class="mkt-fatal" role="alert"><b>This profile could not load.</b><span>Refresh to retry the legacy profile data.</span></div>';return}t==="market2"?(he(),w("market2")):t==="trades"?(U(),w("trades")):t==="market-archive"?(me(),w("trades")):t==="creator"?(fe(e),w("market2")):t==="portfolio"?(Y("investor"),w("portfolio")):t==="search"&&(xe(e||""),w("search")),F(t==="market-archive"?"market":t,e)}}window.__backerGo=p;function he(){if(window.BackerMarket2&&typeof window.BackerMarket2.render=="function"){try{if(!/^#market2(?:\?|$)/.test(location.hash)||new URLSearchParams(location.search).get("view")==="market"){var t=new URLSearchParams(location.search);t.delete("view"),history.replaceState(null,"",location.pathname+(t.toString()?"?"+t.toString():"")+"#market2")}}catch{}window.BackerMarket2.render(v);return}v.innerHTML='<div class="m2-fatal" role="alert"><b>Discovery could not load.</b><span>The creator discovery module did not initialize. Refresh this page to try again.</span></div>'}function U(){if(window.BackerMarket){window.BackerMarket.render(v);return}v.innerHTML='<div class="mkt-fatal" role="alert"><b>Trades could not load.</b><span>'+(T?"Refresh to retry the retained catalog, paper quotes, and your device-local proposals.":"The Trades module did not initialize.")+'</span><a href="backerdemo.html#market2">Return to Discovery</a></div>'}function me(){if(window.BackerLegacyMarket&&typeof window.BackerLegacyMarket.render=="function"){window.BackerLegacyMarket.render(v);var t=v.querySelector(".mkt");t&&(t.dataset.marketSurface="archive");return}v.innerHTML='<div class="mkt-fatal" role="alert"><b>The archived demo market could not load.</b><span>'+(P?"Refresh to retry the preserved fixture board.":"The preserved market module did not initialize.")+'</span><a href="backerdemo.html#trades">Open Trades</a></div>'}function fe(t){const e=o.byId(t);if(!e)return U();const s=re(e.velocity.status),a=e.auth>=80?"#56d39a":e.auth>=60?"#f3b44e":"#ff6f6b",i=N(e.auth),r=["Dec","Jan","Feb","Mar","Apr","May","Jun"],n=e.mkt?e.mkt.state:"OPEN",c=window.BACKER_MKT&&window.BACKER_MKT.STATES[n]||{label:"Open"},l=n==="OPEN"&&!!e.milestone,f=!!e.milestone&&["OPEN","OPENING_SOON","CLOSED","RESOLVED"].includes(n),h=e.milestone?e.milestone.money?o.money(e.milestone.target):o.fmt(e.milestone.target):"",g=e.milestone?e.milestone.money?o.money(e.milestone.current):o.fmt(e.milestone.current):"",b=e.milestone?Math.min(100,Math.round(e.milestone.current/e.milestone.target*100)):0,m=e.flagged?`<div class="metric" style="grid-column:1/-1;border-color:${e.flagged==="neg"?"rgba(255,111,107,.4)":"rgba(243,180,78,.4)"};background:${e.flagged==="neg"?"rgba(255,111,107,.07)":"rgba(243,180,78,.06)"}">
        ...
        <div class="detail-main">
          <div class="dhero">
            ...
            <div class="dhero-body">
              <span class="dhero-avatar" style="background:${A(e.hue)};display:grid;place-items:center;font-weight:700;font-size:30px;color:hsl(${e.hue} 60% 14%)">${j(e.name)}</span>
          ...
          <div class="score-block">
            ...
            <div class="auth-hero">
              <div class="ring">${de(e.auth,a)}<div class="ring-label"><b>${e.auth}%</b><span>authentic</span></div></div>
          ...
          ${f?`<div class="terms">
            ...
            <div class="term-row">
              ...
              <div class="term-info"><b>Reach ${h} ${e.milestone.metric} in ${e.milestone.deadline}</b><p>Currently ${g} · ${b}% of the way there</p>
    ...
    `)}function Y(t){if(!window.BackerAccessGate||window.BackerAccessGate.requireWaitlist("portfolio"))return;const e=pe(),s=`<div class="toggle"><button class="${t==="investor"?"active":""}" data-port-mode="investor">Investor</button><button class="${t==="creator"?"active":""}" data-port-mode="creator">Creator</button></div>`;if(t==="creator"){v.innerHTML=`
        ...
        </div>`,d("#applyRaise").addEventListener("click",$e);return}const a=["Oct","Nov","Dec","Jan","Feb","Mar","Now"],i=e.inv*.9,r=e.val,n=[i,i*1.04,r*.82,r*.88,r*.9,r*.97,r],c=e.p.map(l=>{const f=o.byId(l.id);if(!f)return"";const h=W(l),g=(h-l.invested)/l.invested*100,b=g>=0?"pos":"neg";return`<div class="holding" data-creator="${f.id}">
        <span class="holding-av" style="background:${A(f.hue)};display:grid;place-items:center;font-weight:700;font-size:13px;color:hsl(${f.hue} 60% 14%)">${j(f.name)}</span>
        <div class="holding-info"><b>${f.name}</b><span>${f.handle} · invested ${l.when}</span></div>
        <div class="holding-val"><b>${o.money(h)}</b><span class="${b}">${g>=0?"+":""}${g.toFixed(1)}%</span></div>
      </div>`}).join("");v.innerHTML=`
      <div class="app-head">
        <div style="display:flex;align-items:center;gap:16px">
          <span class="dhero-avatar" style="width:60px;height:60px;border-radius:16px;background:${A(210)};display:grid;place-items:center;font-weight:700;font-size:22px;color:hsl(210 60% 16%);border:none">C</span>
      ...
      </div>`}function $e(){!window.BackerAccessGate||window.BackerAccessGate.requireWaitlist("create")||q(`
      <button class="modal-x" data-close aria-label="Close"><svg viewBox="0 0 24 24" class="ic"><path d="M18 6 6 18M6 6l12 12"/></svg></button>
    ...
    `)}function xe(t){if(window.BackerSearch&&typeof window.BackerSearch.render=="function"){window.BackerSearch.render(v,t);return}v.innerHTML=`
      ...
      </div>`}const y=d("#modalRoot");function q(t){y.innerHTML=`<div class="modal">${t}</div>`,y.classList.remove("hidden"),y.setAttribute("aria-hidden","false")}function B(){y.classList.add("hidden"),y.setAttribute("aria-hidden","true"),y.innerHTML=""}y.addEventListener("click",t=>{t.target===y&&B()});const G=d("#toast");let J;function E(t,e){G.innerHTML=`<svg viewBox="0 0 24 24" class="ic" style="color:${e==="warn"?"var(--warn)":"var(--pos)"}">${e==="warn"?'<path d="M12 9v4M12 17h0M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z"/>':'<path d="M20 6 9 17l-5-5"/>'}</svg>${t}`,G.classList.add("show"),clearTimeout(J),J=setTimeout(()=>G.classList.remove("show"),2600)}window.__backerToast=E,document.addEventListener("click",t=>{const e=t.target,s=e.closest("[data-close]"),a=e.closest("[data-confirm]"),i=e.closest("[data-back-creator]"),r=e.closest("[data-creator]"),n=e.closest("[data-view]"),c=e.closest('[data-nav="home"]'),l=e.closest('#navLinks a[href^="#"]'),f=e.closest("[data-scroll]"),h=e.closest("[data-port-mode]"),g=e.closest("[data-raise-submit]"),b=e.closest("[data-share]");if(a){if(!window.BackerAccessGate||window.BackerAccessGate.requireWaitlist("trade"))return;const m=o.byId(a.dataset.confirm),u=parseFloat(a.dataset.amt);ve(m.id,u),$("market_position_completed",{creator_id:m.id,instrument:"milestone",source:"creator"}),we(m,u),E(`Position opened in ${m.name.split(" ")[0]}`);return}if(!(g&&(!window.BackerAccessGate||window.BackerAccessGate.requireWaitlist("create")))){if(i){ke(o.byId(i.dataset.backCreator));return}if(b){E("Share link copied to clipboard");try{navigator.clipboard&&navigator.clipboard.writeText(location.href)}catch{}return}if(s&&n){B(),p(n.dataset.view);return}if(s){B();return}if(h){Y(h.dataset.portMode);return}if(l&&document.body.classList.contains("body-app")){t.preventDefault();const m=l.getAttribute("href").slice(1);p("home");try{history.replaceState(null,"",location.pathname+"#"+m)}catch{}requestAnimationFrame(()=>{const u=document.getElementById(m);u&&u.scrollIntoView({behavior:"smooth"})});return}if(c){t.preventDefault(),p("home");return}if(r&&!n){p("creator",r.dataset.creator);return}if(n){t.preventDefault(),p(n.dataset.view);return}if(f){t.preventDefault();const m=document.getElementById(f.dataset.scroll);m&&m.scrollIntoView({behavior:"smooth"});return}}}),document.addEventListener("keydown",t=>{t.key==="Escape"&&!y.classList.contains("hidden")&&B()});function Me(){const t=d("#heroSearch"),e=d("#heroSearchInput");t&&t.addEventListener("submit",i=>{i.preventDefault(),p("search",e.value.trim()||"high-retention creators about to break out")});const s=d("#heroPills"),a=d("#heroPillsToggle");s&&s.addEventListener("click",i=>{const r=i.target.closest("[data-q]");r&&($("search_submitted",{source:"suggestion"}),p("search",r.dataset.q))}),s&&a&&a.addEventListener("click",()=>{const i=s.classList.toggle("is-paused");a.setAttribute("aria-pressed",String(i)),a.setAttribute("aria-label",i?"Resume scrolling suggestions":"Pause scrolling suggestions"),a.querySelector("span").textContent=i?"▶":"Ⅱ"})}function Le(){const t=d("#scoreGrid");t&&(t.innerHTML=o.scoreDefs.map(e=>`
      ...
      </div>`).join(""))}function Se(){const t=d("#nav"),e=()=>t.classList.toggle("scrolled",window.scrollY>20);window.addEventListener("scroll",e,{passive:!0}),e()}function Ae(){const t=new IntersectionObserver(s=>{s.forEach(a=>{a.isIntersecting&&(a.target.classList.add("in"),t.unobserve(a.target))})},{threshold:.12,rootMargin:"0px 0px -40px 0px"}),e=()=>k("#site .reveal:not(.in)").forEach(s=>t.observe(s));e(),setTimeout(e,100)}function Be(){k(".typed").forEach(t=>{const e=t.dataset.typed;let s=0;const a=new IntersectionObserver(i=>{if(i[0].isIntersecting){a.disconnect();const r=()=>{t.textContent=e.slice(0,s++),s<=e.length&&setTimeout(r,38)};r()}},{threshold:.6});a.observe(t)})}function Q(){var t=new URLSearchParams(location.search).get("view");if(t==="market"||t==="trades")return p("trades"),!0;if(t==="market-archive")return p("market-archive"),!0;if(t==="market2")return p("market2"),!0;if(t==="search")return p("search",new URLSearchParams(location.search).get("q")||""),!0;if(/^#search(?:\?|$)/.test(location.hash)){var e=location.hash.indexOf("?"),s=new URLSearchParams(e>=0?location.hash.slice(e+1):"");return p("search",s.get("q")||""),!0}if(/^#market2(?:\?|$)/.test(location.hash)){var a=location.hash.indexOf("?"),i=new URLSearchParams(a>=0?location.hash.slice(a+1):"");if(i.get("focus")==="search")return p("search",i.get("q")||""),!0}return/^#trades(?:\?|$)/.test(location.hash)?(p("trades"),!0):/^#market2(?:\?|$)/.test(location.hash)?(p("market2"),!0):/^#market-archive(?:\?|$)/.test(location.hash)?(p("market-archive"),!0):/^#market(?:\?|$)/.test(location.hash)?(p("trades"),!0):!1}function Z(){Se(),Ae(),Me(),Be();var t=d(".dock-home");t&&t.classList.add("active");try{Q()||O().catch(e=>console.error(e))}catch{}}window.addEventListener("hashchange",()=>{try{Q()}catch{}}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Z):Z()})();
