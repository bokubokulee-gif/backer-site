...
`)}function Hf(e,t){let r;switch(t){case jl:r="Linear";break;case ql:r="Reinhard";break;case Yl:r="Cineon";break;case Ts:r="ACESFilmic";break;case Kl:r="AgX";break;case Zl:r="Neutral";break;case Jl:r="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),r="Linear"}return"vec3 "+e+"( vec3 color ) { return "+r+"ToneMapping( color ); }"}var Ma=new U;function Vf(){je.getLuminanceCoefficients(Ma);let e=Ma.x.toFixed(4),t=Ma.y.toFixed(4),r=Ma.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${e}, ${t}, ${r} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}function Kf(e){let t="SHADOWMAP_TYPE_BASIC";return e.shadowMapType===ys?t="SHADOWMAP_TYPE_PCF":e.shadowMapType===bl?t="SHADOWMAP_TYPE_PCF_SOFT":e.shadowMapType===Kt&&(t="SHADOWMAP_TYPE_VSM"),t}function Zf(e){let t="ENVMAP_TYPE_CUBE";if(e.envMap)switch(e.envMapMode){case Fr:case Br:t="ENVMAP_TYPE_CUBE";break;case Ni:t="ENVMAP_TYPE_CUBE_UV";break}return t}function $f(e){let t="ENVMAP_MODE_REFLECTION";return e.envMap&&e.envMapMode===Br&&(t="ENVMAP_MODE_REFRACTION"),t}function Qf(e){let t="ENVMAP_BLENDING_NONE";if(e.envMap)switch(e.combine){case Es:t="ENVMAP_BLENDING_MULTIPLY";break;case Wl:t="ENVMAP_BLENDING_MIX";break;case Xl:t="ENVMAP_BLENDING_ADD";break}return t}function em(e){let t=e.envMapCubeUVHeight;if(t===null)return null;let r=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,r),112)),texelHeight:i,maxMip:r}}function tm(e,t,r,i){let a=e.getContext(),n=r.defines,s=r.vertexShader,o=r.fragmentShader,l=Kf(r),h=Zf(r),c=$f(r),u=Qf(r),d=em(r),f=Gf(r),v=kf(n),_=a.createProgram(),m,p,b=r.glslVersion?"#version "+r.glslVersion+`
`:"";r.isRawShaderMaterial?(m=["#define SHADER_TYPE "+r.shaderType,"#define SHADER_NAME "+r.shaderName,v].filter(Ui).join(`
`),m.length>0&&(m+=`
`),p=["#define SHADER_TYPE "+r.shaderType,"#define SHADER_NAME "+r.shaderName,v].filter(Ui).join(`
`),p.length>0&&(p+=`
...
`].filter(Ui).join(`
`)),s=ds(s),s=Jo(s,r),s=Ko(s,r),o=ds(o),o=Jo(o,r),o=Ko(o,r),s=Zo(s),o=Zo(o),r.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`)+`
`+p);let M=b+m+s,T=b+p+o,D=jo(a,a.VERTEX_SHADER,M),w=jo(a,a.FRAGMENT_SHADER,T);a.attachShader(_,D),a.attachShader(_,w),r.index0AttributeName!==void 0?a.bindAttribLocation(_,0,r.index0AttributeName):r.morphTargets===!0&&a.bindAttribLocation(_,0,"position"),a.linkProgram(_);function A(P){if(e.debug.checkShaderErrors){let V=a.getProgramInfoLog(_)||"",F=a.getShaderInfoLog(D)||"",z=a.getShaderInfoLog(w)||"",K=V.trim(),j=F.trim(),Z=z.trim(),q=!0,ee=!0;if(a.getProgramParameter(_,a.LINK_STATUS)===!1)if(q=!1,typeof e.debug.onShaderError=="function")e.debug.onShaderError(a,_,D,w);else{let se=Yo(a,D,"vertex"),Me=Yo(a,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(_,a.VALIDATE_STATUS)+`
...
Program Info Log: `+K+`
`+se+`
`+Me)}else K!==""?console.warn("THREE.WebGLProgram: Program Info Log:",K):(j===""||Z==="")&&(ee=!1);ee&&(P.diagnostics={runnable:q,programLog:K,vertexShader:{log:j,prefix:m},fragmentShader:{log:Z,prefix:p}})}a.deleteShader(D),a.deleteShader(w),O=new ya(a,_),E=Wf(a,_)}let O;this.getUniforms=function(){return O===void 0&&A(this),O};let E;this.getAttributes=function(){return E===void 0&&A(this),E};let y=r.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return y===!1&&(y=a.getProgramParameter(_,Nf)),y},this.destroy=function(){i.releaseStatesOfProgram(this),a.deleteProgram(_),this.program=void 0},this.type=r.shaderType,this.name=r.shaderName,this.id=Of++,this.cacheKey=t,this.usedTimes=1,this.program=_,this.vertexShader=D,this.fragmentShader=w,this}var rm=0,im=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){let t=e.vertexShader,r=e.fragmentShader,i=this._getShaderStage(t),a=this._getShaderStage(r),n=this._getShaderCacheForMaterial(e);return n.has(i)===!1&&(n.add(i),i.usedTimes++),n.has(a)===!1&&(n.add(a),a.usedTimes++),this}remove(e){let t=this.materialCache.get(e);for(let r of t)r.usedTimes--,r.usedTimes===0&&this.shaderCache.delete(r.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){let t=this.materialCache,r=t.get(e);return r===void 0&&(r=new Set,t.set(e,r)),r}_getShaderStage(e){let t=this.shaderCache,r=t.get(e);return r===void 0&&(r=new am(e),t.set(e,r)),r}},am=class{constructor(e){this.id=rm++,this.code=e,this.usedTimes=0}};function nm(e,t,r,i,a,n,s){let o=new Zs,l=new im,h=new Set,c=[],u=a.logarithmicDepthBuffer,d=a.vertexTextures,f=a.precision,v={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(E){return h.add(E),E===0?"uv":`uv${E}`}function m(E,y,P,V,F){let z=V.fog,K=F.geometry,j=E.isMeshStandardMaterial?V.environment:null,Z=(E.isMeshStandardMaterial?r:t).get(E.envMap||j),q=Z&&Z.mapping===Ni?Z.image.height:null,ee=v[E.type];E.precision!==null&&(f=a.getMaxPrecision(E.precision),f!==E.precision&&console.warn("THREE.WebGLProgram.getParameters:",E.precision,"not supported, using",f,"instead."));let se=K.morphAttributes.position||K.morphAttributes.normal||K.morphAttributes.color,Me=se!==void 0?se.length:0,Ge=0;K.morphAttributes.position!==void 0&&(Ge=1),K.morphAttributes.normal!==void 0&&(Ge=2),K.morphAttributes.color!==void 0&&(Ge=3);let qe,k,re,Te;if(ee){let Je=Yt[ee];qe=Je.vertexShader,k=Je.fragmentShader}else qe=E.vertexShader,k=E.fragmentShader,l.update(E),re=l.getVertexShaderID(E),Te=l.getFragmentShaderID(E);let ce=e.getRenderTarget(),_e=e.state.buffers.depth.getReversed(),Le=F.isInstancedMesh===!0,Fe=F.isBatchedMesh===!0,Xe=!!E.map,R=!!E.matcap,et=!!Z,Ne=!!E.aoMap,Ye=!!E.lightMap,Ae=!!E.bumpMap,Ze=!!E.normalMap,Se=!!E.displacementMap,Pe=!!E.emissiveMap,ie=!!E.metalnessMap,ve=!!E.roughnessMap,ge=E.anisotropy>0,S=E.clearcoat>0,g=E.dispersion>0,L=E.iridescence>0,B=E.sheen>0,Y=E.transmission>0,X=ge&&!!E.anisotropyMap,de=S&&!!E.clearcoatMap,te=S&&!!E.clearcoatNormalMap,xe=S&&!!E.clearcoatRoughnessMap,be=L&&!!E.iridescenceMap,W=L&&!!E.iridescenceThicknessMap,ae=B&&!!E.sheenColorMap,Ce=B&&!!E.sheenRoughnessMap,pe=!!E.specularMap,le=!!E.specularColorMap,ze=!!E.specularIntensityMap,C=Y&&!!E.transmissionMap,he=Y&&!!E.thicknessMap,ne=!!E.gradientMap,Ee=!!E.alphaMap,Q=E.alphaTest>0,J=!!E.alphaHash,ye=!!E.extensions,Ue=hr;E.toneMapped&&(ce===null||ce.isXRRenderTarget===!0)&&(Ue=e.toneMapping);let st={shaderID:ee,shaderType:E.type,shaderName:E.name,vertexShader:qe,fragmentShader:k,defines:E.defines,customVertexShaderID:re,customFragmentShaderID:Te,isRawShaderMaterial:E.isRawShaderMaterial===!0,glslVersion:E.glslVersion,precision:f,batching:Fe,batchingColor:Fe&&F._colorsTexture!==null,instancing:Le,instancingColor:Le&&F.instanceColor!==null,instancingMorph:Le&&F.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:ce===null?e.outputColorSpace:ce.isXRRenderTarget===!0?ce.texture.colorSpace:zr,alphaToCoverage:!!E.alphaToCoverage,map:Xe,matcap:R,envMap:et,envMapMode:et&&Z.mapping,envMapCubeUVHeight:q,aoMap:Ne,lightMap:Ye,bumpMap:Ae,normalMap:Ze,displacementMap:d&&Se,emissiveMap:Pe,normalMapObjectSpace:Ze&&E.normalMapType===th,normalMapTangentSpace:Ze&&E.normalMapType===Fs,metalnessMap:ie,roughnessMap:ve,anisotropy:ge,anisotropyMap:X,clearcoat:S,clearcoatMap:de,clearcoatNormalMap:te,clearcoatRoughnessMap:xe,dispersion:g,iridescence:L,iridescenceMap:be,iridescenceThicknessMap:W,sheen:B,sheenColorMap:ae,sheenRoughnessMap:Ce,specularMap:pe,specularColorMap:le,specularIntensityMap:ze,transmission:Y,transmissionMap:C,thicknessMap:he,gradientMap:ne,opaque:E.transparent===!1&&E.blending===Nr&&E.alphaToCoverage===!1,alphaMap:Ee,alphaTest:Q,alphaHash:J,combine:E.combine,mapUv:Xe&&_(E.map.channel),aoMapUv:Ne&&_(E.aoMap.channel),lightMapUv:Ye&&_(E.lightMap.channel),bumpMapUv:Ae&&_(E.bumpMap.channel),normalMapUv:Ze&&_(E.normalMap.channel),displacementMapUv:Se&&_(E.displacementMap.channel),emissiveMapUv:Pe&&_(E.emissiveMap.channel),metalnessMapUv:ie&&_(E.metalnessMap.channel),roughnessMapUv:ve&&_(E.roughnessMap.channel),anisotropyMapUv:X&&_(E.anisotropyMap.channel),clearcoatMapUv:de&&_(E.clearcoatMap.channel),clearcoatNormalMapUv:te&&_(E.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:xe&&_(E.clearcoatRoughnessMap.channel),iridescenceMapUv:be&&_(E.iridescenceMap.channel),iridescenceThicknessMapUv:W&&_(E.iridescenceThicknessMap.channel),sheenColorMapUv:ae&&_(E.sheenColorMap.channel),sheenRoughnessMapUv:Ce&&_(E.sheenRoughnessMap.channel),specularMapUv:pe&&_(E.specularMap.channel),specularColorMapUv:le&&_(E.specularColorMap.channel),specularIntensityMapUv:ze&&_(E.specularIntensityMap.channel),transmissionMapUv:C&&_(E.transmissionMap.channel),thicknessMapUv:he&&_(E.thicknessMap.channel),alphaMapUv:Ee&&_(E.alphaMap.channel),vertexTangents:!!K.attributes.tangent&&(Ze||ge),vertexColors:E.vertexColors,vertexAlphas:E.vertexColors===!0&&!!K.attributes.color&&K.attributes.color.itemSize===4,pointsUvs:F.isPoints===!0&&!!K.attributes.uv&&(Xe||Ee),fog:!!z,useFog:E.fog===!0,fogExp2:!!z&&z.isFogExp2,flatShading:E.flatShading===!0&&E.wireframe===!1,sizeAttenuation:E.sizeAttenuation===!0,logarithmicDepthBuffer:u,reversedDepthBuffer:_e,skinning:F.isSkinnedMesh===!0,morphTargets:K.morphAttributes.position!==void 0,morphNormals:K.morphAttributes.normal!==void 0,morphColors:K.morphAttributes.color!==void 0,morphTargetsCount:Me,morphTextureStride:Ge,numDirLights:y.directional.length,numPointLights:y.point.length,numSpotLights:y.spot.length,numSpotLightMaps:y.spotLightMap.length,numRectAreaLights:y.rectArea.length,numHemiLights:y.hemi.length,numDirLightShadows:y.directionalShadowMap.length,numPointLightShadows:y.pointShadowMap.length,numSpotLightShadows:y.spotShadowMap.length,numSpotLightShadowsWithMaps:y.numSpotLightShadowsWithMaps,numLightProbes:y.numLightProbes,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:E.dithering,shadowMapEnabled:e.shadowMap.enabled&&P.length>0,shadowMapType:e.shadowMap.type,toneMapping:Ue,decodeVideoTexture:Xe&&E.map.isVideoTexture===!0&&je.getTransfer(E.map.colorSpace)===Ke,decodeVideoTextureEmissive:Pe&&E.emissiveMap.isVideoTexture===!0&&je.getTransfer(E.emissiveMap.colorSpace)===Ke,premultipliedAlpha:E.premultipliedAlpha,doubleSided:E.side===Zt,flipSided:E.side===xt,useDepthPacking:E.depthPacking>=0,depthPacking:E.depthPacking||0,index0AttributeName:E.index0AttributeName,extensionClipCullDistance:ye&&E.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ye&&E.extensions.multiDraw===!0||Fe)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:E.customProgramCacheKey()};return st.vertexUv1s=h.has(1),st.vertexUv2s=h.has(2),st.vertexUv3s=h.has(3),h.clear(),st}function p(E){let y=[];if(E.shaderID?y.push(E.shaderID):(y.push(E.customVertexShaderID),y.push(E.customFragmentShaderID)),E.defines!==void 0)for(let P in E.defines)y.push(P),y.push(E.defines[P]);return E.isRawShaderMaterial===!1&&(b(y,E),M(y,E),y.push(e.outputColorSpace)),y.push(E.customProgramCacheKey),y.join()}function b(E,y){E.push(y.precision),E.push(y.outputColorSpace),E.push(y.envMapMode),E.push(y.envMapCubeUVHeight),E.push(y.mapUv),E.push(y.alphaMapUv),E.push(y.lightMapUv),E.push(y.aoMapUv),E.push(y.bumpMapUv),E.push(y.normalMapUv),E.push(y.displacementMapUv),E.push(y.emissiveMapUv),E.push(y.metalnessMapUv),E.push(y.roughnessMapUv),E.push(y.anisotropyMapUv),E.push(y.clearcoatMapUv),E.push(y.clearcoatNormalMapUv),E.push(y.clearcoatRoughnessMapUv),E.push(y.iridescenceMapUv),E.push(y.iridescenceThicknessMapUv),E.push(y.sheenColorMapUv),E.push(y.sheenRoughnessMapUv),E.push(y.specularMapUv),E.push(y.specularColorMapUv),E.push(y.specularIntensityMapUv),E.push(y.transmissionMapUv),E.push(y.thicknessMapUv),E.push(y.combine),E.push(y.fogExp2),E.push(y.sizeAttenuation),E.push(y.morphTargetsCount),E.push(y.morphAttributeCount),E.push(y.numDirLights),E.push(y.numPointLights),E.push(y.numSpotLights),E.push(y.numSpotLightMaps),E.push(y.numHemiLights),E.push(y.numRectAreaLights),E.push(y.numDirLightShadows),E.push(y.numPointLightShadows),E.push(y.numSpotLightShadows),E.push(y.numSpotLightShadowsWithMaps),E.push(y.numLightProbes),E.push(y.shadowMapType),E.push(y.toneMapping),E.push(y.numClippingPlanes),E.push(y.numClipIntersection),E.push(y.depthPacking)}function M(E,y){o.disableAll(),y.supportsVertexTextures&&o.enable(0),y.instancing&&o.enable(1),y.instancingColor&&o.enable(2),y.instancingMorph&&o.enable(3),y.matcap&&o.enable(4),y.envMap&&o.enable(5),y.normalMapObjectSpace&&o.enable(6),y.normalMapTangentSpace&&o.enable(7),y.clearcoat&&o.enable(8),y.iridescence&&o.enable(9),y.alphaTest&&o.enable(10),y.vertexColors&&o.enable(11),y.vertexAlphas&&o.enable(12),y.vertexUv1s&&o.enable(13),y.vertexUv2s&&o.enable(14),y.vertexUv3s&&o.enable(15),y.vertexTangents&&o.enable(16),y.anisotropy&&o.enable(17),y.alphaHash&&o.enable(18),y.batching&&o.enable(19),y.dispersion&&o.enable(20),y.batchingColor&&o.enable(21),y.gradientMap&&o.enable(22),E.push(o.mask),o.disableAll(),y.fog&&o.enable(0),y.useFog&&o.enable(1),y.flatShading&&o.enable(2),y.logarithmicDepthBuffer&&o.enable(3),y.reversedDepthBuffer&&o.enable(4),y.skinning&&o.enable(5),y.morphTargets&&o.enable(6),y.morphNormals&&o.enable(7),y.morphColors&&o.enable(8),y.premultipliedAlpha&&o.enable(9),y.shadowMapEnabled&&o.enable(10),y.doubleSided&&o.enable(11),y.flipSided&&o.enable(12),y.useDepthPacking&&o.enable(13),y.dithering&&o.enable(14),y.transmission&&o.enable(15),y.sheen&&o.enable(16),y.opaque&&o.enable(17),y.pointsUvs&&o.enable(18),y.decodeVideoTexture&&o.enable(19),y.decodeVideoTextureEmissive&&o.enable(20),y.alphaToCoverage&&o.enable(21),E.push(o.mask)}function T(E){let y=v[E.type],P;if(y){let V=Yt[y];P=jh.clone(V.uniforms)}else P=E.uniforms;return P}function D(E,y){let P;for(let V=0,F=c.length;V<F;V++){let z=c[V];if(z.cacheKey===y){P=z,++P.usedTimes;break}}return P===void 0&&(P=new tm(e,y,E,n),c.push(P)),P}function w(E){if(--E.usedTimes===0){let y=c.indexOf(E);c[y]=c[c.length-1],c.pop(),E.destroy()}}function A(E){l.remove(E)}function O(){l.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:T,acquireProgram:D,releaseProgram:w,releaseShaderCache:A,programs:c,dispose:O}}function sm(){let e=new WeakMap;function t(s){return e.has(s)}function r(s){let o=e.get(s);return o===void 0&&(o={},e.set(s,o)),o}function i(s){e.delete(s)}function a(s,o,l){e.get(s)[o]=l}function n(){e=new WeakMap}return{has:t,get:r,remove:i,update:a,dispose:n}}function om(e,t){return e.groupOrder!==t.groupOrder?e.groupOrder-t.groupOrder:e.renderOrder!==t.renderOrder?e.renderOrder-t.renderOrder:e.material.id!==t.material.id?e.material.id-t.material.id:e.z!==t.z?e.z-t.z:e.id-t.id}function Qo(e,t){return e.groupOrder!==t.groupOrder?e.groupOrder-t.groupOrder:e.renderOrder!==t.renderOrder?e.renderOrder-t.renderOrder:e.z!==t.z?t.z-e.z:e.id-t.id}function el(){let e=[],t=0,r=[],i=[],a=[];function n(){t=0,r.length=0,i.length=0,a.length=0}function s(u,d,f,v,_,m){let p=e[t];return p===void 0?(p={id:u.id,object:u,geometry:d,material:f,groupOrder:v,renderOrder:u.renderOrder,z:_,group:m},e[t]=p):(p.id=u.id,p.object=u,p.geometry=d,p.material=f,p.groupOrder=v,p.renderOrder=u.renderOrder,p.z=_,p.group=m),t++,p}function o(u,d,f,v,_,m){let p=s(u,d,f,v,_,m);f.transmission>0?i.push(p):f.transparent===!0?a.push(p):r.push(p)}function l(u,d,f,v,_,m){let p=s(u,d,f,v,_,m);f.transmission>0?i.unshift(p):f.transparent===!0?a.unshift(p):r.unshift(p)}function h(u,d){r.length>1&&r.sort(u||om),i.length>1&&i.sort(d||Qo),a.length>1&&a.sort(d||Qo)}function c(){for(let u=t,d=e.length;u<d;u++){let f=e[u];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:r,transmissive:i,transparent:a,init:n,push:o,unshift:l,finish:c,sort:h}}function lm(){let e=new WeakMap;function t(i,a){let n=e.get(i),s;return n===void 0?(s=new el,e.set(i,[s])):a>=n.length?(s=new el,n.push(s)):s=n[a],s}function r(){e=new WeakMap}return{get:t,dispose:r}}function hm(){let e={};return{get:function(t){if(e[t.id]!==void 0)return e[t.id];let r;switch(t.type){case"DirectionalLight":r={direction:new U,color:new We};break;case"SpotLight":r={position:new U,direction:new U,color:new We,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":r={position:new U,color:new We,distance:0,decay:0};break;case"HemisphereLight":r={direction:new U,skyColor:new We,groundColor:new We};break;case"RectAreaLight":r={color:new We,position:new U,halfWidth:new U,halfHeight:new U};break}return e[t.id]=r,r}}}function cm(){let e={};return{get:function(t){if(e[t.id]!==void 0)return e[t.id];let r;switch(t.type){case"DirectionalLight":r={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Re};break;case"SpotLight":r={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Re};break;case"PointLight":r={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Re,shadowCameraNear:1,shadowCameraFar:1e3};break}return e[t.id]=r,r}}}var um=0;function dm(e,t){return(t.castShadow?2:0)-(e.castShadow?2:0)+(t.map?1:0)-(e.map?1:0)}function pm(e){let t=new hm,r=cm(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let h=0;h<9;h++)i.probe.push(new U);let a=new U,n=new ht,s=new ht;function o(h){let c=0,u=0,d=0;for(let E=0;E<9;E++)i.probe[E].set(0,0,0);let f=0,v=0,_=0,m=0,p=0,b=0,M=0,T=0,D=0,w=0,A=0;h.sort(dm);for(let E=0,y=h.length;E<y;E++){let P=h[E],V=P.color,F=P.intensity,z=P.distance,K=P.shadow&&P.shadow.map?P.shadow.map.texture:null;if(P.isAmbientLight)c+=V.r*F,u+=V.g*F,d+=V.b*F;else if(P.isLightProbe){for(let j=0;j<9;j++)i.probe[j].addScaledVector(P.sh.coefficients[j],F);A++}else if(P.isDirectionalLight){let j=t.get(P);if(j.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){let Z=P.shadow,q=r.get(P);q.shadowIntensity=Z.intensity,q.shadowBias=Z.bias,q.shadowNormalBias=Z.normalBias,q.shadowRadius=Z.radius,q.shadowMapSize=Z.mapSize,i.directionalShadow[f]=q,i.directionalShadowMap[f]=K,i.directionalShadowMatrix[f]=P.shadow.matrix,b++}i.directional[f]=j,f++}else if(P.isSpotLight){let j=t.get(P);j.position.setFromMatrixPosition(P.matrixWorld),j.color.copy(V).multiplyScalar(F),j.distance=z,j.coneCos=Math.cos(P.angle),j.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),j.decay=P.decay,i.spot[_]=j;let Z=P.shadow;if(P.map&&(i.spotLightMap[D]=P.map,D++,Z.updateMatrices(P),P.castShadow&&w++),i.spotLightMatrix[_]=Z.matrix,P.castShadow){let q=r.get(P);q.shadowIntensity=Z.intensity,q.shadowBias=Z.bias,q.shadowNormalBias=Z.normalBias,q.shadowRadius=Z.radius,q.shadowMapSize=Z.mapSize,i.spotShadow[_]=q,i.spotShadowMap[_]=K,T++}_++}else if(P.isRectAreaLight){let j=t.get(P);j.color.copy(V).multiplyScalar(F),j.halfWidth.set(P.width*.5,0,0),j.halfHeight.set(0,P.height*.5,0),i.rectArea[m]=j,m++}else if(P.isPointLight){let j=t.get(P);if(j.color.copy(P.color).multiplyScalar(P.intensity),j.distance=P.distance,j.decay=P.decay,P.castShadow){let Z=P.shadow,q=r.get(P);q.shadowIntensity=Z.intensity,q.shadowBias=Z.bias,q.shadowNormalBias=Z.normalBias,q.shadowRadius=Z.radius,q.shadowMapSize=Z.mapSize,q.shadowCameraNear=Z.camera.near,q.shadowCameraFar=Z.camera.far,i.pointShadow[v]=q,i.pointShadowMap[v]=K,i.pointShadowMatrix[v]=P.shadow.matrix,M++}i.point[v]=j,v++}else if(P.isHemisphereLight){let j=t.get(P);j.skyColor.copy(P.color).multiplyScalar(F),j.groundColor.copy(P.groundColor).multiplyScalar(F),i.hemi[p]=j,p++}}m>0&&(e.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=oe.LTC_FLOAT_1,i.rectAreaLTC2=oe.LTC_FLOAT_2):(i.rectAreaLTC1=oe.LTC_HALF_1,i.rectAreaLTC2=oe.LTC_HALF_2)),i.ambient[0]=c,i.ambient[1]=u,i.ambient[2]=d;let O=i.hash;(O.directionalLength!==f||O.pointLength!==v||O.spotLength!==_||O.rectAreaLength!==m||O.hemiLength!==p||O.numDirectionalShadows!==b||O.numPointShadows!==M||O.numSpotShadows!==T||O.numSpotMaps!==D||O.numLightProbes!==A)&&(i.directional.length=f,i.spot.length=_,i.rectArea.length=m,i.point.length=v,i.hemi.length=p,i.directionalShadow.length=b,i.directionalShadowMap.length=b,i.pointShadow.length=M,i.pointShadowMap.length=M,i.spotShadow.length=T,i.spotShadowMap.length=T,i.directionalShadowMatrix.length=b,i.pointShadowMatrix.length=M,i.spotLightMatrix.length=T+D-w,i.spotLightMap.length=D,i.numSpotLightShadowsWithMaps=w,i.numLightProbes=A,O.directionalLength=f,O.pointLength=v,O.spotLength=_,O.rectAreaLength=m,O.hemiLength=p,O.numDirectionalShadows=b,O.numPointShadows=M,O.numSpotShadows=T,O.numSpotMaps=D,O.numLightProbes=A,i.version=um++)}function l(h,c){let u=0,d=0,f=0,v=0,_=0,m=c.matrixWorldInverse;for(let p=0,b=h.length;p<b;p++){let M=h[p];if(M.isDirectionalLight){let T=i.directional[u];T.direction.setFromMatrixPosition(M.matrixWorld),a.setFromMatrixPosition(M.target.matrixWorld),T.direction.sub(a),T.direction.transformDirection(m),u++}else if(M.isSpotLight){let T=i.spot[f];T.position.setFromMatrixPosition(M.matrixWorld),T.position.applyMatrix4(m),T.direction.setFromMatrixPosition(M.matrixWorld),a.setFromMatrixPosition(M.target.matrixWorld),T.direction.sub(a),T.direction.transformDirection(m),f++}else if(M.isRectAreaLight){let T=i.rectArea[v];T.position.setFromMatrixPosition(M.matrixWorld),T.position.applyMatrix4(m),s.identity(),n.copy(M.matrixWorld),n.premultiply(m),s.extractRotation(n),T.halfWidth.set(M.width*.5,0,0),T.halfHeight.set(0,M.height*.5,0),T.halfWidth.applyMatrix4(s),T.halfHeight.applyMatrix4(s),v++}else if(M.isPointLight){let T=i.point[d];T.position.setFromMatrixPosition(M.matrixWorld),T.position.applyMatrix4(m),d++}else if(M.isHemisphereLight){let T=i.hemi[_];T.direction.setFromMatrixPosition(M.matrixWorld),T.direction.transformDirection(m),_++}}}return{setup:o,setupView:l,state:i}}function tl(e){let t=new pm(e),r=[],i=[];function a(c){h.camera=c,r.length=0,i.length=0}function n(c){r.push(c)}function s(c){i.push(c)}function o(){t.setup(r)}function l(c){t.setupView(r,c)}let h={lightsArray:r,shadowsArray:i,camera:null,lights:t,transmissionRenderTarget:{}};return{init:a,state:h,setupLights:o,setupLightsView:l,pushLight:n,pushShadow:s}}function fm(e){let t=new WeakMap;function r(a,n=0){let s=t.get(a),o;return s===void 0?(o=new tl(e),t.set(a,[o])):n>=s.length?(o=new tl(e),s.push(o)):o=s[n],o}function i(){t=new WeakMap}return{get:r,dispose:i}}var mm=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function _m(e,t,r){let i=new qn,a=new Re,n=new Re,s=new ot,o=new yc({depthPacking:eh}),l=new Mc,h={},c=r.maxTextureSize,u={[or]:xt,[xt]:or,[Zt]:Zt},d=new sr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Re},radius:{value:4}},vertexShader:mm,fragmentShader:gm}),f=d.clone();f.defines.HORIZONTAL_PASS=1;let v=new Bt;v.setAttribute("position",new Xt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let _=new bt(v,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ys;let p=this.type;this.render=function(w,A,O){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;let E=e.getRenderTarget(),y=e.getActiveCubeFace(),P=e.getActiveMipmapLevel(),V=e.state;V.setBlending(lr),V.buffers.depth.getReversed()?V.buffers.color.setClear(0,0,0,0):V.buffers.color.setClear(1,1,1,1),V.buffers.depth.setTest(!0),V.setScissorTest(!1);let F=p!==Kt&&this.type===Kt,z=p===Kt&&this.type!==Kt;for(let K=0,j=w.length;K<j;K++){let Z=w[K],q=Z.shadow;if(q===void 0){console.warn("THREE.WebGLShadowMap:",Z,"has no shadow.");continue}if(q.autoUpdate===!1&&q.needsUpdate===!1)continue;a.copy(q.mapSize);let ee=q.getFrameExtents();if(a.multiply(ee),n.copy(q.mapSize),(a.x>c||a.y>c)&&(a.x>c&&(n.x=Math.floor(c/ee.x),a.x=n.x*ee.x,q.mapSize.x=n.x),a.y>c&&(n.y=Math.floor(c/ee.y),a.y=n.y*ee.y,q.mapSize.y=n.y)),q.map===null||F===!0||z===!0){let Me=this.type!==Kt?{minFilter:Ut,magFilter:Ut}:{};q.map!==null&&q.map.dispose(),q.map=new Tr(a.x,a.y,Me),q.map.texture.name=Z.name+".shadowMap",q.camera.updateProjectionMatrix()}e.setRenderTarget(q.map),e.clear();let se=q.getViewportCount();for(let Me=0;Me<se;Me++){let Ge=q.getViewport(Me);s.set(n.x*Ge.x,n.y*Ge.y,n.x*Ge.z,n.y*Ge.w),V.viewport(s),q.updateMatrices(Z,Me),i=q.getFrustum(),T(A,O,q.camera,Z,this.type)}q.isPointLightShadow!==!0&&this.type===Kt&&b(q,O),q.needsUpdate=!1}p=this.type,m.needsUpdate=!1,e.setRenderTarget(E,y,P)};function b(w,A){let O=t.update(_);d.defines.VSM_SAMPLES!==w.blurSamples&&(d.defines.VSM_SAMPLES=w.blurSamples,f.defines.VSM_SAMPLES=w.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Tr(a.x,a.y)),d.uniforms.shadow_pass.value=w.map.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,e.setRenderTarget(w.mapPass),e.clear(),e.renderBufferDirect(A,null,O,d,_,null),f.uniforms.shadow_pass.value=w.mapPass.texture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,e.setRenderTarget(w.map),e.clear(),e.renderBufferDirect(A,null,O,f,_,null)}function M(w,A,O,E){let y=null,P=O.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(P!==void 0)y=P;else if(y=O.isPointLight===!0?l:o,e.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){let V=y.uuid,F=A.uuid,z=h[V];z===void 0&&(z={},h[V]=z);let K=z[F];K===void 0&&(K=y.clone(),z[F]=K,A.addEventListener("dispose",D)),y=K}if(y.visible=A.visible,y.wireframe=A.wireframe,E===Kt?y.side=A.shadowSide!==null?A.shadowSide:A.side:y.side=A.shadowSide!==null?A.shadowSide:u[A.side],y.alphaMap=A.alphaMap,y.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,y.map=A.map,y.clipShadows=A.clipShadows,y.clippingPlanes=A.clippingPlanes,y.clipIntersection=A.clipIntersection,y.displacementMap=A.displacementMap,y.displacementScale=A.displacementScale,y.displacementBias=A.displacementBias,y.wireframeLinewidth=A.wireframeLinewidth,y.linewidth=A.linewidth,O.isPointLight===!0&&y.isMeshDistanceMaterial===!0){let V=e.properties.get(y);V.light=O}return y}function T(w,A,O,E,y){if(w.visible===!1)return;if(w.layers.test(A.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&y===Kt)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,w.matrixWorld);let V=t.update(w),F=w.material;if(Array.isArray(F)){let z=V.groups;for(let K=0,j=z.length;K<j;K++){let Z=z[K],q=F[Z.materialIndex];if(q&&q.visible){let ee=M(w,q,E,y);w.onBeforeShadow(e,w,A,O,V,ee,Z),e.renderBufferDirect(O,null,V,ee,w,Z),w.onAfterShadow(e,w,A,O,V,ee,Z)}}}else if(F.visible){let z=M(w,F,E,y);w.onBeforeShadow(e,w,A,O,V,z,null),e.renderBufferDirect(O,null,V,z,w,null),w.onAfterShadow(e,w,A,O,V,z,null)}}let P=w.children;for(let V=0,F=P.length;V<F;V++)T(P[V],A,O,E,y)}function D(w){w.target.removeEventListener("dispose",D);for(let A in h){let O=h[A],E=w.target.uuid;E in O&&(O[E].dispose(),delete O[E])}}}var vm={[Ca]:Pa,[La]:Ia,[Ua]:Na,[Or]:Da,[Pa]:Ca,[Ia]:La,[Na]:Ua,[Da]:Or};function xm(e,t){function r(){let C=!1,he=new ot,ne=null,Ee=new ot(0,0,0,0);return{setMask:function(Q){ne!==Q&&!C&&(e.colorMask(Q,Q,Q,Q),ne=Q)},setLocked:function(Q){C=Q},setClear:function(Q,J,ye,Ue,st){st===!0&&(Q*=Ue,J*=Ue,ye*=Ue),he.set(Q,J,ye,Ue),Ee.equals(he)===!1&&(e.clearColor(Q,J,ye,Ue),Ee.copy(he))},reset:function(){C=!1,ne=null,Ee.set(-1,0,0,0)}}}function i(){let C=!1,he=!1,ne=null,Ee=null,Q=null;return{setReversed:function(J){if(he!==J){let ye=t.get("EXT_clip_control");J?ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.ZERO_TO_ONE_EXT):ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.NEGATIVE_ONE_TO_ONE_EXT),he=J;let Ue=Q;Q=null,this.setClear(Ue)}},getReversed:function(){return he},setTest:function(J){J?ce(e.DEPTH_TEST):_e(e.DEPTH_TEST)},setMask:function(J){ne!==J&&!C&&(e.depthMask(J),ne=J)},setFunc:function(J){if(he&&(J=vm[J]),Ee!==J){switch(J){case Ca:e.depthFunc(e.NEVER);break;case Pa:e.depthFunc(e.ALWAYS);break;case La:e.depthFunc(e.LESS);break;case Or:e.depthFunc(e.LEQUAL);break;case Ua:e.depthFunc(e.EQUAL);break;case Da:e.depthFunc(e.GEQUAL);break;case Ia:e.depthFunc(e.GREATER);break;case Na:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}Ee=J}},setLocked:function(J){C=J},setClear:function(J){Q!==J&&(he&&(J=1-J),e.clearDepth(J),Q=J)},reset:function(){C=!1,ne=null,Ee=null,Q=null,he=!1}}}function a(){let C=!1,he=null,ne=null,Ee=null,Q=null,J=null,ye=null,Ue=null,st=null;return{setTest:function(Je){C||(Je?ce(e.STENCIL_TEST):_e(e.STENCIL_TEST))},setMask:function(Je){he!==Je&&!C&&(e.stencilMask(Je),he=Je)},setFunc:function(Je,Ht,Vt){(ne!==Je||Ee!==Ht||Q!==Vt)&&(e.stencilFunc(Je,Ht,Vt),ne=Je,Ee=Ht,Q=Vt)},setOp:function(Je,Ht,Vt){(J!==Je||ye!==Ht||Ue!==Vt)&&(e.stencilOp(Je,Ht,Vt),J=Je,ye=Ht,Ue=Vt)},setLocked:function(Je){C=Je},setClear:function(Je){st!==Je&&(e.clearStencil(Je),st=Je)},reset:function(){C=!1,he=null,ne=null,Ee=null,Q=null,J=null,ye=null,Ue=null,st=null}}}let n=new r,s=new i,o=new a,l=new WeakMap,h=new WeakMap,c={},u={},d=new WeakMap,f=[],v=null,_=!1,m=null,p=null,b=null,M=null,T=null,D=null,w=null,A=new We(0,0,0),O=0,E=!1,y=null,P=null,V=null,F=null,z=null,K=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS),j=!1,Z=0,q=e.getParameter(e.VERSION);q.indexOf("WebGL")!==-1?(Z=parseFloat(/^WebGL (\d)/.exec(q)[1]),j=Z>=1):q.indexOf("OpenGL ES")!==-1&&(Z=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),j=Z>=2);let ee=null,se={},Me=e.getParameter(e.SCISSOR_BOX),Ge=e.getParameter(e.VIEWPORT),qe=new ot().fromArray(Me),k=new ot().fromArray(Ge);function re(C,he,ne,Ee){let Q=new Uint8Array(4),J=e.createTexture();e.bindTexture(C,J),e.texParameteri(C,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(C,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let ye=0;ye<ne;ye++)C===e.TEXTURE_3D||C===e.TEXTURE_2D_ARRAY?e.texImage3D(he,0,e.RGBA,1,1,Ee,0,e.RGBA,e.UNSIGNED_BYTE,Q):e.texImage2D(he+ye,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,Q);return J}let Te={};Te[e.TEXTURE_2D]=re(e.TEXTURE_2D,e.TEXTURE_2D,1),Te[e.TEXTURE_CUBE_MAP]=re(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),Te[e.TEXTURE_2D_ARRAY]=re(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),Te[e.TEXTURE_3D]=re(e.TEXTURE_3D,e.TEXTURE_3D,1,1),n.setClear(0,0,0,1),s.setClear(1),o.setClear(0),ce(e.DEPTH_TEST),s.setFunc(Or),Ae(!1),Ze(xs),ce(e.CULL_FACE),Ne(lr);function ce(C){c[C]!==!0&&(e.enable(C),c[C]=!0)}function _e(C){c[C]!==!1&&(e.disable(C),c[C]=!1)}function Le(C,he){return u[C]!==he?(e.bindFramebuffer(C,he),u[C]=he,C===e.DRAW_FRAMEBUFFER&&(u[e.FRAMEBUFFER]=he),C===e.FRAMEBUFFER&&(u[e.DRAW_FRAMEBUFFER]=he),!0):!1}function Fe(C,he){let ne=f,Ee=!1;if(C){ne=d.get(he),ne===void 0&&(ne=[],d.set(he,ne));let Q=C.textures;if(ne.length!==Q.length||ne[0]!==e.COLOR_ATTACHMENT0){for(let J=0,ye=Q.length;J<ye;J++)ne[J]=e.COLOR_ATTACHMENT0+J;ne.length=Q.length,Ee=!0}}else ne[0]!==e.BACK&&(ne[0]=e.BACK,Ee=!0);Ee&&e.drawBuffers(ne)}function Xe(C){return v!==C?(e.useProgram(C),v=C,!0):!1}let R={[yr]:e.FUNC_ADD,[Al]:e.FUNC_SUBTRACT,[Rl]:e.FUNC_REVERSE_SUBTRACT};R[Cl]=e.MIN,R[Pl]=e.MAX;let et={[Ll]:e.ZERO,[Ul]:e.ONE,[Dl]:e.SRC_COLOR,[Aa]:e.SRC_ALPHA,[zl]:e.SRC_ALPHA_SATURATE,[Fl]:e.DST_COLOR,[Nl]:e.DST_ALPHA,[Il]:e.ONE_MINUS_SRC_COLOR,[Ra]:e.ONE_MINUS_SRC_ALPHA,[Bl]:e.ONE_MINUS_DST_COLOR,[Ol]:e.ONE_MINUS_DST_ALPHA,[Hl]:e.CONSTANT_COLOR,[Vl]:e.ONE_MINUS_CONSTANT_COLOR,[Gl]:e.CONSTANT_ALPHA,[kl]:e.ONE_MINUS_CONSTANT_ALPHA};function Ne(C,he,ne,Ee,Q,J,ye,Ue,st,Je){if(C===lr){_===!0&&(_e(e.BLEND),_=!1);return}if(_===!1&&(ce(e.BLEND),_=!0),C!==wl){if(C!==m||Je!==E){if((p!==yr||T!==yr)&&(e.blendEquation(e.FUNC_ADD),p=yr,T=yr),Je)switch(C){case Nr:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case wa:e.blendFunc(e.ONE,e.ONE);break;case Ms:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case Ss:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",C);break}else switch(C){case Nr:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case wa:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case Ms:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Ss:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",C);break}b=null,M=null,D=null,w=null,A.set(0,0,0),O=0,m=C,E=Je}return}Q=Q||he,J=J||ne,ye=ye||Ee,(he!==p||Q!==T)&&(e.blendEquationSeparate(R[he],R[Q]),p=he,T=Q),(ne!==b||Ee!==M||J!==D||ye!==w)&&(e.blendFuncSeparate(et[ne],et[Ee],et[J],et[ye]),b=ne,M=Ee,D=J,w=ye),(Ue.equals(A)===!1||st!==O)&&(e.blendColor(Ue.r,Ue.g,Ue.b,st),A.copy(Ue),O=st),m=C,E=!1}function Ye(C,he){C.side===Zt?_e(e.CULL_FACE):ce(e.CULL_FACE);let ne=C.side===xt;he&&(ne=!ne),Ae(ne),C.blending===Nr&&C.transparent===!1?Ne(lr):Ne(C.blending,C.blendEquation,C.blendSrc,C.blendDst,C.blendEquationAlpha,C.blendSrcAlpha,C.blendDstAlpha,C.blendColor,C.blendAlpha,C.premultipliedAlpha),s.setFunc(C.depthFunc),s.setTest(C.depthTest),s.setMask(C.depthWrite),n.setMask(C.colorWrite);let Ee=C.stencilWrite;o.setTest(Ee),Ee&&(o.setMask(C.stencilWriteMask),o.setFunc(C.stencilFunc,C.stencilRef,C.stencilFuncMask),o.setOp(C.stencilFail,C.stencilZFail,C.stencilZPass)),Pe(C.polygonOffset,C.polygonOffsetFactor,C.polygonOffsetUnits),C.alphaToCoverage===!0?ce(e.SAMPLE_ALPHA_TO_COVERAGE):_e(e.SAMPLE_ALPHA_TO_COVERAGE)}function Ae(C){y!==C&&(C?e.frontFace(e.CW):e.frontFace(e.CCW),y=C)}function Ze(C){C!==El?(ce(e.CULL_FACE),C!==P&&(C===xs?e.cullFace(e.BACK):C===Tl?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):_e(e.CULL_FACE),P=C}function Se(C){C!==V&&(j&&e.lineWidth(C),V=C)}function Pe(C,he,ne){C?(ce(e.POLYGON_OFFSET_FILL),(F!==he||z!==ne)&&(e.polygonOffset(he,ne),F=he,z=ne)):_e(e.POLYGON_OFFSET_FILL)}function ie(C){C?ce(e.SCISSOR_TEST):_e(e.SCISSOR_TEST)}function ve(C){C===void 0&&(C=e.TEXTURE0+K-1),ee!==C&&(e.activeTexture(C),ee=C)}function ge(C,he,ne){ne===void 0&&(ee===null?ne=e.TEXTURE0+K-1:ne=ee);let Ee=se[ne];Ee===void 0&&(Ee={type:void 0,texture:void 0},se[ne]=Ee),(Ee.type!==C||Ee.texture!==he)&&(ee!==ne&&(e.activeTexture(ne),ee=ne),e.bindTexture(C,he||Te[C]),Ee.type=C,Ee.texture=he)}function S(){let C=se[ee];C!==void 0&&C.type!==void 0&&(e.bindTexture(C.type,null),C.type=void 0,C.texture=void 0)}function g(){try{e.compressedTexImage2D(...arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function L(){try{e.compressedTexImage3D(...arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function B(){try{e.texSubImage2D(...arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Y(){try{e.texSubImage3D(...arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function X(){try{e.compressedTexSubImage2D(...arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function de(){try{e.compressedTexSubImage3D(...arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function te(){try{e.texStorage2D(...arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function xe(){try{e.texStorage3D(...arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function be(){try{e.texImage2D(...arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function W(){try{e.texImage3D(...arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function ae(C){qe.equals(C)===!1&&(e.scissor(C.x,C.y,C.z,C.w),qe.copy(C))}function Ce(C){k.equals(C)===!1&&(e.viewport(C.x,C.y,C.z,C.w),k.copy(C))}function pe(C,he){let ne=h.get(he);ne===void 0&&(ne=new WeakMap,h.set(he,ne));let Ee=ne.get(C);Ee===void 0&&(Ee=e.getUniformBlockIndex(he,C.name),ne.set(C,Ee))}function le(C,he){let ne=h.get(he).get(C);l.get(he)!==ne&&(e.uniformBlockBinding(he,ne,C.__bindingPointIndex),l.set(he,ne))}function ze(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),s.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),c={},ee=null,se={},u={},d=new WeakMap,f=[],v=null,_=!1,m=null,p=null,b=null,M=null,T=null,D=null,w=null,A=new We(0,0,0),O=0,E=!1,y=null,P=null,V=null,F=null,z=null,qe.set(0,0,e.canvas.width,e.canvas.height),k.set(0,0,e.canvas.width,e.canvas.height),n.reset(),s.reset(),o.reset()}return{buffers:{color:n,depth:s,stencil:o},enable:ce,disable:_e,bindFramebuffer:Le,drawBuffers:Fe,useProgram:Xe,setBlending:Ne,setMaterial:Ye,setFlipSided:Ae,setCullFace:Ze,setLineWidth:Se,setPolygonOffset:Pe,setScissorTest:ie,activeTexture:ve,bindTexture:ge,unbindTexture:S,compressedTexImage2D:g,compressedTexImage3D:L,texImage2D:be,texImage3D:W,updateUBOMapping:pe,uniformBlockBinding:le,texStorage2D:te,texStorage3D:xe,texSubImage2D:B,texSubImage3D:Y,compressedTexSubImage2D:X,compressedTexSubImage3D:de,scissor:ae,viewport:Ce,reset:ze}}function ym(e,t,r,i,a,n,s){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new Re,c=new WeakMap,u,d=new WeakMap,f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(S,g){return f?new OffscreenCanvas(S,g):ji("canvas")}function _(S,g,L){let B=1,Y=ge(S);if((Y.width>L||Y.height>L)&&(B=L/Math.max(Y.width,Y.height)),B<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){let X=Math.floor(B*Y.width),de=Math.floor(B*Y.height);u===void 0&&(u=v(X,de));let te=g?v(X,de):u;return te.width=X,te.height=de,te.getContext("2d").drawImage(S,0,0,X,de),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Y.width+"x"+Y.height+") to ("+X+"x"+de+")."),te}else return"data"in S&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Y.width+"x"+Y.height+")."),S;return S}function m(S){return S.generateMipmaps}function p(S){e.generateMipmap(S)}function b(S){return S.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?e.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function M(S,g,L,B,Y=!1){if(S!==null){if(e[S]!==void 0)return e[S];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let X=g;if(g===e.RED&&(L===e.FLOAT&&(X=e.R32F),L===e.HALF_FLOAT&&(X=e.R16F),L===e.UNSIGNED_BYTE&&(X=e.R8)),g===e.RED_INTEGER&&(L===e.UNSIGNED_BYTE&&(X=e.R8UI),L===e.UNSIGNED_SHORT&&(X=e.R16UI),L===e.UNSIGNED_INT&&(X=e.R32UI),L===e.BYTE&&(X=e.R8I),L===e.SHORT&&(X=e.R16I),L===e.INT&&(X=e.R32I)),g===e.RG&&(L===e.FLOAT&&(X=e.RG32F),L===e.HALF_FLOAT&&(X=e.RG16F),L===e.UNSIGNED_BYTE&&(X=e.RG8)),g===e.RG_INTEGER&&(L===e.UNSIGNED_BYTE&&(X=e.RG8UI),L===e.UNSIGNED_SHORT&&(X=e.RG16UI),L===e.UNSIGNED_INT&&(X=e.RG32UI),L===e.BYTE&&(X=e.RG8I),L===e.SHORT&&(X=e.RG16I),L===e.INT&&(X=e.RG32I)),g===e.RGB_INTEGER&&(L===e.UNSIGNED_BYTE&&(X=e.RGB8UI),L===e.UNSIGNED_SHORT&&(X=e.RGB16UI),L===e.UNSIGNED_INT&&(X=e.RGB32UI),L===e.BYTE&&(X=e.RGB8I),L===e.SHORT&&(X=e.RGB16I),L===e.INT&&(X=e.RGB32I)),g===e.RGBA_INTEGER&&(L===e.UNSIGNED_BYTE&&(X=e.RGBA8UI),L===e.UNSIGNED_SHORT&&(X=e.RGBA16UI),L===e.UNSIGNED_INT&&(X=e.RGBA32UI),L===e.BYTE&&(X=e.RGBA8I),L===e.SHORT&&(X=e.RGBA16I),L===e.INT&&(X=e.RGBA32I)),g===e.RGB&&L===e.UNSIGNED_INT_5_9_9_9_REV&&(X=e.RGB9_E5),g===e.RGBA){let de=Y?Wi:je.getTransfer(B);L===e.FLOAT&&(X=e.RGBA32F),L===e.HALF_FLOAT&&(X=e.RGBA16F),L===e.UNSIGNED_BYTE&&(X=de===Ke?e.SRGB8_ALPHA8:e.RGBA8),L===e.UNSIGNED_SHORT_4_4_4_4&&(X=e.RGBA4),L===e.UNSIGNED_SHORT_5_5_5_1&&(X=e.RGB5_A1)}return(X===e.R16F||X===e.R32F||X===e.RG16F||X===e.RG32F||X===e.RGBA16F||X===e.RGBA32F)&&t.get("EXT_color_buffer_float"),X}function T(S,g){let L;return S?g===null||g===Er||g===fi?L=e.DEPTH24_STENCIL8:g===$t?L=e.DEPTH32F_STENCIL8:g===di&&(L=e.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Er||g===fi?L=e.DEPTH_COMPONENT24:g===$t?L=e.DEPTH_COMPONENT32F:g===di&&(L=e.DEPTH_COMPONENT16),L}function D(S,g){return m(S)===!0||S.isFramebufferTexture&&S.minFilter!==Ut&&S.minFilter!==Gt?Math.log2(Math.max(g.width,g.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?g.mipmaps.length:1}function w(S){let g=S.target;g.removeEventListener("dispose",w),O(g),g.isVideoTexture&&c.delete(g)}function A(S){let g=S.target;g.removeEventListener("dispose",A),y(g)}function O(S){let g=i.get(S);if(g.__webglInit===void 0)return;let L=S.source,B=d.get(L);if(B){let Y=B[g.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&E(S),Object.keys(B).length===0&&d.delete(L)}i.remove(S)}function E(S){let g=i.get(S);e.deleteTexture(g.__webglTexture);let L=S.source,B=d.get(L);delete B[g.__cacheKey],s.memory.textures--}function y(S){let g=i.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),i.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let B=0;B<6;B++){if(Array.isArray(g.__webglFramebuffer[B]))for(let Y=0;Y<g.__webglFramebuffer[B].length;Y++)e.deleteFramebuffer(g.__webglFramebuffer[B][Y]);else e.deleteFramebuffer(g.__webglFramebuffer[B]);g.__webglDepthbuffer&&e.deleteRenderbuffer(g.__webglDepthbuffer[B])}else{if(Array.isArray(g.__webglFramebuffer))for(let B=0;B<g.__webglFramebuffer.length;B++)e.deleteFramebuffer(g.__webglFramebuffer[B]);else e.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&e.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&e.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let B=0;B<g.__webglColorRenderbuffer.length;B++)g.__webglColorRenderbuffer[B]&&e.deleteRenderbuffer(g.__webglColorRenderbuffer[B]);g.__webglDepthRenderbuffer&&e.deleteRenderbuffer(g.__webglDepthRenderbuffer)}let L=S.textures;for(let B=0,Y=L.length;B<Y;B++){let X=i.get(L[B]);X.__webglTexture&&(e.deleteTexture(X.__webglTexture),s.memory.textures--),i.remove(L[B])}i.remove(S)}let P=0;function V(){P=0}function F(){let S=P;return S>=a.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+a.maxTextures),P+=1,S}function z(S){let g=[];return g.push(S.wrapS),g.push(S.wrapT),g.push(S.wrapR||0),g.push(S.magFilter),g.push(S.minFilter),g.push(S.anisotropy),g.push(S.internalFormat),g.push(S.format),g.push(S.type),g.push(S.generateMipmaps),g.push(S.premultiplyAlpha),g.push(S.flipY),g.push(S.unpackAlignment),g.push(S.colorSpace),g.join()}function K(S,g){let L=i.get(S);if(S.isVideoTexture&&ie(S),S.isRenderTargetTexture===!1&&S.isExternalTexture!==!0&&S.version>0&&L.__version!==S.version){let B=S.image;if(B===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(B.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Te(L,S,g);return}}else S.isExternalTexture&&(L.__webglTexture=S.sourceTexture?S.sourceTexture:null);r.bindTexture(e.TEXTURE_2D,L.__webglTexture,e.TEXTURE0+g)}function j(S,g){let L=i.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&L.__version!==S.version){Te(L,S,g);return}r.bindTexture(e.TEXTURE_2D_ARRAY,L.__webglTexture,e.TEXTURE0+g)}function Z(S,g){let L=i.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&L.__version!==S.version){Te(L,S,g);return}r.bindTexture(e.TEXTURE_3D,L.__webglTexture,e.TEXTURE0+g)}function q(S,g){let L=i.get(S);if(S.version>0&&L.__version!==S.version){ce(L,S,g);return}r.bindTexture(e.TEXTURE_CUBE_MAP,L.__webglTexture,e.TEXTURE0+g)}let ee={[Oi]:e.REPEAT,[Mr]:e.CLAMP_TO_EDGE,[Ba]:e.MIRRORED_REPEAT},se={[Ut]:e.NEAREST,[$l]:e.NEAREST_MIPMAP_NEAREST,[Fi]:e.NEAREST_MIPMAP_LINEAR,[Gt]:e.LINEAR,[za]:e.LINEAR_MIPMAP_NEAREST,[Sr]:e.LINEAR_MIPMAP_LINEAR},Me={[rh]:e.NEVER,[lh]:e.ALWAYS,[ih]:e.LESS,[zs]:e.LEQUAL,[ah]:e.EQUAL,[oh]:e.GEQUAL,[nh]:e.GREATER,[sh]:e.NOTEQUAL};function Ge(S,g){if(g.type===$t&&t.has("OES_texture_float_linear")===!1&&(g.magFilter===Gt||g.magFilter===za||g.magFilter===Fi||g.magFilter===Sr||g.minFilter===Gt||g.minFilter===za||g.minFilter===Fi||g.minFilter===Sr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(S,e.TEXTURE_WRAP_S,ee[g.wrapS]),e.texParameteri(S,e.TEXTURE_WRAP_T,ee[g.wrapT]),(S===e.TEXTURE_3D||S===e.TEXTURE_2D_ARRAY)&&e.texParameteri(S,e.TEXTURE_WRAP_R,ee[g.wrapR]),e.texParameteri(S,e.TEXTURE_MAG_FILTER,se[g.magFilter]),e.texParameteri(S,e.TEXTURE_MIN_FILTER,se[g.minFilter]),g.compareFunction&&(e.texParameteri(S,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(S,e.TEXTURE_COMPARE_FUNC,Me[g.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Ut||g.minFilter!==Fi&&g.minFilter!==Sr||g.type===$t&&t.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||i.get(g).__currentAnisotropy){let L=t.get("EXT_texture_filter_anisotropic");e.texParameterf(S,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,a.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy}}}function qe(S,g){let L=!1;S.__webglInit===void 0&&(S.__webglInit=!0,g.addEventListener("dispose",w));let B=g.source,Y=d.get(B);Y===void 0&&(Y={},d.set(B,Y));let X=z(g);if(X!==S.__cacheKey){Y[X]===void 0&&(Y[X]={texture:e.createTexture(),usedTimes:0},s.memory.textures++,L=!0),Y[X].usedTimes++;let de=Y[S.__cacheKey];de!==void 0&&(Y[S.__cacheKey].usedTimes--,de.usedTimes===0&&E(g)),S.__cacheKey=X,S.__webglTexture=Y[X].texture}return L}function k(S,g,L){return Math.floor(Math.floor(S/L)/g)}function re(S,g,L,B){let Y=S.updateRanges;if(Y.length===0)r.texSubImage2D(e.TEXTURE_2D,0,0,0,g.width,g.height,L,B,g.data);else{Y.sort((be,W)=>be.start-W.start);let X=0;for(let be=1;be<Y.length;be++){let W=Y[X],ae=Y[be],Ce=W.start+W.count,pe=k(ae.start,g.width,4),le=k(W.start,g.width,4);ae.start<=Ce+1&&pe===le&&k(ae.start+ae.count-1,g.width,4)===pe?W.count=Math.max(W.count,ae.start+ae.count-W.start):(++X,Y[X]=ae)}Y.length=X+1;let de=e.getParameter(e.UNPACK_ROW_LENGTH),te=e.getParameter(e.UNPACK_SKIP_PIXELS),xe=e.getParameter(e.UNPACK_SKIP_ROWS);e.pixelStorei(e.UNPACK_ROW_LENGTH,g.width);for(let be=0,W=Y.length;be<W;be++){let ae=Y[be],Ce=Math.floor(ae.start/4),pe=Math.ceil(ae.count/4),le=Ce%g.width,ze=Math.floor(Ce/g.width),C=pe;e.pixelStorei(e.UNPACK_SKIP_PIXELS,le),e.pixelStorei(e.UNPACK_SKIP_ROWS,ze),r.texSubImage2D(e.TEXTURE_2D,0,le,ze,C,1,L,B,g.data)}S.clearUpdateRanges(),e.pixelStorei(e.UNPACK_ROW_LENGTH,de),e.pixelStorei(e.UNPACK_SKIP_PIXELS,te),e.pixelStorei(e.UNPACK_SKIP_ROWS,xe)}}function Te(S,g,L){let B=e.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(B=e.TEXTURE_2D_ARRAY),g.isData3DTexture&&(B=e.TEXTURE_3D);let Y=qe(S,g),X=g.source;r.bindTexture(B,S.__webglTexture,e.TEXTURE0+L);let de=i.get(X);if(X.version!==de.__version||Y===!0){r.activeTexture(e.TEXTURE0+L);let te=je.getPrimaries(je.workingColorSpace),xe=g.colorSpace===cr?null:je.getPrimaries(g.colorSpace),be=g.colorSpace===cr||te===xe?e.NONE:e.BROWSER_DEFAULT_WEBGL;e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,g.flipY),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),e.pixelStorei(e.UNPACK_ALIGNMENT,g.unpackAlignment),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);let W=_(g.image,!1,a.maxTextureSize);W=ve(g,W);let ae=n.convert(g.format,g.colorSpace),Ce=n.convert(g.type),pe=M(g.internalFormat,ae,Ce,g.colorSpace,g.isVideoTexture);Ge(B,g);let le,ze=g.mipmaps,C=g.isVideoTexture!==!0,he=de.__version===void 0||Y===!0,ne=X.dataReady,Ee=D(g,W);if(g.isDepthTexture)pe=T(g.format===gi,g.type),he&&(C?r.texStorage2D(e.TEXTURE_2D,1,pe,W.width,W.height):r.texImage2D(e.TEXTURE_2D,0,pe,W.width,W.height,0,ae,Ce,null));else if(g.isDataTexture)if(ze.length>0){C&&he&&r.texStorage2D(e.TEXTURE_2D,Ee,pe,ze[0].width,ze[0].height);for(let Q=0,J=ze.length;Q<J;Q++)le=ze[Q],C?ne&&r.texSubImage2D(e.TEXTURE_2D,Q,0,0,le.width,le.height,ae,Ce,le.data):r.texImage2D(e.TEXTURE_2D,Q,pe,le.width,le.height,0,ae,Ce,le.data);g.generateMipmaps=!1}else C?(he&&r.texStorage2D(e.TEXTURE_2D,Ee,pe,W.width,W.height),ne&&re(g,W,ae,Ce)):r.texImage2D(e.TEXTURE_2D,0,pe,W.width,W.height,0,ae,Ce,W.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){C&&he&&r.texStorage3D(e.TEXTURE_2D_ARRAY,Ee,pe,ze[0].width,ze[0].height,W.depth);for(let Q=0,J=ze.length;Q<J;Q++)if(le=ze[Q],g.format!==Dt)if(ae!==null)if(C){if(ne)if(g.layerUpdates.size>0){let ye=wo(le.width,le.height,g.format,g.type);for(let Ue of g.layerUpdates){let st=le.data.subarray(Ue*ye/le.data.BYTES_PER_ELEMENT,(Ue+1)*ye/le.data.BYTES_PER_ELEMENT);r.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,Q,0,0,Ue,le.width,le.height,1,ae,st)}g.clearLayerUpdates()}else r.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,Q,0,0,0,le.width,le.height,W.depth,ae,le.data)}else r.compressedTexImage3D(e.TEXTURE_2D_ARRAY,Q,pe,le.width,le.height,W.depth,0,le.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else C?ne&&r.texSubImage3D(e.TEXTURE_2D_ARRAY,Q,0,0,0,le.width,le.height,W.depth,ae,Ce,le.data):r.texImage3D(e.TEXTURE_2D_ARRAY,Q,pe,le.width,le.height,W.depth,0,ae,Ce,le.data)}else{C&&he&&r.texStorage2D(e.TEXTURE_2D,Ee,pe,ze[0].width,ze[0].height);for(let Q=0,J=ze.length;Q<J;Q++)le=ze[Q],g.format!==Dt?ae!==null?C?ne&&r.compressedTexSubImage2D(e.TEXTURE_2D,Q,0,0,le.width,le.height,ae,le.data):r.compressedTexImage2D(e.TEXTURE_2D,Q,pe,le.width,le.height,0,le.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):C?ne&&r.texSubImage2D(e.TEXTURE_2D,Q,0,0,le.width,le.height,ae,Ce,le.data):r.texImage2D(e.TEXTURE_2D,Q,pe,le.width,le.height,0,ae,Ce,le.data)}else if(g.isDataArrayTexture)if(C){if(he&&r.texStorage3D(e.TEXTURE_2D_ARRAY,Ee,pe,W.width,W.height,W.depth),ne)if(g.layerUpdates.size>0){let Q=wo(W.width,W.height,g.format,g.type);for(let J of g.layerUpdates){let ye=W.data.subarray(J*Q/W.data.BYTES_PER_ELEMENT,(J+1)*Q/W.data.BYTES_PER_ELEMENT);r.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,J,W.width,W.height,1,ae,Ce,ye)}g.clearLayerUpdates()}else r.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,W.width,W.height,W.depth,ae,Ce,W.data)}else r.texImage3D(e.TEXTURE_2D_ARRAY,0,pe,W.width,W.height,W.depth,0,ae,Ce,W.data);else if(g.isData3DTexture)C?(he&&r.texStorage3D(e.TEXTURE_3D,Ee,pe,W.width,W.height,W.depth),ne&&r.texSubImage3D(e.TEXTURE_3D,0,0,0,0,W.width,W.height,W.depth,ae,Ce,W.data)):r.texImage3D(e.TEXTURE_3D,0,pe,W.width,W.height,W.depth,0,ae,Ce,W.data);else if(g.isFramebufferTexture){if(he)if(C)r.texStorage2D(e.TEXTURE_2D,Ee,pe,W.width,W.height);else{let Q=W.width,J=W.height;for(let ye=0;ye<Ee;ye++)r.texImage2D(e.TEXTURE_2D,ye,pe,Q,J,0,ae,Ce,null),Q>>=1,J>>=1}}else if(ze.length>0){if(C&&he){let Q=ge(ze[0]);r.texStorage2D(e.TEXTURE_2D,Ee,pe,Q.width,Q.height)}for(let Q=0,J=ze.length;Q<J;Q++)le=ze[Q],C?ne&&r.texSubImage2D(e.TEXTURE_2D,Q,0,0,ae,Ce,le):r.texImage2D(e.TEXTURE_2D,Q,pe,ae,Ce,le);g.generateMipmaps=!1}else if(C){if(he){let Q=ge(W);r.texStorage2D(e.TEXTURE_2D,Ee,pe,Q.width,Q.height)}ne&&r.texSubImage2D(e.TEXTURE_2D,0,0,0,ae,Ce,W)}else r.texImage2D(e.TEXTURE_2D,0,pe,ae,Ce,W);m(g)&&p(B),de.__version=X.version,g.onUpdate&&g.onUpdate(g)}S.__version=g.version}function ce(S,g,L){if(g.image.length!==6)return;let B=qe(S,g),Y=g.source;r.bindTexture(e.TEXTURE_CUBE_MAP,S.__webglTexture,e.TEXTURE0+L);let X=i.get(Y);if(Y.version!==X.__version||B===!0){r.activeTexture(e.TEXTURE0+L);let de=je.getPrimaries(je.workingColorSpace),te=g.colorSpace===cr?null:je.getPrimaries(g.colorSpace),xe=g.colorSpace===cr||de===te?e.NONE:e.BROWSER_DEFAULT_WEBGL;e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,g.flipY),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),e.pixelStorei(e.UNPACK_ALIGNMENT,g.unpackAlignment),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe);let be=g.isCompressedTexture||g.image[0].isCompressedTexture,W=g.image[0]&&g.image[0].isDataTexture,ae=[];for(let J=0;J<6;J++)!be&&!W?ae[J]=_(g.image[J],!0,a.maxCubemapSize):ae[J]=W?g.image[J].image:g.image[J],ae[J]=ve(g,ae[J]);let Ce=ae[0],pe=n.convert(g.format,g.colorSpace),le=n.convert(g.type),ze=M(g.internalFormat,pe,le,g.colorSpace),C=g.isVideoTexture!==!0,he=X.__version===void 0||B===!0,ne=Y.dataReady,Ee=D(g,Ce);Ge(e.TEXTURE_CUBE_MAP,g);let Q;if(be){C&&he&&r.texStorage2D(e.TEXTURE_CUBE_MAP,Ee,ze,Ce.width,Ce.height);for(let J=0;J<6;J++){Q=ae[J].mipmaps;for(let ye=0;ye<Q.length;ye++){let Ue=Q[ye];g.format!==Dt?pe!==null?C?ne&&r.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+J,ye,0,0,Ue.width,Ue.height,pe,Ue.data):r.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+J,ye,ze,Ue.width,Ue.height,0,Ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):C?ne&&r.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+J,ye,0,0,Ue.width,Ue.height,pe,le,Ue.data):r.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+J,ye,ze,Ue.width,Ue.height,0,pe,le,Ue.data)}}}else{if(Q=g.mipmaps,C&&he){Q.length>0&&Ee++;let J=ge(ae[0]);r.texStorage2D(e.TEXTURE_CUBE_MAP,Ee,ze,J.width,J.height)}for(let J=0;J<6;J++)if(W){C?ne&&r.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,ae[J].width,ae[J].height,pe,le,ae[J].data):r.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,ze,ae[J].width,ae[J].height,0,pe,le,ae[J].data);for(let ye=0;ye<Q.length;ye++){let Ue=Q[ye].image[J].image;C?ne&&r.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+J,ye+1,0,0,Ue.width,Ue.height,pe,le,Ue.data):r.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+J,ye+1,ze,Ue.width,Ue.height,0,pe,le,Ue.data)}}else{C?ne&&r.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,pe,le,ae[J]):r.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,ze,pe,le,ae[J]);for(let ye=0;ye<Q.length;ye++){let Ue=Q[ye];C?ne&&r.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+J,ye+1,0,0,pe,le,Ue.image[J]):r.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+J,ye+1,ze,pe,le,Ue.image[J])}}}m(g)&&p(e.TEXTURE_CUBE_MAP),X.__version=Y.version,g.onUpdate&&g.onUpdate(g)}S.__version=g.version}function _e(S,g,L,B,Y,X){let de=n.convert(L.format,L.colorSpace),te=n.convert(L.type),xe=M(L.internalFormat,de,te,L.colorSpace),be=i.get(g),W=i.get(L);if(W.__renderTarget=g,!be.__hasExternalTextures){let ae=Math.max(1,g.width>>X),Ce=Math.max(1,g.height>>X);Y===e.TEXTURE_3D||Y===e.TEXTURE_2D_ARRAY?r.texImage3D(Y,X,xe,ae,Ce,g.depth,0,de,te,null):r.texImage2D(Y,X,xe,ae,Ce,0,de,te,null)}r.bindFramebuffer(e.FRAMEBUFFER,S),Pe(g)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,B,Y,W.__webglTexture,0,Se(g)):(Y===e.TEXTURE_2D||Y>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,B,Y,W.__webglTexture,X),r.bindFramebuffer(e.FRAMEBUFFER,null)}function Le(S,g,L){if(e.bindRenderbuffer(e.RENDERBUFFER,S),g.depthBuffer){let B=g.depthTexture,Y=B&&B.isDepthTexture?B.type:null,X=T(g.stencilBuffer,Y),de=g.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,te=Se(g);Pe(g)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,te,X,g.width,g.height):L?e.renderbufferStorageMultisample(e.RENDERBUFFER,te,X,g.width,g.height):e.renderbufferStorage(e.RENDERBUFFER,X,g.width,g.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,de,e.RENDERBUFFER,S)}else{let B=g.textures;for(let Y=0;Y<B.length;Y++){let X=B[Y],de=n.convert(X.format,X.colorSpace),te=n.convert(X.type),xe=M(X.internalFormat,de,te,X.colorSpace),be=Se(g);L&&Pe(g)===!1?e.renderbufferStorageMultisample(e.RENDERBUFFER,be,xe,g.width,g.height):Pe(g)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,be,xe,g.width,g.height):e.renderbufferStorage(e.RENDERBUFFER,xe,g.width,g.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function Fe(S,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(r.bindFramebuffer(e.FRAMEBUFFER,S),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let L=i.get(g.depthTexture);L.__renderTarget=g,(!L.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),K(g.depthTexture,0);let B=L.__webglTexture,Y=Se(g);if(g.depthTexture.format===mi)Pe(g)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,e.DEPTH_ATTACHMENT,e.TEXTURE_2D,B,0,Y):e.framebufferTexture2D(e.FRAMEBUFFER,e.DEPTH_ATTACHMENT,e.TEXTURE_2D,B,0);else if(g.depthTexture.format===gi)Pe(g)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,e.DEPTH_STENCIL_ATTACHMENT,e.TEXTURE_2D,B,0,Y):e.framebufferTexture2D(e.FRAMEBUFFER,e.DEPTH_STENCIL_ATTACHMENT,e.TEXTURE_2D,B,0);else throw new Error("Unknown depthTexture format")}function Xe(S){let g=i.get(S),L=S.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==S.depthTexture){let B=S.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),B){let Y=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,B.removeEventListener("dispose",Y)};B.addEventListener("dispose",Y),g.__depthDisposeCallback=Y}g.__boundDepthTexture=B}if(S.depthTexture&&!g.__autoAllocateDepthBuffer){if(L)throw new Error("target.depthTexture not supported in Cube render targets");let B=S.texture.mipmaps;B&&B.length>0?Fe(g.__webglFramebuffer[0],S):Fe(g.__webglFramebuffer,S)}else if(L){g.__webglDepthbuffer=[];for(let B=0;B<6;B++)if(r.bindFramebuffer(e.FRAMEBUFFER,g.__webglFramebuffer[B]),g.__webglDepthbuffer[B]===void 0)g.__webglDepthbuffer[B]=e.createRenderbuffer(),Le(g.__webglDepthbuffer[B],S,!1);else{let Y=S.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,X=g.__webglDepthbuffer[B];e.bindRenderbuffer(e.RENDERBUFFER,X),e.framebufferRenderbuffer(e.FRAMEBUFFER,Y,e.RENDERBUFFER,X)}}else{let B=S.texture.mipmaps;if(B&&B.length>0?r.bindFramebuffer(e.FRAMEBUFFER,g.__webglFramebuffer[0]):r.bindFramebuffer(e.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=e.createRenderbuffer(),Le(g.__webglDepthbuffer,S,!1);else{let Y=S.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,X=g.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,X),e.framebufferRenderbuffer(e.FRAMEBUFFER,Y,e.RENDERBUFFER,X)}}r.bindFramebuffer(e.FRAMEBUFFER,null)}function R(S,g,L){let B=i.get(S);g!==void 0&&_e(B.__webglFramebuffer,S,S.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),L!==void 0&&Xe(S)}function et(S){let g=S.texture,L=i.get(S),B=i.get(g);S.addEventListener("dispose",A);let Y=S.textures,X=S.isWebGLCubeRenderTarget===!0,de=Y.length>1;if(de||(B.__webglTexture===void 0&&(B.__webglTexture=e.createTexture()),B.__version=g.version,s.memory.textures++),X){L.__webglFramebuffer=[];for(let te=0;te<6;te++)if(g.mipmaps&&g.mipmaps.length>0){L.__webglFramebuffer[te]=[];for(let xe=0;xe<g.mipmaps.length;xe++)L.__webglFramebuffer[te][xe]=e.createFramebuffer()}else L.__webglFramebuffer[te]=e.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){L.__webglFramebuffer=[];for(let te=0;te<g.mipmaps.length;te++)L.__webglFramebuffer[te]=e.createFramebuffer()}else L.__webglFramebuffer=e.createFramebuffer();if(de)for(let te=0,xe=Y.length;te<xe;te++){let be=i.get(Y[te]);be.__webglTexture===void 0&&(be.__webglTexture=e.createTexture(),s.memory.textures++)}if(S.samples>0&&Pe(S)===!1){L.__webglMultisampledFramebuffer=e.createFramebuffer(),L.__webglColorRenderbuffer=[],r.bindFramebuffer(e.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let te=0;te<Y.length;te++){let xe=Y[te];L.__webglColorRenderbuffer[te]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,L.__webglColorRenderbuffer[te]);let be=n.convert(xe.format,xe.colorSpace),W=n.convert(xe.type),ae=M(xe.internalFormat,be,W,xe.colorSpace,S.isXRRenderTarget===!0),Ce=Se(S);e.renderbufferStorageMultisample(e.RENDERBUFFER,Ce,ae,S.width,S.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+te,e.RENDERBUFFER,L.__webglColorRenderbuffer[te])}e.bindRenderbuffer(e.RENDERBUFFER,null),S.depthBuffer&&(L.__webglDepthRenderbuffer=e.createRenderbuffer(),Le(L.__webglDepthRenderbuffer,S,!0)),r.bindFramebuffer(e.FRAMEBUFFER,null)}}if(X){r.bindTexture(e.TEXTURE_CUBE_MAP,B.__webglTexture),Ge(e.TEXTURE_CUBE_MAP,g);for(let te=0;te<6;te++)if(g.mipmaps&&g.mipmaps.length>0)for(let xe=0;xe<g.mipmaps.length;xe++)_e(L.__webglFramebuffer[te][xe],S,g,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+te,xe);else _e(L.__webglFramebuffer[te],S,g,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+te,0);m(g)&&p(e.TEXTURE_CUBE_MAP),r.unbindTexture()}else if(de){for(let te=0,xe=Y.length;te<xe;te++){let be=Y[te],W=i.get(be),ae=e.TEXTURE_2D;(S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(ae=S.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),r.bindTexture(ae,W.__webglTexture),Ge(ae,be),_e(L.__webglFramebuffer,S,be,e.COLOR_ATTACHMENT0+te,ae,0),m(be)&&p(ae)}r.unbindTexture()}else{let te=e.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(te=S.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),r.bindTexture(te,B.__webglTexture),Ge(te,g),g.mipmaps&&g.mipmaps.length>0)for(let xe=0;xe<g.mipmaps.length;xe++)_e(L.__webglFramebuffer[xe],S,g,e.COLOR_ATTACHMENT0,te,xe);else _e(L.__webglFramebuffer,S,g,e.COLOR_ATTACHMENT0,te,0);m(g)&&p(te),r.unbindTexture()}S.depthBuffer&&Xe(S)}function Ne(S){let g=S.textures;for(let L=0,B=g.length;L<B;L++){let Y=g[L];if(m(Y)){let X=b(S),de=i.get(Y).__webglTexture;r.bindTexture(X,de),p(X),r.unbindTexture()}}}let Ye=[],Ae=[];function Ze(S){if(S.samples>0){if(Pe(S)===!1){let g=S.textures,L=S.width,B=S.height,Y=e.COLOR_BUFFER_BIT,X=S.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,de=i.get(S),te=g.length>1;if(te)for(let be=0;be<g.length;be++)r.bindFramebuffer(e.FRAMEBUFFER,de.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+be,e.RENDERBUFFER,null),r.bindFramebuffer(e.FRAMEBUFFER,de.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+be,e.TEXTURE_2D,null,0);r.bindFramebuffer(e.READ_FRAMEBUFFER,de.__webglMultisampledFramebuffer);let xe=S.texture.mipmaps;xe&&xe.length>0?r.bindFramebuffer(e.DRAW_FRAMEBUFFER,de.__webglFramebuffer[0]):r.bindFramebuffer(e.DRAW_FRAMEBUFFER,de.__webglFramebuffer);for(let be=0;be<g.length;be++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(Y|=e.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(Y|=e.STENCIL_BUFFER_BIT)),te){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,de.__webglColorRenderbuffer[be]);let W=i.get(g[be]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,W,0)}e.blitFramebuffer(0,0,L,B,0,0,L,B,Y,e.NEAREST),l===!0&&(Ye.length=0,Ae.length=0,Ye.push(e.COLOR_ATTACHMENT0+be),S.depthBuffer&&S.resolveDepthBuffer===!1&&(Ye.push(X),Ae.push(X),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,Ae)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,Ye))}if(r.bindFramebuffer(e.READ_FRAMEBUFFER,null),r.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),te)for(let be=0;be<g.length;be++){r.bindFramebuffer(e.FRAMEBUFFER,de.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+be,e.RENDERBUFFER,de.__webglColorRenderbuffer[be]);let W=i.get(g[be]).__webglTexture;r.bindFramebuffer(e.FRAMEBUFFER,de.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+be,e.TEXTURE_2D,W,0)}r.bindFramebuffer(e.DRAW_FRAMEBUFFER,de.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&l){let g=S.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[g])}}}function Se(S){return Math.min(a.maxSamples,S.samples)}function Pe(S){let g=i.get(S);return S.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function ie(S){let g=s.render.frame;c.get(S)!==g&&(c.set(S,g),S.update())}function ve(S,g){let L=S.colorSpace,B=S.format,Y=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||L!==zr&&L!==cr&&(je.getTransfer(L)===Ke?(B!==Dt||Y!==kt)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",L)),g}function ge(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(h.width=S.naturalWidth||S.width,h.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(h.width=S.displayWidth,h.height=S.displayHeight):(h.width=S.width,h.height=S.height),h}this.allocateTextureUnit=F,this.resetTextureUnits=V,this.setTexture2D=K,this.setTexture2DArray=j,this.setTexture3D=Z,this.setTextureCube=q,this.rebindTextures=R,this.setupRenderTarget=et,this.updateRenderTargetMipmap=Ne,this.updateMultisampleRenderTarget=Ze,this.setupDepthRenderbuffer=Xe,this.setupFrameBufferTexture=_e,this.useMultisampledRTT=Pe}function Mm(e,t){function r(i,a=cr){let n,s=je.getTransfer(a);if(i===kt)return e.UNSIGNED_BYTE;if(i===Va)return e.UNSIGNED_SHORT_4_4_4_4;if(i===Ga)return e.UNSIGNED_SHORT_5_5_5_1;if(i===Rs)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===ws)return e.BYTE;if(i===As)return e.SHORT;if(i===di)return e.UNSIGNED_SHORT;if(i===Ha)return e.INT;if(i===Er)return e.UNSIGNED_INT;if(i===$t)return e.FLOAT;if(i===pi)return e.HALF_FLOAT;if(i===Cs)return e.ALPHA;if(i===Ps)return e.RGB;if(i===Dt)return e.RGBA;if(i===mi)return e.DEPTH_COMPONENT;if(i===gi)return e.DEPTH_STENCIL;if(i===Ls)return e.RED;if(i===ka)return e.RED_INTEGER;if(i===Us)return e.RG;if(i===Wa)return e.RG_INTEGER;if(i===Xa)return e.RGBA_INTEGER;if(i===Bi||i===zi||i===Hi||i===Vi)if(s===Ke)if(n=t.get("WEBGL_compressed_texture_s3tc_srgb"),n!==null){if(i===Bi)return n.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===zi)return n.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Hi)return n.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Vi)return n.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(n=t.get("WEBGL_compressed_texture_s3tc"),n!==null){if(i===Bi)return n.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===zi)return n.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Hi)return n.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Vi)return n.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===ja||i===qa||i===Ya||i===Ja)if(n=t.get("WEBGL_compressed_texture_pvrtc"),n!==null){if(i===ja)return n.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===qa)return n.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Ya)return n.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Ja)return n.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Ka||i===Za||i===$a)if(n=t.get("WEBGL_compressed_texture_etc"),n!==null){if(i===Ka||i===Za)return s===Ke?n.COMPRESSED_SRGB8_ETC2:n.COMPRESSED_RGB8_ETC2;if(i===$a)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:n.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Qa||i===en||i===tn||i===rn||i===an||i===nn||i===sn||i===on||i===ln||i===hn||i===cn||i===un||i===dn||i===pn)if(n=t.get("WEBGL_compressed_texture_astc"),n!==null){if(i===Qa)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:n.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===en)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:n.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===tn)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:n.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===rn)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:n.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===an)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:n.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===nn)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:n.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===sn)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:n.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===on)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:n.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===ln)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:n.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===hn)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:n.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===cn)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:n.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===un)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:n.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===dn)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:n.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===pn)return s===Ke?n.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:n.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Gi||i===fn||i===mn)if(n=t.get("EXT_texture_compression_bptc"),n!==null){if(i===Gi)return s===Ke?n.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:n.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===fn)return n.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===mn)return n.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Ds||i===gn||i===_n||i===vn)if(n=t.get("EXT_texture_compression_rgtc"),n!==null){if(i===Gi)return n.COMPRESSED_RED_RGTC1_EXT;if(i===gn)return n.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===_n)return n.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===vn)return n.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===fi?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:r}}var rl=class extends It{constructor(e=null){super(),this.sourceTexture=e,this.isExternalTexture=!0}},Sm=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`,Tm=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let r=new rl(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,r=new sr({vertexShader:Sm,fragmentShader:Em,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new bt(new Qn(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},bm=class extends Vr{constructor(e,t){super();let r=this,i=null,a=1,n=null,s="local-floor",o=1,l=null,h=null,c=null,u=null,d=null,f=null,v=new Tm,_={},m=t.getContextAttributes(),p=null,b=null,M=[],T=[],D=new Re,w=null,A=new Ct;A.viewport=new ot;let O=new Ct;O.viewport=new ot;let E=[A,O],y=new Oc,P=null,V=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(k){let re=M[k];return re===void 0&&(re=new Xn,M[k]=re),re.getTargetRaySpace()},this.getControllerGrip=function(k){let re=M[k];return re===void 0&&(re=new Xn,M[k]=re),re.getGripSpace()},this.getHand=function(k){let re=M[k];return re===void 0&&(re=new Xn,M[k]=re),re.getHandSpace()};function F(k){let re=T.indexOf(k.inputSource);if(re===-1)return;let Te=M[re];Te!==void 0&&(Te.update(k.inputSource,k.frame,l||n),Te.dispatchEvent({type:k.type,data:k.inputSource}))}function z(){i.removeEventListener("select",F),i.removeEventListener("selectstart",F),i.removeEventListener("selectend",F),i.removeEventListener("squeeze",F),i.removeEventListener("squeezestart",F),i.removeEventListener("squeezeend",F),i.removeEventListener("end",z),i.removeEventListener("inputsourceschange",K);for(let k=0;k<M.length;k++){let re=T[k];re!==null&&(T[k]=null,M[k].disconnect(re))}P=null,V=null,v.reset();for(let k in _)delete _[k];e.setRenderTarget(p),d=null,u=null,c=null,i=null,b=null,qe.stop(),r.isPresenting=!1,e.setPixelRatio(w),e.setSize(D.width,D.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(k){a=k,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(k){s=k,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||n},this.setReferenceSpace=function(k){l=k},this.getBaseLayer=function(){return u!==null?u:d},this.getBinding=function(){return c},this.getFrame=function(){return f},this.getSession=function(){return i},this.setSession=async function(k){if(i=k,i!==null){if(p=e.getRenderTarget(),i.addEventListener("select",F),i.addEventListener("selectstart",F),i.addEventListener("selectend",F),i.addEventListener("squeeze",F),i.addEventListener("squeezestart",F),i.addEventListener("squeezeend",F),i.addEventListener("end",z),i.addEventListener("inputsourceschange",K),m.xrCompatible!==!0&&await t.makeXRCompatible(),w=e.getPixelRatio(),e.getSize(D),typeof XRWebGLBinding<"u"&&(c=new XRWebGLBinding(i,t)),c!==null&&"createProjectionLayer"in XRWebGLBinding.prototype){let re=null,Te=null,ce=null;m.depth&&(ce=m.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,re=m.stencil?gi:mi,Te=m.stencil?fi:Er);let _e={colorFormat:t.RGBA8,depthFormat:ce,scaleFactor:a};u=c.createProjectionLayer(_e),i.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),b=new Tr(u.textureWidth,u.textureHeight,{format:Dt,type:kt,depthTexture:new _o(u.textureWidth,u.textureHeight,Te,void 0,void 0,void 0,void 0,void 0,void 0,re),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{let re={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:a};d=new XRWebGLLayer(i,t,re),i.updateRenderState({baseLayer:d}),e.setPixelRatio(1),e.setSize(d.framebufferWidth,d.framebufferHeight,!1),b=new Tr(d.framebufferWidth,d.framebufferHeight,{format:Dt,type:kt,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(o),l=null,n=await i.requestReferenceSpace(s),qe.setContext(i),qe.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return v.getDepthTexture()};function K(k){for(let re=0;re<k.removed.length;re++){let Te=k.removed[re],ce=T.indexOf(Te);ce>=0&&(T[ce]=null,M[ce].disconnect(Te))}for(let re=0;re<k.added.length;re++){let Te=k.added[re],ce=T.indexOf(Te);if(ce===-1){for(let Le=0;Le<M.length;Le++)if(Le>=T.length){T.push(Te),ce=Le;break}else if(T[Le]===null){T[Le]=Te,ce=Le;break}if(ce===-1)break}let _e=M[ce];_e&&_e.connect(Te)}}let j=new U,Z=new U;function q(k,re,Te){j.setFromMatrixPosition(re.matrixWorld),Z.setFromMatrixPosition(Te.matrixWorld);let ce=j.distanceTo(Z),_e=re.projectionMatrix.elements,Le=Te.projectionMatrix.elements,Fe=_e[14]/(_e[10]-1),Xe=_e[14]/(_e[10]+1),R=(_e[9]+1)/_e[5],et=(_e[9]-1)/_e[5],Ne=(_e[8]-1)/_e[0],Ye=(Le[8]+1)/Le[0],Ae=Fe*Ne,Ze=Fe*Ye,Se=ce/(-Ne+Ye),Pe=Se*-Ne;if(re.matrixWorld.decompose(k.position,k.quaternion,k.scale),k.translateX(Pe),k.translateZ(Se),k.matrixWorld.compose(k.position,k.quaternion,k.scale),k.matrixWorldInverse.copy(k.matrixWorld).invert(),_e[10]===-1)k.projectionMatrix.copy(re.projectionMatrix),k.projectionMatrixInverse.copy(re.projectionMatrixInverse);else{let ie=Fe+Se,ve=Xe+Se,ge=Ae-Pe,S=Ze+(ce-Pe),g=R*Xe/ve*ie,L=et*Xe/ve*ie;k.projectionMatrix.makePerspective(ge,S,g,L,ie,ve),k.projectionMatrixInverse.copy(k.projectionMatrix).invert()}}function ee(k,re){re===null?k.matrixWorld.copy(k.matrix):k.matrixWorld.multiplyMatrices(re.matrixWorld,k.matrix),k.matrixWorldInverse.copy(k.matrixWorld).invert()}this.updateCamera=function(k){if(i===null)return;let re=k.near,Te=k.far;v.texture!==null&&(v.depthNear>0&&(re=v.depthNear),v.depthFar>0&&(Te=v.depthFar)),y.near=O.near=A.near=re,y.far=O.far=A.far=Te,(P!==y.near||V!==y.far)&&(i.updateRenderState({depthNear:y.near,depthFar:y.far}),P=y.near,V=y.far),y.layers.mask=k.layers.mask|6,A.layers.mask=y.layers.mask&3,O.layers.mask=y.layers.mask&5;let ce=k.parent,_e=y.cameras;ee(y,ce);for(let Le=0;Le<_e.length;Le++)ee(_e[Le],ce);_e.length===2?q(y,A,O):y.projectionMatrix.copy(A.projectionMatrix),se(k,y,ce)};function se(k,re,Te){Te===null?k.matrix.copy(re.matrixWorld):(k.matrix.copy(Te.matrixWorld),k.matrix.invert(),k.matrix.multiply(re.matrixWorld)),k.matrix.decompose(k.position,k.quaternion,k.scale),k.updateMatrixWorld(!0),k.projectionMatrix.copy(re.projectionMatrix),k.projectionMatrixInverse.copy(re.projectionMatrixInverse),k.isPerspectiveCamera&&(k.fov=vi*2*Math.atan(1/k.projectionMatrix.elements[5]),k.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(u===null&&d===null))return o},this.setFoveation=function(k){o=k,u!==null&&(u.fixedFoveation=k),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=k)},this.hasDepthSensing=function(){return v.texture!==null},this.getDepthSensingMesh=function(){return v.getMesh(y)},this.getCameraTexture=function(k){return _[k]};let Me=null;function Ge(k,re){if(h=re.getViewerPose(l||n),f=re,h!==null){let Te=h.views;d!==null&&(e.setRenderTargetFramebuffer(b,d.framebuffer),e.setRenderTarget(b));let ce=!1;Te.length!==y.cameras.length&&(y.cameras.length=0,ce=!0);for(let Le=0;Le<Te.length;Le++){let Fe=Te[Le],Xe=null;if(d!==null)Xe=d.getViewport(Fe);else{let et=c.getViewSubImage(u,Fe);Xe=et.viewport,Le===0&&(e.setRenderTargetTextures(b,et.colorTexture,et.depthStencilTexture),e.setRenderTarget(b))}let R=E[Le];R===void 0&&(R=new Ct,R.layers.enable(Le),R.viewport=new ot,E[Le]=R),R.matrix.fromArray(Fe.transform.matrix),R.matrix.decompose(R.position,R.quaternion,R.scale),R.projectionMatrix.fromArray(Fe.projectionMatrix),R.projectionMatrixInverse.copy(R.projectionMatrix).invert(),R.viewport.set(Xe.x,Xe.y,Xe.width,Xe.height),Le===0&&(y.matrix.copy(R.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),ce===!0&&y.cameras.push(R)}let _e=i.enabledFeatures;if(_e&&_e.includes("depth-sensing")&&i.depthUsage=="gpu-optimized"&&c){let Le=c.getDepthInformation(Te[0]);Le&&Le.isValid&&Le.texture&&v.init(Le,i.renderState)}if(_e&&_e.includes("camera-access")&&(e.state.unbindTexture(),c))for(let Le=0;Le<Te.length;Le++){let Fe=Te[Le].camera;if(Fe){let Xe=_[Fe];Xe||(Xe=new rl,_[Fe]=Xe);let R=c.getCameraImage(Fe);Xe.sourceTexture=R}}}for(let Te=0;Te<M.length;Te++){let ce=T[Te],_e=M[Te];ce!==null&&_e!==void 0&&_e.update(ce,re,l||n)}Me&&Me(k,re),re.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:re}),f=null}let qe=new Ao;qe.setAnimationLoop(Ge),this.setAnimationLoop=function(k){Me=k},this.dispose=function(){}}},Dr=new mr,wm=new ht;function Am(e,t){function r(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function i(m,p){p.color.getRGB(m.fogColor.value,co(e)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function a(m,p,b,M,T){p.isMeshBasicMaterial||p.isMeshLambertMaterial?n(m,p):p.isMeshToonMaterial?(n(m,p),u(m,p)):p.isMeshPhongMaterial?(n(m,p),c(m,p)):p.isMeshStandardMaterial?(n(m,p),d(m,p),p.isMeshPhysicalMaterial&&f(m,p,T)):p.isMeshMatcapMaterial?(n(m,p),v(m,p)):p.isMeshDepthMaterial?n(m,p):p.isMeshDistanceMaterial?(n(m,p),_(m,p)):p.isMeshNormalMaterial?n(m,p):p.isLineBasicMaterial?(s(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?l(m,p,b,M):p.isSpriteMaterial?h(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function n(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,r(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,r(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,r(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===xt&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,r(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===xt&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,r(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,r(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,r(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);let b=t.get(p),M=b.envMap,T=b.envMapRotation;M&&(m.envMap.value=M,Dr.copy(T),Dr.x*=-1,Dr.y*=-1,Dr.z*=-1,M.isCubeTexture&&M.isRenderTargetTexture===!1&&(Dr.y*=-1,Dr.z*=-1),m.envMapRotation.value.setFromMatrix4(wm.makeRotationFromEuler(Dr)),m.flipEnvMap.value=M.isCubeTexture&&M.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,r(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,r(p.aoMap,m.aoMapTransform))}function s(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,r(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,b,M){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*b,m.scale.value=M*.5,p.map&&(m.map.value=p.map,r(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,r(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,r(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,r(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function u(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,r(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,r(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,b){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,r(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,r(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,r(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,r(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,r(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===xt&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,r(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,r(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=b.texture,m.transmissionSamplerSize.value.set(b.width,b.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,r(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,r(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,r(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,r(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,r(p.specularIntensityMap,m.specularIntensityMapTransform))}function v(m,p){p.matcap&&(m.matcap.value=p.matcap)}function _(m,p){let b=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(b.matrixWorld),m.nearDistance.value=b.shadow.camera.near,m.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:a}}function Rm(e,t,r,i){let a={},n={},s=[],o=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function l(b,M){let T=M.program;i.uniformBlockBinding(b,T)}function h(b,M){let T=a[b.id];T===void 0&&(v(b),T=c(b),a[b.id]=T,b.addEventListener("dispose",m));let D=M.program;i.updateUBOMapping(b,D);let w=t.render.frame;n[b.id]!==w&&(d(b),n[b.id]=w)}function c(b){let M=u();b.__bindingPointIndex=M;let T=e.createBuffer(),D=b.__size,w=b.usage;return e.bindBuffer(e.UNIFORM_BUFFER,T),e.bufferData(e.UNIFORM_BUFFER,D,w),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,M,T),T}function u(){for(let b=0;b<o;b++)if(s.indexOf(b)===-1)return s.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(b){let M=a[b.id],T=b.uniforms,D=b.__cache;e.bindBuffer(e.UNIFORM_BUFFER,M);for(let w=0,A=T.length;w<A;w++){let O=Array.isArray(T[w])?T[w]:[T[w]];for(let E=0,y=O.length;E<y;E++){let P=O[E];if(f(P,w,E,D)===!0){let V=P.__offset,F=Array.isArray(P.value)?P.value:[P.value],z=0;for(let K=0;K<F.length;K++){let j=F[K],Z=_(j);typeof j=="number"||typeof j=="boolean"?(P.__data[0]=j,e.bufferSubData(e.UNIFORM_BUFFER,V+z,P.__data)):j.isMatrix3?(P.__data[0]=j.elements[0],P.__data[1]=j.elements[1],P.__data[2]=j.elements[2],P.__data[3]=0,P.__data[4]=j.elements[3],P.__data[5]=j.elements[4],P.__data[6]=j.elements[5],P.__data[7]=0,P.__data[8]=j.elements[6],P.__data[9]=j.elements[7],P.__data[10]=j.elements[8],P.__data[11]=0):(j.toArray(P.__data,z),z+=Z.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,V,P.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function f(b,M,T,D){let w=b.value,A=M+"_"+T;if(D[A]===void 0)return typeof w=="number"||typeof w=="boolean"?D[A]=w:D[A]=w.clone(),!0;{let O=D[A];if(typeof w=="number"||typeof w=="boolean"){if(O!==w)return D[A]=w,!0}else if(O.equals(w)===!1)return O.copy(w),!0}return!1}function v(b){let M=b.uniforms,T=0,D=16;for(let A=0,O=M.length;A<O;A++){let E=Array.isArray(M[A])?M[A]:[M[A]];for(let y=0,P=E.length;y<P;y++){let V=E[y],F=Array.isArray(V.value)?V.value:[V.value];for(let z=0,K=F.length;z<K;z++){let j=F[z],Z=_(j),q=T%D,ee=q%Z.boundary,se=q+ee;T+=ee,se!==0&&D-se<Z.storage&&(T+=D-se),V.__data=new Float32Array(Z.storage/Float32Array.BYTES_PER_ELEMENT),V.__offset=T,T+=Z.storage}}}let w=T%D;return w>0&&(T+=D-w),b.__size=T,b.__cache={},this}function _(b){let M={boundary:0,storage:0};return typeof b=="number"||typeof b=="boolean"?(M.boundary=4,M.storage=4):b.isVector2?(M.boundary=8,M.storage=8):b.isVector3||b.isColor?(M.boundary=16,M.storage=12):b.isVector4?(M.boundary=16,M.storage=16):b.isMatrix3?(M.boundary=48,M.storage=48):b.isMatrix4?(M.boundary=64,M.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),M}function m(b){let M=b.target;M.removeEventListener("dispose",m);let T=s.indexOf(M.__bindingPointIndex);s.splice(T,1),e.deleteBuffer(a[M.id]),delete a[M.id],delete n[M.id]}function p(){for(let b in a)e.deleteBuffer(a[b]);s=[],a={},n={}}return{bind:l,update:h,dispose:p}}var Cm=class{constructor(e={}){let{canvas:t=bh(),context:r=null,depth:i=!0,stencil:a=!1,alpha:n=!1,antialias:s=!1,premultipliedAlpha:o=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:c=!1,reversedDepthBuffer:u=!1}=e;this.isWebGLRenderer=!0;let d;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");d=r.getContextAttributes().alpha}else d=n;let f=new Uint32Array(4),v=new Int32Array(4),_=null,m=null,p=[],b=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=hr,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let M=this,T=!1;this._outputColorSpace=yt;let D=0,w=0,A=null,O=-1,E=null,y=new ot,P=new ot,V=null,F=new We(0),z=0,K=t.width,j=t.height,Z=1,q=null,ee=null,se=new ot(0,0,K,j),Me=new ot(0,0,K,j),Ge=!1,qe=new qn,k=!1,re=!1,Te=new ht,ce=new U,_e=new ot,Le={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Fe=!1;function Xe(){return A===null?Z:1}let R=r;function et(x,N){return t.getContext(x,N)}try{let x={alpha:!0,depth:i,stencil:a,antialias:s,premultipliedAlpha:o,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:c};if("setAttribute"in t&&t.setAttribute("data-engine","three.js r179"),t.addEventListener("webglcontextlost",he,!1),t.addEventListener("webglcontextrestored",ne,!1),t.addEventListener("webglcontextcreationerror",Ee,!1),R===null){let N="webgl2";if(R=et(N,x),R===null)throw et(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(x){throw console.error("THREE.WebGLRenderer: "+x.message),x}let Ne,Ye,Ae,Ze,Se,Pe,ie,ve,ge,S,g,L,B,Y,X,de,te,xe,be,W,ae,Ce,pe,le;function ze(){Ne=new Bp(R),Ne.init(),Ce=new Mm(R,Ne),Ye=new Lp(R,Ne,e,Ce),Ae=new xm(R,Ne),Ye.reversedDepthBuffer&&u&&Ae.buffers.depth.setReversed(!0),Ze=new Vp(R),Se=new sm,Pe=new ym(R,Ne,Ae,Se,Ye,Ce,Ze),ie=new Dp(M),ve=new Fp(M),ge=new qc(R),pe=new Cp(R,ge),S=new zp(R,ge,Ze,pe),g=new kp(R,S,ge,Ze),be=new Gp(R,Ye,Pe),de=new Up(Se),L=new nm(M,ie,ve,Ne,Ye,pe,de),B=new Am(M,Se),Y=new lm,X=new fm(Ne),xe=new Rp(M,ie,ve,Ae,g,d,o),te=new _m(M,g,Ye),le=new Rm(R,Ze,Ye,Ae),W=new Pp(R,Ne,Ze),ae=new Hp(R,Ne,Ze),Ze.programs=L.programs,M.capabilities=Ye,M.extensions=Ne,M.properties=Se,M.renderLists=Y,M.shadowMap=te,M.state=Ae,M.info=Ze}ze();let C=new bm(M,R);this.xr=C,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){let x=Ne.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){let x=Ne.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return Z},this.setPixelRatio=function(x){x!==void 0&&(Z=x,this.setSize(K,j,!1))},this.getSize=function(x){return x.set(K,j)},this.setSize=function(x,N,H=!0){if(C.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}K=x,j=N,t.width=Math.floor(x*Z),t.height=Math.floor(N*Z),H===!0&&(t.style.width=x+"px",t.style.height=N+"px"),this.setViewport(0,0,x,N)},this.getDrawingBufferSize=function(x){return x.set(K*Z,j*Z).floor()},this.setDrawingBufferSize=function(x,N,H){K=x,j=N,Z=H,t.width=Math.floor(x*H),t.height=Math.floor(N*H),this.setViewport(0,0,x,N)},this.getCurrentViewport=function(x){return x.copy(y)},this.getViewport=function(x){return x.copy(se)},this.setViewport=function(x,N,H,G){x.isVector4?se.set(x.x,x.y,x.z,x.w):se.set(x,N,H,G),Ae.viewport(y.copy(se).multiplyScalar(Z).round())},this.getScissor=function(x){return x.copy(Me)},this.setScissor=function(x,N,H,G){x.isVector4?Me.set(x.x,x.y,x.z,x.w):Me.set(x,N,H,G),Ae.scissor(P.copy(Me).multiplyScalar(Z).round())},this.getScissorTest=function(){return Ge},this.setScissorTest=function(x){Ae.setScissorTest(Ge=x)},this.setOpaqueSort=function(x){q=x},this.setTransparentSort=function(x){ee=x},this.getClearColor=function(x){return x.copy(xe.getClearColor())},this.setClearColor=function(){xe.setClearColor(...arguments)},this.getClearAlpha=function(){return xe.getClearAlpha()},this.setClearAlpha=function(){xe.setClearAlpha(...arguments)},this.clear=function(x=!0,N=!0,H=!0){let G=0;if(x){let I=!1;if(A!==null){let $=A.texture.format;I=$===Xa||$===Wa||$===ka}if(I){let $=A.texture.type,ue=$===kt||$===Er||$===di||$===fi||$===Va||$===Ga,fe=xe.getClearColor(),me=xe.getClearAlpha(),De=fe.r,Oe=fe.g,Ie=fe.b;ue?(f[0]=De,f[1]=Oe,f[2]=Ie,f[3]=me,R.clearBufferuiv(R.COLOR,0,f)):(v[0]=De,v[1]=Oe,v[2]=Ie,v[3]=me,R.clearBufferiv(R.COLOR,0,v))}else G|=R.COLOR_BUFFER_BIT}N&&(G|=R.DEPTH_BUFFER_BIT),H&&(G|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),R.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",he,!1),t.removeEventListener("webglcontextrestored",ne,!1),t.removeEventListener("webglcontextcreationerror",Ee,!1),xe.dispose(),Y.dispose(),X.dispose(),Se.dispose(),ie.dispose(),ve.dispose(),g.dispose(),pe.dispose(),le.dispose(),L.dispose(),C.dispose(),C.removeEventListener("sessionstart",Ht),C.removeEventListener("sessionend",Vt),vr.stop()};function he(x){x.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),T=!0}function ne(){console.log("THREE.WebGLRenderer: Context Restored."),T=!1;let x=Ze.autoReset,N=te.enabled,H=te.autoUpdate,G=te.needsUpdate,I=te.type;ze(),Ze.autoReset=x,te.enabled=N,te.autoUpdate=H,te.needsUpdate=G,te.type=I}function Ee(x){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function Q(x){let N=x.target;N.removeEventListener("dispose",Q),J(N)}function J(x){ye(x),Se.remove(x)}function ye(x){let N=Se.get(x).programs;N!==void 0&&(N.forEach(function(H){L.releaseProgram(H)}),x.isShaderMaterial&&L.releaseShaderCache(x))}this.renderBufferDirect=function(x,N,H,G,I,$){N===null&&(N=Le);let ue=I.isMesh&&I.matrixWorld.determinant()<0,fe=_l(x,N,H,G,I);Ae.setMaterial(G,ue);let me=H.index,De=1;if(G.wireframe===!0){if(me=S.getWireframeAttribute(H),me===void 0)return;De=2}let Oe=H.drawRange,Ie=H.attributes.position,ke=Oe.start*De,$e=(Oe.start+Oe.count)*De;$!==null&&(ke=Math.max(ke,$.start*De),$e=Math.min($e,($.start+$.count)*De)),me!==null?(ke=Math.max(ke,0),$e=Math.min($e,me.count)):Ie!=null&&(ke=Math.max(ke,0),$e=Math.min($e,Ie.count));let tt=$e-ke;if(tt<0||tt===1/0)return;pe.setup(I,G,fe,H,me);let it,Qe=W;if(me!==null&&(it=ge.get(me),Qe=ae,Qe.setIndex(it)),I.isMesh)G.wireframe===!0?(Ae.setLineWidth(G.wireframeLinewidth*Xe()),Qe.setMode(R.LINES)):Qe.setMode(R.TRIANGLES);else if(I.isLine){let we=G.linewidth;we===void 0&&(we=1),Ae.setLineWidth(we*Xe()),I.isLineSegments?Qe.setMode(R.LINES):I.isLineLoop?Qe.setMode(R.LINE_LOOP):Qe.setMode(R.LINE_STRIP)}else I.isPoints?Qe.setMode(R.POINTS):I.isSprite&&Qe.setMode(R.TRIANGLES);if(I.isBatchedMesh)if(I._multiDrawInstances!==null)Xr("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Qe.renderMultiDrawInstances(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount,I._multiDrawInstances);else if(Ne.get("WEBGL_multi_draw"))Qe.renderMultiDraw(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount);else{let we=I._multiDrawStarts,pt=I._multiDrawCounts,Jt=I._multiDrawCount,Pt=me?ge.get(me).bytesPerElement:1,Ir=Se.get(G).currentProgram.getUniforms();for(let Mt=0;Mt<Jt;Mt++)Ir.setValue(R,"_gl_DrawID",Mt),Qe.render(we[Mt]/Pt,pt[Mt])}else if(I.isInstancedMesh)Qe.renderInstances(ke,tt,I.count);else if(H.isInstancedBufferGeometry){let we=H._maxInstanceCount!==void 0?H._maxInstanceCount:1/0,pt=Math.min(H.instanceCount,we);Qe.renderInstances(ke,tt,pt)}else Qe.render(ke,tt)};function Ue(x,N,H){x.transparent===!0&&x.side===Zt&&x.forceSinglePass===!1?(x.side=xt,x.needsUpdate=!0,Ii(x,N,H),x.side=or,x.needsUpdate=!0,Ii(x,N,H),x.side=Zt):Ii(x,N,H)}this.compile=function(x,N,H=null){H===null&&(H=x),m=X.get(H),m.init(N),b.push(m),H.traverseVisible(function(I){I.isLight&&I.layers.test(N.layers)&&(m.pushLight(I),I.castShadow&&m.pushShadow(I))}),x!==H&&x.traverseVisible(function(I){I.isLight&&I.layers.test(N.layers)&&(m.pushLight(I),I.castShadow&&m.pushShadow(I))}),m.setupLights();let G=new Set;return x.traverse(function(I){if(!(I.isMesh||I.isPoints||I.isLine||I.isSprite))return;let $=I.material;if($)if(Array.isArray($))for(let ue=0;ue<$.length;ue++){let fe=$[ue];Ue(fe,H,I),G.add(fe)}else Ue($,H,I),G.add($)}),m=b.pop(),G},this.compileAsync=function(x,N,H=null){let G=this.compile(x,N,H);return new Promise(I=>{function $(){if(G.forEach(function(ue){Se.get(ue).currentProgram.isReady()&&G.delete(ue)}),G.size===0){I(x);return}setTimeout($,10)}Ne.get("KHR_parallel_shader_compile")!==null?$():setTimeout($,10)})};let st=null;function Je(x){st&&st(x)}function Ht(){vr.stop()}function Vt(){vr.start()}let vr=new Ao;vr.setAnimationLoop(Je),typeof self<"u"&&vr.setContext(self),this.setAnimationLoop=function(x){st=x,C.setAnimationLoop(x),x===null?vr.stop():vr.start()},C.addEventListener("sessionstart",Ht),C.addEventListener("sessionend",Vt),this.render=function(x,N){if(N!==void 0&&N.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(T===!0)return;if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),C.enabled===!0&&C.isPresenting===!0&&(C.cameraAutoUpdate===!0&&C.updateCamera(N),N=C.getCamera()),x.isScene===!0&&x.onBeforeRender(M,x,N,A),m=X.get(x,b.length),m.init(N),b.push(m),Te.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),qe.setFromProjectionMatrix(Te,Wt,N.reversedDepth),re=this.localClippingEnabled,k=de.init(this.clippingPlanes,re),_=Y.get(x,p.length),_.init(),p.push(_),C.enabled===!0&&C.isPresenting===!0){let $=M.xr.getDepthSensingMesh();$!==null&&Ta($,N,-1/0,M.sortObjects)}Ta(x,N,0,M.sortObjects),_.finish(),M.sortObjects===!0&&_.sort(q,ee),Fe=C.enabled===!1||C.isPresenting===!1||C.hasDepthSensing()===!1,Fe&&xe.addToRenderList(_,x),this.info.render.frame++,k===!0&&de.beginShadows();let H=m.state.shadowsArray;te.render(H,x,N),k===!0&&de.endShadows(),this.info.autoReset===!0&&this.info.reset();let G=_.opaque,I=_.transmissive;if(m.setupLights(),N.isArrayCamera){let $=N.cameras;if(I.length>0)for(let ue=0,fe=$.length;ue<fe;ue++){let me=$[ue];ms(G,I,x,me)}Fe&&xe.render(x);for(let ue=0,fe=$.length;ue<fe;ue++){let me=$[ue];fs(_,x,me,me.viewport)}}else I.length>0&&ms(G,I,x,N),Fe&&xe.render(x),fs(_,x,N);A!==null&&w===0&&(Pe.updateMultisampleRenderTarget(A),Pe.updateRenderTargetMipmap(A)),x.isScene===!0&&x.onAfterRender(M,x,N),pe.resetDefaultState(),O=-1,E=null,b.pop(),b.length>0?(m=b[b.length-1],k===!0&&de.setGlobalState(M.clippingPlanes,m.state.camera)):m=null,p.pop(),p.length>0?_=p[p.length-1]:_=null};function Ta(x,N,H,G){if(x.visible===!1)return;if(x.layers.test(N.layers)){if(x.isGroup)H=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(N);else if(x.isLight)m.pushLight(x),x.castShadow&&m.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||qe.intersectsSprite(x)){G&&_e.setFromMatrixPosition(x.matrixWorld).applyMatrix4(Te);let $=g.update(x),ue=x.material;ue.visible&&_.push(x,$,ue,H,_e.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||qe.intersectsObject(x))){let $=g.update(x),ue=x.material;if(G&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),_e.copy(x.boundingSphere.center)):($.boundingSphere===null&&$.computeBoundingSphere(),_e.copy($.boundingSphere.center)),_e.applyMatrix4(x.matrixWorld).applyMatrix4(Te)),Array.isArray(ue)){let fe=$.groups;for(let me=0,De=fe.length;me<De;me++){let Oe=fe[me],Ie=ue[Oe.materialIndex];Ie&&Ie.visible&&_.push(x,$,Ie,H,_e.z,Oe)}}else ue.visible&&_.push(x,$,ue,H,_e.z,null)}}let I=x.children;for(let $=0,ue=I.length;$<ue;$++)Ta(I[$],N,H,G)}function fs(x,N,H,G){let I=x.opaque,$=x.transmissive,ue=x.transparent;m.setupLightsView(H),k===!0&&de.setGlobalState(M.clippingPlanes,H),G&&Ae.viewport(y.copy(G)),I.length>0&&Di(I,N,H),$.length>0&&Di($,N,H),ue.length>0&&Di(ue,N,H),Ae.buffers.depth.setTest(!0),Ae.buffers.depth.setMask(!0),Ae.buffers.color.setMask(!0),Ae.setPolygonOffset(!1)}function ms(x,N,H,G){if((H.isScene===!0?H.overrideMaterial:null)!==null)return;m.state.transmissionRenderTarget[G.id]===void 0&&(m.state.transmissionRenderTarget[G.id]=new Tr(1,1,{generateMipmaps:!0,type:Ne.has("EXT_color_buffer_half_float")||Ne.has("EXT_color_buffer_float")?pi:kt,minFilter:Sr,samples:4,stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:je.workingColorSpace}));let I=m.state.transmissionRenderTarget[G.id],$=G.viewport||y;I.setSize($.z*M.transmissionResolutionScale,$.w*M.transmissionResolutionScale);let ue=M.getRenderTarget(),fe=M.getActiveCubeFace(),me=M.getActiveMipmapLevel();M.setRenderTarget(I),M.getClearColor(F),z=M.getClearAlpha(),z<1&&M.setClearColor(16777215,.5),M.clear(),Fe&&xe.render(H);let De=M.toneMapping;M.toneMapping=hr;let Oe=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),m.setupLightsView(G),k===!0&&de.setGlobalState(M.clippingPlanes,G),Di(x,H,G),Pe.updateMultisampleRenderTarget(I),Pe.updateRenderTargetMipmap(I),Ne.has("WEBGL_multisampled_render_to_texture")===!1){let Ie=!1;for(let ke=0,$e=N.length;ke<$e;ke++){let tt=N[ke],it=tt.object,Qe=tt.geometry,we=tt.material,pt=tt.group;if(we.side===Zt&&it.layers.test(G.layers)){let Jt=we.side;we.side=xt,we.needsUpdate=!0,gs(it,H,G,Qe,we,pt),we.side=Jt,we.needsUpdate=!0,Ie=!0}}Ie===!0&&(Pe.updateMultisampleRenderTarget(I),Pe.updateRenderTargetMipmap(I))}M.setRenderTarget(ue,fe,me),M.setClearColor(F,z),Oe!==void 0&&(G.viewport=Oe),M.toneMapping=De}function Di(x,N,H){let G=N.isScene===!0?N.overrideMaterial:null;for(let I=0,$=x.length;I<$;I++){let ue=x[I],fe=ue.object,me=ue.geometry,De=ue.group,Oe=ue.material;Oe.allowOverride===!0&&G!==null&&(Oe=G),fe.layers.test(H.layers)&&gs(fe,N,H,me,Oe,De)}}function gs(x,N,H,G,I,$){x.onBeforeRender(M,N,H,G,I,$),x.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),I.onBeforeRender(M,N,H,G,x,$),I.transparent===!0&&I.side===Zt&&I.forceSinglePass===!1?(I.side=xt,I.needsUpdate=!0,M.renderBufferDirect(H,N,G,I,x,$),I.side=or,I.needsUpdate=!0,M.renderBufferDirect(H,N,G,I,x,$),I.side=Zt):M.renderBufferDirect(H,N,G,I,x,$),x.onAfterRender(M,N,H,G,I,$)}function Ii(x,N,H){N.isScene!==!0&&(N=Le);let G=Se.get(x),I=m.state.lights,$=m.state.shadowsArray,ue=I.state.version,fe=L.getParameters(x,I.state,$,N,H),me=L.getProgramCacheKey(fe),De=G.programs;G.environment=x.isMeshStandardMaterial?N.environment:null,G.fog=N.fog,G.envMap=(x.isMeshStandardMaterial?ve:ie).get(x.envMap||G.environment),G.envMapRotation=G.environment!==null&&x.envMap===null?N.environmentRotation:x.envMapRotation,De===void 0&&(x.addEventListener("dispose",Q),De=new Map,G.programs=De);let Oe=De.get(me);if(Oe!==void 0){if(G.currentProgram===Oe&&G.lightsStateVersion===ue)return vs(x,fe),Oe}else fe.uniforms=L.getUniforms(x),x.onBeforeCompile(fe,M),Oe=L.acquireProgram(fe,me),De.set(me,Oe),G.uniforms=fe.uniforms;let Ie=G.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(Ie.clippingPlanes=de.uniform),vs(x,fe),G.needsLights=xl(x),G.lightsStateVersion=ue,G.needsLights&&(Ie.ambientLightColor.value=I.state.ambient,Ie.lightProbe.value=I.state.probe,Ie.directionalLights.value=I.state.directional,Ie.directionalLightShadows.value=I.state.directionalShadow,Ie.spotLights.value=I.state.spot,Ie.spotLightShadows.value=I.state.spotShadow,Ie.rectAreaLights.value=I.state.rectArea,Ie.ltc_1.value=I.state.rectAreaLTC1,Ie.ltc_2.value=I.state.rectAreaLTC2,Ie.pointLights.value=I.state.point,Ie.pointLightShadows.value=I.state.pointShadow,Ie.hemisphereLights.value=I.state.hemi,Ie.directionalShadowMap.value=I.state.directionalShadowMap,Ie.directionalShadowMatrix.value=I.state.directionalShadowMatrix,Ie.spotShadowMap.value=I.state.spotShadowMap,Ie.spotLightMatrix.value=I.state.spotLightMatrix,Ie.spotLightMap.value=I.state.spotLightMap,Ie.pointShadowMap.value=I.state.pointShadowMap,Ie.pointShadowMatrix.value=I.state.pointShadowMatrix),G.currentProgram=Oe,G.uniformsList=null,Oe}function _s(x){if(x.uniformsList===null){let N=x.currentProgram.getUniforms();x.uniformsList=ya.seqWithValue(N.seq,x.uniforms)}return x.uniformsList}function vs(x,N){let H=Se.get(x);H.outputColorSpace=N.outputColorSpace,H.batching=N.batching,H.batchingColor=N.batchingColor,H.instancing=N.instancing,H.instancingColor=N.instancingColor,H.instancingMorph=N.instancingMorph,H.skinning=N.skinning,H.morphTargets=N.morphTargets,H.morphNormals=N.morphNormals,H.morphColors=N.morphColors,H.morphTargetsCount=N.morphTargetsCount,H.numClippingPlanes=N.numClippingPlanes,H.numIntersection=N.numClipIntersection,H.vertexAlphas=N.vertexAlphas,H.vertexTangents=N.vertexTangents,H.toneMapping=N.toneMapping}function _l(x,N,H,G,I){N.isScene!==!0&&(N=Le),Pe.resetTextureUnits();let $=N.fog,ue=G.isMeshStandardMaterial?N.environment:null,fe=A===null?M.outputColorSpace:A.isXRRenderTarget===!0?A.texture.colorSpace:zr,me=(G.isMeshStandardMaterial?ve:ie).get(G.envMap||ue),De=G.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,Oe=!!H.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),Ie=!!H.morphAttributes.position,ke=!!H.morphAttributes.normal,$e=!!H.morphAttributes.color,tt=hr;G.toneMapped&&(A===null||A.isXRRenderTarget===!0)&&(tt=M.toneMapping);let it=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,Qe=it!==void 0?it.length:0,we=Se.get(G),pt=m.state.lights;if(k===!0&&(re===!0||x!==E)){let ft=x===E&&G.id===O;de.setState(G,x,ft)}let Jt=!1;G.version===we.__version?(we.needsLights&&we.lightsStateVersion!==pt.state.version||we.outputColorSpace!==fe||I.isBatchedMesh&&we.batching===!1||!I.isBatchedMesh&&we.batching===!0||I.isBatchedMesh&&we.batchingColor===!0&&I.colorTexture===null||I.isBatchedMesh&&we.batchingColor===!1&&I.colorTexture!==null||I.isInstancedMesh&&we.instancing===!1||!I.isInstancedMesh&&we.instancing===!0||I.isSkinnedMesh&&we.skinning===!1||!I.isSkinnedMesh&&we.skinning===!0||I.isInstancedMesh&&we.instancingColor===!0&&I.instanceColor===null||I.isInstancedMesh&&we.instancingColor===!1&&I.instanceColor!==null||I.isInstancedMesh&&we.instancingMorph===!0&&I.morphTexture===null||I.isInstancedMesh&&we.instancingMorph===!1&&I.morphTexture!==null||we.envMap!==me||G.fog===!0&&we.fog!==$||we.numClippingPlanes!==void 0&&(we.numClippingPlanes!==de.numPlanes||we.numIntersection!==de.numIntersection)||we.vertexAlphas!==De||we.vertexTangents!==Oe||we.morphTargets!==Ie||we.morphNormals!==ke||we.morphColors!==$e||we.toneMapping!==tt||we.morphTargetsCount!==Qe)&&(Jt=!0):(Jt=!0,we.__version=G.version);let Pt=we.currentProgram;Jt===!0&&(Pt=Ii(G,N,I));let Ir=!1,Mt=!1,ui=!1,at=Pt.getUniforms(),wt=we.uniforms;if(Ae.useProgram(Pt.program)&&(Ir=!0,Mt=!0,ui=!0),G.id!==O&&(O=G.id,Mt=!0),Ir||E!==x){Ae.buffers.depth.getReversed()&&x.reversedDepth!==!0&&(x._reversedDepth=!0,x.updateProjectionMatrix()),at.setValue(R,"projectionMatrix",x.projectionMatrix),at.setValue(R,"viewMatrix",x.matrixWorldInverse);let ft=at.map.cameraPosition;ft!==void 0&&ft.setValue(R,ce.setFromMatrixPosition(x.matrixWorld)),Ye.logarithmicDepthBuffer&&at.setValue(R,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&at.setValue(R,"isOrthographic",x.isOrthographicCamera===!0),E!==x&&(E=x,Mt=!0,ui=!0)}if(I.isSkinnedMesh){at.setOptional(R,I,"bindMatrix"),at.setOptional(R,I,"bindMatrixInverse");let ft=I.skeleton;ft&&(ft.boneTexture===null&&ft.computeBoneTexture(),at.setValue(R,"boneTexture",ft.boneTexture,Pe))}I.isBatchedMesh&&(at.setOptional(R,I,"batchingTexture"),at.setValue(R,"batchingTexture",I._matricesTexture,Pe),at.setOptional(R,I,"batchingIdTexture"),at.setValue(R,"batchingIdTexture",I._indirectTexture,Pe),at.setOptional(R,I,"batchingColorTexture"),I._colorsTexture!==null&&at.setValue(R,"batchingColorTexture",I._colorsTexture,Pe));let At=H.morphAttributes;if((At.position!==void 0||At.normal!==void 0||At.color!==void 0)&&be.update(I,H,Pt),(Mt||we.receiveShadow!==I.receiveShadow)&&(we.receiveShadow=I.receiveShadow,at.setValue(R,"receiveShadow",I.receiveShadow)),G.isMeshGouraudMaterial&&G.envMap!==null&&(wt.envMap.value=me,wt.flipEnvMap.value=me.isCubeTexture&&me.isRenderTargetTexture===!1?-1:1),G.isMeshStandardMaterial&&G.envMap===null&&N.environment!==null&&(wt.envMapIntensity.value=N.environmentIntensity),Mt&&(at.setValue(R,"toneMappingExposure",M.toneMappingExposure),we.needsLights&&vl(wt,ui),$&&G.fog===!0&&B.refreshFogUniforms(wt,$),B.refreshMaterialUniforms(wt,G,Z,j,m.state.transmissionRenderTarget[x.id]),ya.upload(R,_s(we),wt,Pe)),G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(ya.upload(R,_s(we),wt,Pe),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&at.setValue(R,"center",I.center),at.setValue(R,"modelViewMatrix",I.modelViewMatrix),at.setValue(R,"normalMatrix",I.normalMatrix),at.setValue(R,"modelMatrix",I.matrixWorld),G.isShaderMaterial||G.isRawShaderMaterial){let ft=G.uniformsGroups;for(let Lt=0,ba=ft.length;Lt<ba;Lt++){let xr=ft[Lt];le.update(xr,Pt),le.bind(xr,Pt)}}return Pt}function vl(x,N){x.ambientLightColor.needsUpdate=N,x.lightProbe.needsUpdate=N,x.directionalLights.needsUpdate=N,x.directionalLightShadows.needsUpdate=N,x.pointLights.needsUpdate=N,x.pointLightShadows.needsUpdate=N,x.spotLights.needsUpdate=N,x.spotLightShadows.needsUpdate=N,x.rectAreaLights.needsUpdate=N,x.hemisphereLights.needsUpdate=N}function xl(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return D},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return A},this.setRenderTargetTextures=function(x,N,H){let G=Se.get(x);G.__autoAllocateDepthBuffer=x.resolveDepthBuffer===!1,G.__autoAllocateDepthBuffer===!1&&(G.__useRenderToTexture=!1),Se.get(x.texture).__webglTexture=N,Se.get(x.depthTexture).__webglTexture=G.__autoAllocateDepthBuffer?void 0:H,G.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(x,N){let H=Se.get(x);H.__webglFramebuffer=N,H.__useDefaultFramebuffer=N===void 0};let yl=R.createFramebuffer();this.setRenderTarget=function(x,N=0,H=0){A=x,D=N,w=H;let G=!0,I=null,$=!1,ue=!1;if(x){let fe=Se.get(x);if(fe.__useDefaultFramebuffer!==void 0)Ae.bindFramebuffer(R.FRAMEBUFFER,null),G=!1;else if(fe.__webglFramebuffer===void 0)Pe.setupRenderTarget(x);else if(fe.__hasExternalTextures)Pe.rebindTextures(x,Se.get(x.texture).__webglTexture,Se.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){let Oe=x.depthTexture;if(fe.__boundDepthTexture!==Oe){if(Oe!==null&&Se.has(Oe)&&(x.width!==Oe.image.width||x.height!==Oe.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Pe.setupDepthRenderbuffer(x)}}let me=x.texture;(me.isData3DTexture||me.isDataArrayTexture||me.isCompressedArrayTexture)&&(ue=!0);let De=Se.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(De[N])?I=De[N][H]:I=De[N],$=!0):x.samples>0&&Pe.useMultisampledRTT(x)===!1?I=Se.get(x).__webglMultisampledFramebuffer:Array.isArray(De)?I=De[H]:I=De,y.copy(x.viewport),P.copy(x.scissor),V=x.scissorTest}else y.copy(se).multiplyScalar(Z).floor(),P.copy(Me).multiplyScalar(Z).floor(),V=Ge;if(H!==0&&(I=yl),Ae.bindFramebuffer(R.FRAMEBUFFER,I)&&G&&Ae.drawBuffers(x,I),Ae.viewport(y),Ae.scissor(P),Ae.setScissorTest(V),$){let fe=Se.get(x.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+N,fe.__webglTexture,H)}else if(ue){let fe=N;for(let me=0;me<x.textures.length;me++){let De=Se.get(x.textures[me]);R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0+me,De.__webglTexture,H,fe)}}else if(x!==null&&H!==0){let fe=Se.get(x.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,fe.__webglTexture,H)}O=-1},this.readRenderTargetPixels=function(x,N,H,G,I,$,ue,fe=0){if(!(x&&x.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let me=Se.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&ue!==void 0&&(me=me[ue]),me){Ae.bindFramebuffer(R.FRAMEBUFFER,me);try{let De=x.textures[fe],Oe=De.format,Ie=De.type;if(!Ye.textureFormatReadable(Oe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ye.textureTypeReadable(Ie)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=x.width-G&&H>=0&&H<=x.height-I&&(x.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+fe),R.readPixels(N,H,G,I,Ce.convert(Oe),Ce.convert(Ie),$))}finally{let De=A!==null?Se.get(A).__webglFramebuffer:null;Ae.bindFramebuffer(R.FRAMEBUFFER,De)}}},this.readRenderTargetPixelsAsync=async function(x,N,H,G,I,$,ue,fe=0){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let me=Se.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&ue!==void 0&&(me=me[ue]),me)if(N>=0&&N<=x.width-G&&H>=0&&H<=x.height-I){Ae.bindFramebuffer(R.FRAMEBUFFER,me);let De=x.textures[fe],Oe=De.format,Ie=De.type;if(!Ye.textureFormatReadable(Oe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ye.textureTypeReadable(Ie))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let ke=R.createBuffer();R.bindBuffer(R.PIXEL_PACK_BUFFER,ke),R.bufferData(R.PIXEL_PACK_BUFFER,$.byteLength,R.STREAM_READ),x.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+fe),R.readPixels(N,H,G,I,Ce.convert(Oe),Ce.convert(Ie),0);let $e=A!==null?Se.get(A).__webglFramebuffer:null;Ae.bindFramebuffer(R.FRAMEBUFFER,$e);let tt=R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE,0);return R.flush(),await wh(R,tt,4),R.bindBuffer(R.PIXEL_PACK_BUFFER,ke),R.getBufferSubData(R.PIXEL_PACK_BUFFER,0,$),R.deleteBuffer(ke),R.deleteSync(tt),$}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(x,N=null,H=0){let G=Math.pow(2,-H),I=Math.floor(x.image.width*G),$=Math.floor(x.image.height*G),ue=N!==null?N.x:0,fe=N!==null?N.y:0;Pe.setTexture2D(x,0),R.copyTexSubImage2D(R.TEXTURE_2D,H,0,0,ue,fe,I,$),Ae.unbindTexture()};let Ml=R.createFramebuffer(),Sl=R.createFramebuffer();this.copyTextureToTexture=function(x,N,H=null,G=null,I=0,$=null){$===null&&(I!==0?(Xr("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),$=I,I=0):$=0);let ue,fe,me,De,Oe,Ie,ke,$e,tt,it=x.isCompressedTexture?x.mipmaps[$]:x.image;if(H!==null)ue=H.max.x-H.min.x,fe=H.max.y-H.min.y,me=H.isBox3?H.max.z-H.min.z:1,De=H.min.x,Oe=H.min.y,Ie=H.isBox3?H.min.z:0;else{let At=Math.pow(2,-I);ue=Math.floor(it.width*At),fe=Math.floor(it.height*At),x.isDataArrayTexture?me=it.depth:x.isData3DTexture?me=Math.floor(it.depth*At):me=1,De=0,Oe=0,Ie=0}G!==null?(ke=G.x,$e=G.y,tt=G.z):(ke=0,$e=0,tt=0);let Qe=Ce.convert(N.format),we=Ce.convert(N.type),pt;N.isData3DTexture?(Pe.setTexture3D(N,0),pt=R.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(Pe.setTexture2DArray(N,0),pt=R.TEXTURE_2D_ARRAY):(Pe.setTexture2D(N,0),pt=R.TEXTURE_2D),R.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,N.flipY),R.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),R.pixelStorei(R.UNPACK_ALIGNMENT,N.unpackAlignment);let Jt=R.getParameter(R.UNPACK_ROW_LENGTH),Pt=R.getParameter(R.UNPACK_IMAGE_HEIGHT),Ir=R.getParameter(R.UNPACK_SKIP_PIXELS),Mt=R.getParameter(R.UNPACK_SKIP_ROWS),ui=R.getParameter(R.UNPACK_SKIP_IMAGES);R.pixelStorei(R.UNPACK_ROW_LENGTH,it.width),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,it.height),R.pixelStorei(R.UNPACK_SKIP_PIXELS,De),R.pixelStorei(R.UNPACK_SKIP_ROWS,Oe),R.pixelStorei(R.UNPACK_SKIP_IMAGES,Ie);let at=x.isDataArrayTexture||x.isData3DTexture,wt=N.isDataArrayTexture||N.isData3DTexture;if(x.isDepthTexture){let At=Se.get(x),ft=Se.get(N),Lt=Se.get(At.__renderTarget),ba=Se.get(ft.__renderTarget);Ae.bindFramebuffer(R.READ_FRAMEBUFFER,Lt.__webglFramebuffer),Ae.bindFramebuffer(R.DRAW_FRAMEBUFFER,ba.__webglFramebuffer);for(let xr=0;xr<me;xr++)at&&(R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,Se.get(x).__webglTexture,I,Ie+xr),R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,Se.get(N).__webglTexture,$,tt+xr)),R.blitFramebuffer(De,Oe,ue,fe,ke,$e,ue,fe,R.DEPTH_BUFFER_BIT,R.NEAREST);Ae.bindFramebuffer(R.READ_FRAMEBUFFER,null),Ae.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else if(I!==0||x.isRenderTargetTexture||Se.has(x)){let At=Se.get(x),ft=Se.get(N);Ae.bindFramebuffer(R.READ_FRAMEBUFFER,Ml),Ae.bindFramebuffer(R.DRAW_FRAMEBUFFER,Sl);for(let Lt=0;Lt<me;Lt++)at?R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,At.__webglTexture,I,Ie+Lt):R.framebufferTexture2D(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,At.__webglTexture,I),wt?R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,ft.__webglTexture,$,tt+Lt):R.framebufferTexture2D(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,ft.__webglTexture,$),I!==0?R.blitFramebuffer(De,Oe,ue,fe,ke,$e,ue,fe,R.COLOR_BUFFER_BIT,R.NEAREST):wt?R.copyTexSubImage3D(pt,$,ke,$e,tt+Lt,De,Oe,ue,fe):R.copyTexSubImage2D(pt,$,ke,$e,De,Oe,ue,fe);Ae.bindFramebuffer(R.READ_FRAMEBUFFER,null),Ae.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else wt?x.isDataTexture||x.isData3DTexture?R.texSubImage3D(pt,$,ke,$e,tt,ue,fe,me,Qe,we,it.data):N.isCompressedArrayTexture?R.compressedTexSubImage3D(pt,$,ke,$e,tt,ue,fe,me,Qe,it.data):R.texSubImage3D(pt,$,ke,$e,tt,ue,fe,me,Qe,we,it):x.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,$,ke,$e,ue,fe,Qe,we,it.data):x.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,$,ke,$e,it.width,it.height,Qe,it.data):R.texSubImage2D(R.TEXTURE_2D,$,ke,$e,ue,fe,Qe,we,it);R.pixelStorei(R.UNPACK_ROW_LENGTH,Jt),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,Pt),R.pixelStorei(R.UNPACK_SKIP_PIXELS,Ir),R.pixelStorei(R.UNPACK_SKIP_ROWS,Mt),R.pixelStorei(R.UNPACK_SKIP_IMAGES,ui),$===0&&N.generateMipmaps&&R.generateMipmap(pt),Ae.unbindTexture()},this.copyTextureToTexture3D=function(x,N,H=null,G=null,I=0){return Xr('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(x,N,H,G,I)},this.initRenderTarget=function(x){Se.get(x).__webglFramebuffer===void 0&&Pe.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?Pe.setTextureCube(x,0):x.isData3DTexture?Pe.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?Pe.setTexture2DArray(x,0):Pe.setTexture2D(x,0),Ae.unbindTexture()},this.resetState=function(){D=0,w=0,A=null,Ae.reset(),pe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Wt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=je._getDrawingBufferColorSpace(e),t.unpackColorSpace=je._getUnpackColorSpace()}};function Pm(e){if(!e)return()=>{};let t="#e9bd86",r="#56d39a",i=e.closest(".research-robot-wrap")?.querySelector(".robot-greeting"),a=window.matchMedia("(prefers-reduced-motion: reduce)"),n=new Set,s=[],o,l,h,c,u,d,f,v,_,m,p,b=0,M=!1,T=!0,D=!1,w=a.matches,A=0,O=0,E=0,y=0,P=!1,V=null,F=null,z={x:0,y:0},K=[],j=e.dataset.preview||e.closest("[data-preview]")?.dataset.preview,Z=new We(j==="attention"?r:t),q=Z.clone(),ee=performance.now();function se(ie){return n.add(ie),ie}function Me(ie,ve,ge,S){ie.addEventListener(ve,ge,S),s.push(()=>ie.removeEventListener(ve,ge,S))}function Ge(){M||(M=!0,i&&(i.textContent=""),cancelAnimationFrame(b),b=0,m?.disconnect(),p?.disconnect(),s.splice(0).forEach(ie=>ie()),n.forEach(ie=>ie.dispose()),n.clear(),o&&(o.domElement.remove(),o.dispose(),o.forceContextLoss()))}function qe(){e.dataset.robotState="unavailable",e.setAttribute("aria-disabled","true"),e.tabIndex=-1,Ge()}function k(){M||b||!T||document.hidden||!A||!O||(b=requestAnimationFrame(ce))}function re(){document.hidden||!T?(cancelAnimationFrame(b),b=0):(E=0,y=0,k())}function Te(ie,ve){let ge=(ie-ee)/1e3,S=w?1:1-Math.exp(-10*ve),g=w?1:1-Math.exp(-15*ve),L=w?0:Math.sin(ge*1.35)*.011;c.position.x=Qt.lerp(c.position.x,z.x*.055,S),c.position.y=Qt.lerp(c.position.y,-.3+L,S),c.rotation.x=Qt.lerp(c.rotation.x,-z.y*.055,S),c.rotation.y=Qt.lerp(c.rotation.y,-z.x*.11,S),c.rotation.z=Qt.lerp(c.rotation.z,-z.x*.045,S),u.rotation.y=Qt.lerp(u.rotation.y,z.x*.39,g),u.rotation.x=Qt.lerp(u.rotation.x,-z.y*.19,g);let B=(ge+1.1)%4.1,Y=!w&&!P&&B<.25?Math.max(.075,1-Math.sin(B/.25*Math.PI)):1;K.forEach(X=>{X.normal.visible=!P,X.heart.visible=P,X.group.scale.set(1.1,1.1*Y,1.1)}),Z.lerp(q,w?1:1-Math.exp(-7*ve)),f.color.copy(Z),v.color.copy(Z),v.emissive.copy(Z),d.uniforms.color.value.copy(Z),_.color.copy(Z)}function ce(ie){if(b=0,M||!T||document.hidden)return;let ve=1e3/45;if(!w&&y&&ie-y<ve-.5){k();return}let ge=E?Math.min((ie-E)/1e3,.08):1/45;E=ie,y=y?ie-(ie-y)%ve:ie;try{Te(ie,ge),o.render(l,h),D||(D=!0,e.dataset.robotState="ready")}catch{qe();return}w||k()}function _e(){M||(P=!P,e.setAttribute("aria-pressed",String(P)),i&&(i.textContent=P?"Hello, curious human.":""),k())}function Le(){V=null,F=null,z.x=z.y=0,k()}function Fe(){if(!V||M)return;let ie=e.getBoundingClientRect();if(!ie.width||!ie.height)return;let ve=ie.left+ie.width/2,ge=ie.top+ie.height/2,S=V.x-ve,g=V.y-ge;z.x=Qt.clamp(S/Math.max(1,S<0?ve:window.innerWidth-ve),-1,1),z.y=Qt.clamp(-g/Math.max(1,g<0?ge:window.innerHeight-ge),-1,1),k()}function Xe(ie){M||ie.isPrimary===!1||(F&&ie.pointerId===F.id&&Math.hypot(ie.clientX-F.x,ie.clientY-F.y)>=12&&(F.moved=!0),!(ie.pointerType==="touch"&&!e.contains(ie.target))&&(V={x:ie.clientX,y:ie.clientY},Fe()))}function R(){if(M)return;let ie=e.getBoundingClientRect();A=Math.round(ie.width),O=Math.round(ie.height),!(!A||!O)&&(o.setPixelRatio(Math.min(window.devicePixelRatio||1,1.5)),o.setSize(A,O,!1),h.aspect=A/O,h.updateProjectionMatrix(),Fe(),k())}function et(ie){return se(new xc(ie))}function Ne(ie,ve,ge,S,g){let L=new bt(se(ve),ge);return S&&L.position.set(...S),g&&L.rotation.set(...g),ie.add(L),L}function Ye(){let ie=document.createElement("canvas");ie.width=ie.height=256;let ve=ie.getContext("2d");if(!ve)return null;ve.fillStyle="#f1eade",ve.fillRect(0,0,256,256);let ge=4197,S=()=>(ge=ge*1664525+1013904223>>>0,ge/4294967296);for(let L=0;L<2400;L+=1)ve.beginPath(),ve.arc(S()*256,S()*256,.3+S()*.6,0,Math.PI*2),ve.fillStyle=S()>.2?"rgba(78,64,44,.25)":"rgba(255,251,243,.7)",ve.fill();let g=se(new go(ie));return g.colorSpace=yt,g.wrapS=g.wrapT=Oi,g.repeat.set(4,2),g}function Ae(){let ie=document.createElement("canvas");ie.width=ie.height=128;let ve=ie.getContext("2d");if(!ve)return;let ge=ve.createRadialGradient(64,64,5,64,64,62);ge.addColorStop(0,"rgba(0,0,0,.64)"),ge.addColorStop(.45,"rgba(0,0,0,.24)"),ge.addColorStop(1,"rgba(0,0,0,0)"),ve.fillStyle=ge,ve.fillRect(0,0,128,128);let S=se(new go(ie)),g=se(new wi({map:S,transparent:!0,depthWrite:!1,opacity:.75}));Ne(l,new Qn(1.35,.9),g,[0,-.744,0],[-Math.PI/2,0,0])}function Ze(ie,ve,ge,S){let g=ge?-1:1,L=new jt;L.position.set(ve,0,0),L.scale.setScalar(1.3),ie.add(L),Ne(L,new ca(.04,.04,.025,24),S.earBase,null,[0,0,Math.PI/2]),Ne(L,new yo(.032,.008,10,24),S.gold,[g*.012,0,0],[0,Math.PI/2,0]),Ne(L,new ca(.025,.025,.006,24),S.earCenter,[g*.017,0,0],[0,0,Math.PI/2]);let B=new jt;B.position.set(g*.015,.035,0),B.rotation.x=-.4,L.add(B),Ne(B,new ca(.006,.008,.02,12),S.gold,[0,.01,0]),Ne(B,new ca(.003,.003,.1,8),S.gold,[0,.06,0]),Ne(B,new fa(.008,12,8),v,[0,.11,0])}function Se(ie){let ve=new gc,ge=.025,S=.035,g=.02,L=.005,B=(Y,X)=>new U(Y,X*ie,0);return ve.add(new da(B(-ge,L),B(-ge,S-g))),ve.add(new pa(B(-ge,S-g),B(-ge,S),B(-ge+g,S))),ve.add(new da(B(-ge+g,S),B(ge-g,S))),ve.add(new pa(B(ge-g,S),B(ge,S),B(ge,S-g))),ve.add(new da(B(ge,S-g),B(ge,L))),ve}function Pe(ie,ve,ge,S,g){let L=new jt;L.position.set(ie,-.02,.29),L.rotation.y=ve,L.scale.setScalar(1.1),u.add(L);let B=new jt;L.add(B),B.add(new bt(ge,f)),B.add(new bt(S,f));let Y=new bt(g,f);Y.visible=!1,L.add(Y),K.push({group:L,normal:B,heart:Y})}try{e.dataset.robotState="loading",e.setAttribute("aria-pressed","false"),o=new Cm({alpha:!0,antialias:!0,powerPreference:"low-power"}),o.outputColorSpace=yt,o.toneMapping=Ts,o.toneMappingExposure=1.12,o.setClearColor(0,0);let ie=o.domElement;ie.className="robot-canvas research-robot-canvas",ie.setAttribute("aria-hidden","true"),Object.assign(ie.style,{position:"absolute",inset:"0",width:"100%",height:"100%",display:"block",pointerEvents:"none"}),e.prepend(ie),Me(ie,"webglcontextlost",W=>{W.preventDefault(),qe()}),l=new $h,h=new Ct(34,1,.1,20),h.position.set(0,.045,2.82),h.lookAt(0,-.055,0),l.add(new Dc("#fff0d8","#504938",1.1));let ve=new rs("#ffe8c6",2.6);ve.position.set(3,4,5),l.add(ve);let ge=new rs("#fff4e3",1.35);ge.position.set(-3,1,3),l.add(ge);let S=new rs("#e9bd86",3.1);S.position.set(-1,3,-3),l.add(S);let g=Ye(),L=et({color:"#d8ccb8",map:g,roughness:.52,metalness:.1}),B={gold:et({color:"#b49a72",roughness:.31,metalness:.54}),earBase:et({color:"#c9bda9",roughness:.43,metalness:.24}),earCenter:et({color:"#75654e",roughness:.65,metalness:.24})};f=se(new wi({color:Z,toneMapped:!1})),v=et({color:Z,emissive:Z,emissiveIntensity:.4,roughness:.28,metalness:.2}),_=se(new wi({color:Z,transparent:!0,opacity:.09,depthWrite:!1,toneMapped:!1})),d=se(new sr({uniforms:{color:{value:Z.clone()},power:{value:3.8},intensity:{value:.55}},transparent:!0,blending:wa,depthWrite:!1,vertexShader:`
        varying vec3 vNormal;
        varying vec3 vViewPosition;
        void main() {
      ...
      `})),c=new jt,c.position.y=-.3,l.add(c),Ne(c,new fa(.43,48,32,0,Math.PI*2,Math.PI*.15,Math.PI*.85),L),Ne(c,new yo(.235,.025,12,48),B.gold,[0,.34,0],[Math.PI/2,0,0]);let Y=[[.1,-.05],[.215,-.05],[.28,.02],[.295,.045],[.27,.055],[.1,.055],[.1,.055]].map(([W,ae])=>new Re(W,ae));Ne(c,new _c(Y,48),B.gold,[0,.38,0]),u=new jt,u.position.y=.6,c.add(u);let X=et({color:"#101110",roughness:.36,metalness:.16});Ne(u,new fa(.28,48,32),X),Ne(u,new fa(.3,48,32),d);class de extends zt{getPoint(ae,Ce=new U){let pe=ae*Math.PI*2,le=16*Math.pow(Math.sin(pe),3),ze=13*Math.cos(pe)-5*Math.cos(2*pe)-2*Math.cos(3*pe)-Math.cos(4*pe);return Ce.set(le*.002,(ze+6)*.002,0)}}let te=se(new es(Se(1),20,.0042,8,!1)),xe=se(new es(Se(-1),20,.0042,8,!1)),be=se(new es(new de,48,.0038,8,!0));Pe(-.07,-.2,te,xe,be),Pe(.07,.2,te,xe,be),Ze(u,-.29,!0,B),Ze(u,.29,!1,B),Ne(l,new vc(.37,.375,72),_,[0,-.741,0],[-Math.PI/2,0,0]),Ae(),Me(document,"pointermove",Xe,{passive:!0,capture:!0}),Me(document,"pointerleave",Le,{passive:!0}),Me(window,"blur",Le),Me(window,"scroll",Fe,{passive:!0,capture:!0}),Me(e,"pointerleave",()=>{F=null},{passive:!0}),Me(e,"pointerdown",W=>{W.button!==0||W.isPrimary===!1||W.target.closest?.("a, button, input, select")||(Xe(W),F={id:W.pointerId,x:W.clientX,y:W.clientY,at:performance.now(),moved:!1})},{passive:!0}),Me(e,"pointerup",W=>{if(!F||F.id!==W.pointerId)return;let ae=e.getBoundingClientRect(),Ce=W.clientX>=ae.left&&W.clientX<=ae.right&&W.clientY>=ae.top&&W.clientY<=ae.bottom,pe=Math.hypot(W.clientX-F.x,W.clientY-F.y);Ce&&!F.moved&&pe<12&&performance.now()-F.at<700&&_e(),F=null},{passive:!0}),Me(e,"pointercancel",()=>{F=null},{passive:!0}),Me(e,"keydown",W=>{W.target.closest?.("a, button, input, select")&&W.target!==e||(W.key==="Enter"||W.key===" "?(W.preventDefault(),W.repeat||_e()):W.key.startsWith("Arrow")?(W.preventDefault(),W.key==="ArrowLeft"&&(z.x=Math.max(-1,z.x-.35)),W.key==="ArrowRight"&&(z.x=Math.min(1,z.x+.35)),W.key==="ArrowUp"&&(z.y=Math.min(1,z.y+.35)),W.key==="ArrowDown"&&(z.y=Math.max(-1,z.y-.35)),k()):W.key==="Escape"&&(z.x=z.y=0,k()))}),Me(e,"research-preview-change",W=>{q.set(W.detail?.preview==="attention"?r:t),k()}),Me(a,"change",()=>{w=a.matches,E=0,k()}),Me(document,"visibilitychange",re),Me(window,"resize",R,{passive:!0}),"ResizeObserver"in window&&(m=new ResizeObserver(R),m.observe(e)),"IntersectionObserver"in window&&(p=new IntersectionObserver(W=>{T=W[0]?.isIntersecting??!0,re()},{rootMargin:"80px"}),p.observe(e)),R()}catch{qe()}return()=>{Ge(),e.dataset.robotState="unavailable"}}var Lm=document.getElementById("research-robot"),Um=Pm(Lm);window.addEventListener("pagehide",e=>{e.persisted||Um()},{once:!0});
