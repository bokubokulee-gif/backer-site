...
`)+`
`+u);let E=T+m+a,y=T+u+o,R=gc(s,s.VERTEX_SHADER,E),w=gc(s,s.FRAGMENT_SHADER,y);s.attachShader(x,R),s.attachShader(x,w),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function I(C){if(i.debug.checkShaderErrors){let B=s.getProgramInfoLog(x)||"",O=s.getShaderInfoLog(R)||"",V=s.getShaderInfoLog(w)||"",$=B.trim(),H=O.trim(),ne=V.trim(),G=!0,ie=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(G=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,R,w);else{let ae=xc(s,R,"vertex"),Te=xc(s,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
Program Info Log: `+$+`
`+ae+`
`+Te)}else $!==""?console.warn("THREE.WebGLProgram: Program Info Log:",$):(H===""||ne==="")&&(ie=!1);ie&&(C.diagnostics={runnable:G,programLog:$,vertexShader:{log:H,prefix:m},fragmentShader:{log:ne,prefix:u}})}s.deleteShader(R),s.deleteShader(w),U=new Oi(s,x),M=Dp(s,x)}let U;this.getUniforms=function(){return U===void 0&&I(this),U};let M;this.getAttributes=function(){return M===void 0&&I(this),M};let S=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return S===!1&&(S=s.getProgramParameter(x,Ep)),S},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Tp++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=R,this.fragmentShader=w,this}var Xp=0,Uo=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){let t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(s)===!1&&(a.add(s),s.usedTimes++),a.has(r)===!1&&(a.add(r),r.usedTimes++),this}remove(e){let t=this.materialCache.get(e);for(let n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){let t=this.materialCache,n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){let t=this.shaderCache,n=t.get(e);return n===void 0&&(n=new No(e),t.set(e,n)),n}},No=class{constructor(e){this.id=Xp++,this.code=e,this.usedTimes=0}};function qp(i,e,t,n,s,r,a){let o=new ji,c=new Uo,l=new Set,h=[],d=s.logarithmicDepthBuffer,p=s.vertexTextures,f=s.precision,_={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(M){return l.add(M),M===0?"uv":`uv${M}`}function m(M,S,C,B,O){let V=B.fog,$=O.geometry,H=M.isMeshStandardMaterial?B.environment:null,ne=(M.isMeshStandardMaterial?t:e).get(M.envMap||H),G=ne&&ne.mapping===gs?ne.image.height:null,ie=_[M.type];M.precision!==null&&(f=s.getMaxPrecision(M.precision),f!==M.precision&&console.warn("THREE.WebGLProgram.getParameters:",M.precision,"not supported, using",f,"instead."));let ae=$.morphAttributes.position||$.morphAttributes.normal||$.morphAttributes.color,Te=ae!==void 0?ae.length:0,Ne=0;$.morphAttributes.position!==void 0&&(Ne=1),$.morphAttributes.normal!==void 0&&(Ne=2),$.morphAttributes.color!==void 0&&(Ne=3);let Ge,Ze,Y,ce;if(ie){let Je=nn[ie];Ge=Je.vertexShader,Ze=Je.fragmentShader}else Ge=M.vertexShader,Ze=M.fragmentShader,c.update(M),Y=c.getVertexShaderID(M),ce=c.getFragmentShaderID(M);let re=i.getRenderTarget(),Ie=i.state.buffers.depth.getReversed(),Ae=O.isInstancedMesh===!0,Ue=O.isBatchedMesh===!0,it=!!M.map,ze=!!M.matcap,A=!!ne,Ke=!!M.aoMap,Re=!!M.lightMap,Xe=!!M.bumpMap,Ee=!!M.normalMap,et=!!M.displacementMap,X=!!M.emissiveMap,oe=!!M.metalnessMap,_e=!!M.roughnessMap,pe=M.anisotropy>0,b=M.clearcoat>0,g=M.dispersion>0,L=M.iridescence>0,W=M.sheen>0,J=M.transmission>0,q=pe&&!!M.anisotropyMap,Me=b&&!!M.clearcoatMap,se=b&&!!M.clearcoatNormalMap,xe=b&&!!M.clearcoatRoughnessMap,Q=L&&!!M.iridescenceMap,K=L&&!!M.iridescenceThicknessMap,he=W&&!!M.sheenColorMap,we=W&&!!M.sheenRoughnessMap,Se=!!M.specularMap,ue=!!M.specularColorMap,Be=!!M.specularIntensityMap,P=J&&!!M.transmissionMap,te=J&&!!M.thicknessMap,le=!!M.gradientMap,ge=!!M.alphaMap,j=M.alphaTest>0,Z=!!M.alphaHash,ye=!!M.extensions,Fe=gn;M.toneMapped&&(re===null||re.isXRRenderTarget===!0)&&(Fe=i.toneMapping);let nt={shaderID:ie,shaderType:M.type,shaderName:M.name,vertexShader:Ge,fragmentShader:Ze,defines:M.defines,customVertexShaderID:Y,customFragmentShaderID:ce,isRawShaderMaterial:M.isRawShaderMaterial===!0,glslVersion:M.glslVersion,precision:f,batching:Ue,batchingColor:Ue&&O._colorsTexture!==null,instancing:Ae,instancingColor:Ae&&O.instanceColor!==null,instancingMorph:Ae&&O.morphTexture!==null,supportsVertexTextures:p,outputColorSpace:re===null?i.outputColorSpace:re.isXRRenderTarget===!0?re.texture.colorSpace:qn,alphaToCoverage:!!M.alphaToCoverage,map:it,matcap:ze,envMap:A,envMapMode:A&&ne.mapping,envMapCubeUVHeight:G,aoMap:Ke,lightMap:Re,bumpMap:Xe,normalMap:Ee,displacementMap:p&&et,emissiveMap:X,normalMapObjectSpace:Ee&&M.normalMapType===Wl,normalMapTangentSpace:Ee&&M.normalMapType===po,metalnessMap:oe,roughnessMap:_e,anisotropy:pe,anisotropyMap:q,clearcoat:b,clearcoatMap:Me,clearcoatNormalMap:se,clearcoatRoughnessMap:xe,dispersion:g,iridescence:L,iridescenceMap:Q,iridescenceThicknessMap:K,sheen:W,sheenColorMap:he,sheenRoughnessMap:we,specularMap:Se,specularColorMap:ue,specularIntensityMap:Be,transmission:J,transmissionMap:P,thicknessMap:te,gradientMap:le,opaque:M.transparent===!1&&M.blending===Wn&&M.alphaToCoverage===!1,alphaMap:ge,alphaTest:j,alphaHash:Z,combine:M.combine,mapUv:it&&x(M.map.channel),aoMapUv:Ke&&x(M.aoMap.channel),lightMapUv:Re&&x(M.lightMap.channel),bumpMapUv:Xe&&x(M.bumpMap.channel),normalMapUv:Ee&&x(M.normalMap.channel),displacementMapUv:et&&x(M.displacementMap.channel),emissiveMapUv:X&&x(M.emissiveMap.channel),metalnessMapUv:oe&&x(M.metalnessMap.channel),roughnessMapUv:_e&&x(M.roughnessMap.channel),anisotropyMapUv:q&&x(M.anisotropyMap.channel),clearcoatMapUv:Me&&x(M.clearcoatMap.channel),clearcoatNormalMapUv:se&&x(M.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:xe&&x(M.clearcoatRoughnessMap.channel),iridescenceMapUv:Q&&x(M.iridescenceMap.channel),iridescenceThicknessMapUv:K&&x(M.iridescenceThicknessMap.channel),sheenColorMapUv:he&&x(M.sheenColorMap.channel),sheenRoughnessMapUv:we&&x(M.sheenRoughnessMap.channel),specularMapUv:Se&&x(M.specularMap.channel),specularColorMapUv:ue&&x(M.specularColorMap.channel),specularIntensityMapUv:Be&&x(M.specularIntensityMap.channel),transmissionMapUv:P&&x(M.transmissionMap.channel),thicknessMapUv:te&&x(M.thicknessMap.channel),alphaMapUv:ge&&x(M.alphaMap.channel),vertexTangents:!!$.attributes.tangent&&(Ee||pe),vertexColors:M.vertexColors,vertexAlphas:M.vertexColors===!0&&!!$.attributes.color&&$.attributes.color.itemSize===4,pointsUvs:O.isPoints===!0&&!!$.attributes.uv&&(it||ge),fog:!!V,useFog:M.fog===!0,fogExp2:!!V&&V.isFogExp2,flatShading:M.flatShading===!0&&M.wireframe===!1,sizeAttenuation:M.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:Ie,skinning:O.isSkinnedMesh===!0,morphTargets:$.morphAttributes.position!==void 0,morphNormals:$.morphAttributes.normal!==void 0,morphColors:$.morphAttributes.color!==void 0,morphTargetsCount:Te,morphTextureStride:Ne,numDirLights:S.directional.length,numPointLights:S.point.length,numSpotLights:S.spot.length,numSpotLightMaps:S.spotLightMap.length,numRectAreaLights:S.rectArea.length,numHemiLights:S.hemi.length,numDirLightShadows:S.directionalShadowMap.length,numPointLightShadows:S.pointShadowMap.length,numSpotLightShadows:S.spotShadowMap.length,numSpotLightShadowsWithMaps:S.numSpotLightShadowsWithMaps,numLightProbes:S.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:M.dithering,shadowMapEnabled:i.shadowMap.enabled&&C.length>0,shadowMapType:i.shadowMap.type,toneMapping:Fe,decodeVideoTexture:it&&M.map.isVideoTexture===!0&&qe.getTransfer(M.map.colorSpace)===$e,decodeVideoTextureEmissive:X&&M.emissiveMap.isVideoTexture===!0&&qe.getTransfer(M.emissiveMap.colorSpace)===$e,premultipliedAlpha:M.premultipliedAlpha,doubleSided:M.side===en,flipSided:M.side===Tt,useDepthPacking:M.depthPacking>=0,depthPacking:M.depthPacking||0,index0AttributeName:M.index0AttributeName,extensionClipCullDistance:ye&&M.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ye&&M.extensions.multiDraw===!0||Ue)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:M.customProgramCacheKey()};return nt.vertexUv1s=l.has(1),nt.vertexUv2s=l.has(2),nt.vertexUv3s=l.has(3),l.clear(),nt}function u(M){let S=[];if(M.shaderID?S.push(M.shaderID):(S.push(M.customVertexShaderID),S.push(M.customFragmentShaderID)),M.defines!==void 0)for(let C in M.defines)S.push(C),S.push(M.defines[C]);return M.isRawShaderMaterial===!1&&(T(S,M),E(S,M),S.push(i.outputColorSpace)),S.push(M.customProgramCacheKey),S.join()}function T(M,S){M.push(S.precision),M.push(S.outputColorSpace),M.push(S.envMapMode),M.push(S.envMapCubeUVHeight),M.push(S.mapUv),M.push(S.alphaMapUv),M.push(S.lightMapUv),M.push(S.aoMapUv),M.push(S.bumpMapUv),M.push(S.normalMapUv),M.push(S.displacementMapUv),M.push(S.emissiveMapUv),M.push(S.metalnessMapUv),M.push(S.roughnessMapUv),M.push(S.anisotropyMapUv),M.push(S.clearcoatMapUv),M.push(S.clearcoatNormalMapUv),M.push(S.clearcoatRoughnessMapUv),M.push(S.iridescenceMapUv),M.push(S.iridescenceThicknessMapUv),M.push(S.sheenColorMapUv),M.push(S.sheenRoughnessMapUv),M.push(S.specularMapUv),M.push(S.specularColorMapUv),M.push(S.specularIntensityMapUv),M.push(S.transmissionMapUv),M.push(S.thicknessMapUv),M.push(S.combine),M.push(S.fogExp2),M.push(S.sizeAttenuation),M.push(S.morphTargetsCount),M.push(S.morphAttributeCount),M.push(S.numDirLights),M.push(S.numPointLights),M.push(S.numSpotLights),M.push(S.numSpotLightMaps),M.push(S.numHemiLights),M.push(S.numRectAreaLights),M.push(S.numDirLightShadows),M.push(S.numPointLightShadows),M.push(S.numSpotLightShadows),M.push(S.numSpotLightShadowsWithMaps),M.push(S.numLightProbes),M.push(S.shadowMapType),M.push(S.toneMapping),M.push(S.numClippingPlanes),M.push(S.numClipIntersection),M.push(S.depthPacking)}function E(M,S){o.disableAll(),S.supportsVertexTextures&&o.enable(0),S.instancing&&o.enable(1),S.instancingColor&&o.enable(2),S.instancingMorph&&o.enable(3),S.matcap&&o.enable(4),S.envMap&&o.enable(5),S.normalMapObjectSpace&&o.enable(6),S.normalMapTangentSpace&&o.enable(7),S.clearcoat&&o.enable(8),S.iridescence&&o.enable(9),S.alphaTest&&o.enable(10),S.vertexColors&&o.enable(11),S.vertexAlphas&&o.enable(12),S.vertexUv1s&&o.enable(13),S.vertexUv2s&&o.enable(14),S.vertexUv3s&&o.enable(15),S.vertexTangents&&o.enable(16),S.anisotropy&&o.enable(17),S.alphaHash&&o.enable(18),S.batching&&o.enable(19),S.dispersion&&o.enable(20),S.batchingColor&&o.enable(21),S.gradientMap&&o.enable(22),M.push(o.mask),o.disableAll(),S.fog&&o.enable(0),S.useFog&&o.enable(1),S.flatShading&&o.enable(2),S.logarithmicDepthBuffer&&o.enable(3),S.reversedDepthBuffer&&o.enable(4),S.skinning&&o.enable(5),S.morphTargets&&o.enable(6),S.morphNormals&&o.enable(7),S.morphColors&&o.enable(8),S.premultipliedAlpha&&o.enable(9),S.shadowMapEnabled&&o.enable(10),S.doubleSided&&o.enable(11),S.flipSided&&o.enable(12),S.useDepthPacking&&o.enable(13),S.dithering&&o.enable(14),S.transmission&&o.enable(15),S.sheen&&o.enable(16),S.opaque&&o.enable(17),S.pointsUvs&&o.enable(18),S.decodeVideoTexture&&o.enable(19),S.decodeVideoTextureEmissive&&o.enable(20),S.alphaToCoverage&&o.enable(21),M.push(o.mask)}function y(M){let S=_[M.type],C;if(S){let B=nn[S];C=tc.clone(B.uniforms)}else C=M.uniforms;return C}function R(M,S){let C;for(let B=0,O=h.length;B<O;B++){let V=h[B];if(V.cacheKey===S){C=V,++C.usedTimes;break}}return C===void 0&&(C=new Wp(i,S,M,r),h.push(C)),C}function w(M){if(--M.usedTimes===0){let S=h.indexOf(M);h[S]=h[h.length-1],h.pop(),M.destroy()}}function I(M){c.remove(M)}function U(){c.dispose()}return{getParameters:m,getProgramCacheKey:u,getUniforms:y,acquireProgram:R,releaseProgram:w,releaseShaderCache:I,programs:h,dispose:U}}function Yp(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,c){i.get(a)[o]=c}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function Zp(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function bc(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Ec(){let i=[],e=0,t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function a(d,p,f,_,x,m){let u=i[e];return u===void 0?(u={id:d.id,object:d,geometry:p,material:f,groupOrder:_,renderOrder:d.renderOrder,z:x,group:m},i[e]=u):(u.id=d.id,u.object=d,u.geometry=p,u.material=f,u.groupOrder=_,u.renderOrder=d.renderOrder,u.z=x,u.group=m),e++,u}function o(d,p,f,_,x,m){let u=a(d,p,f,_,x,m);f.transmission>0?n.push(u):f.transparent===!0?s.push(u):t.push(u)}function c(d,p,f,_,x,m){let u=a(d,p,f,_,x,m);f.transmission>0?n.unshift(u):f.transparent===!0?s.unshift(u):t.unshift(u)}function l(d,p){t.length>1&&t.sort(d||Zp),n.length>1&&n.sort(p||bc),s.length>1&&s.sort(p||bc)}function h(){for(let d=e,p=i.length;d<p;d++){let f=i[d];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:o,unshift:c,finish:h,sort:l}}function Jp(){let i=new WeakMap;function e(n,s){let r=i.get(n),a;return r===void 0?(a=new Ec,i.set(n,[a])):s>=r.length?(a=new Ec,r.push(a)):a=r[s],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function $p(){let i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new D,color:new He};break;case"SpotLight":t={position:new D,direction:new D,color:new He,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new D,color:new He,distance:0,decay:0};break;case"HemisphereLight":t={direction:new D,skyColor:new He,groundColor:new He};break;case"RectAreaLight":t={color:new He,position:new D,halfWidth:new D,halfHeight:new D};break}return i[e.id]=t,t}}}function Kp(){let i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new be};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new be};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new be,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}var Qp=0;function jp(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function em(i){let e=new $p,t=Kp(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new D);let s=new D,r=new ht,a=new ht;function o(l){let h=0,d=0,p=0;for(let M=0;M<9;M++)n.probe[M].set(0,0,0);let f=0,_=0,x=0,m=0,u=0,T=0,E=0,y=0,R=0,w=0,I=0;l.sort(jp);for(let M=0,S=l.length;M<S;M++){let C=l[M],B=C.color,O=C.intensity,V=C.distance,$=C.shadow&&C.shadow.map?C.shadow.map.texture:null;if(C.isAmbientLight)h+=B.r*O,d+=B.g*O,p+=B.b*O;else if(C.isLightProbe){for(let H=0;H<9;H++)n.probe[H].addScaledVector(C.sh.coefficients[H],O);I++}else if(C.isDirectionalLight){let H=e.get(C);if(H.color.copy(C.color).multiplyScalar(C.intensity),C.castShadow){let ne=C.shadow,G=t.get(C);G.shadowIntensity=ne.intensity,G.shadowBias=ne.bias,G.shadowNormalBias=ne.normalBias,G.shadowRadius=ne.radius,G.shadowMapSize=ne.mapSize,n.directionalShadow[f]=G,n.directionalShadowMap[f]=$,n.directionalShadowMatrix[f]=C.shadow.matrix,T++}n.directional[f]=H,f++}else if(C.isSpotLight){let H=e.get(C);H.position.setFromMatrixPosition(C.matrixWorld),H.color.copy(B).multiplyScalar(O),H.distance=V,H.coneCos=Math.cos(C.angle),H.penumbraCos=Math.cos(C.angle*(1-C.penumbra)),H.decay=C.decay,n.spot[x]=H;let ne=C.shadow;if(C.map&&(n.spotLightMap[R]=C.map,R++,ne.updateMatrices(C),C.castShadow&&w++),n.spotLightMatrix[x]=ne.matrix,C.castShadow){let G=t.get(C);G.shadowIntensity=ne.intensity,G.shadowBias=ne.bias,G.shadowNormalBias=ne.normalBias,G.shadowRadius=ne.radius,G.shadowMapSize=ne.mapSize,n.spotShadow[x]=G,n.spotShadowMap[x]=$,y++}x++}else if(C.isRectAreaLight){let H=e.get(C);H.color.copy(B).multiplyScalar(O),H.halfWidth.set(C.width*.5,0,0),H.halfHeight.set(0,C.height*.5,0),n.rectArea[m]=H,m++}else if(C.isPointLight){let H=e.get(C);if(H.color.copy(C.color).multiplyScalar(C.intensity),H.distance=C.distance,H.decay=C.decay,C.castShadow){let ne=C.shadow,G=t.get(C);G.shadowIntensity=ne.intensity,G.shadowBias=ne.bias,G.shadowNormalBias=ne.normalBias,G.shadowRadius=ne.radius,G.shadowMapSize=ne.mapSize,G.shadowCameraNear=ne.camera.near,G.shadowCameraFar=ne.camera.far,n.pointShadow[_]=G,n.pointShadowMap[_]=$,n.pointShadowMatrix[_]=C.shadow.matrix,E++}n.point[_]=H,_++}else if(C.isHemisphereLight){let H=e.get(C);H.skyColor.copy(C.color).multiplyScalar(O),H.groundColor.copy(C.groundColor).multiplyScalar(O),n.hemi[u]=H,u++}}m>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=de.LTC_FLOAT_1,n.rectAreaLTC2=de.LTC_FLOAT_2):(n.rectAreaLTC1=de.LTC_HALF_1,n.rectAreaLTC2=de.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=d,n.ambient[2]=p;let U=n.hash;(U.directionalLength!==f||U.pointLength!==_||U.spotLength!==x||U.rectAreaLength!==m||U.hemiLength!==u||U.numDirectionalShadows!==T||U.numPointShadows!==E||U.numSpotShadows!==y||U.numSpotMaps!==R||U.numLightProbes!==I)&&(n.directional.length=f,n.spot.length=x,n.rectArea.length=m,n.point.length=_,n.hemi.length=u,n.directionalShadow.length=T,n.directionalShadowMap.length=T,n.pointShadow.length=E,n.pointShadowMap.length=E,n.spotShadow.length=y,n.spotShadowMap.length=y,n.directionalShadowMatrix.length=T,n.pointShadowMatrix.length=E,n.spotLightMatrix.length=y+R-w,n.spotLightMap.length=R,n.numSpotLightShadowsWithMaps=w,n.numLightProbes=I,U.directionalLength=f,U.pointLength=_,U.spotLength=x,U.rectAreaLength=m,U.hemiLength=u,U.numDirectionalShadows=T,U.numPointShadows=E,U.numSpotShadows=y,U.numSpotMaps=R,U.numLightProbes=I,n.version=Qp++)}function c(l,h){let d=0,p=0,f=0,_=0,x=0,m=h.matrixWorldInverse;for(let u=0,T=l.length;u<T;u++){let E=l[u];if(E.isDirectionalLight){let y=n.directional[d];y.direction.setFromMatrixPosition(E.matrixWorld),s.setFromMatrixPosition(E.target.matrixWorld),y.direction.sub(s),y.direction.transformDirection(m),d++}else if(E.isSpotLight){let y=n.spot[f];y.position.setFromMatrixPosition(E.matrixWorld),y.position.applyMatrix4(m),y.direction.setFromMatrixPosition(E.matrixWorld),s.setFromMatrixPosition(E.target.matrixWorld),y.direction.sub(s),y.direction.transformDirection(m),f++}else if(E.isRectAreaLight){let y=n.rectArea[_];y.position.setFromMatrixPosition(E.matrixWorld),y.position.applyMatrix4(m),a.identity(),r.copy(E.matrixWorld),r.premultiply(m),a.extractRotation(r),y.halfWidth.set(E.width*.5,0,0),y.halfHeight.set(0,E.height*.5,0),y.halfWidth.applyMatrix4(a),y.halfHeight.applyMatrix4(a),_++}else if(E.isPointLight){let y=n.point[p];y.position.setFromMatrixPosition(E.matrixWorld),y.position.applyMatrix4(m),p++}else if(E.isHemisphereLight){let y=n.hemi[x];y.direction.setFromMatrixPosition(E.matrixWorld),y.direction.transformDirection(m),x++}}}return{setup:o,setupView:c,state:n}}function Tc(i){let e=new em(i),t=[],n=[];function s(h){l.camera=h,t.length=0,n.length=0}function r(h){t.push(h)}function a(h){n.push(h)}function o(){e.setup(t)}function c(h){e.setupView(t,h)}let l={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:s,state:l,setupLights:o,setupLightsView:c,pushLight:r,pushShadow:a}}function tm(i){let e=new WeakMap;function t(s,r=0){let a=e.get(s),o;return a===void 0?(o=new Tc(i),e.set(s,[o])):r>=a.length?(o=new Tc(i),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}var nm=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function sm(i,e,t){let n=new Ai,s=new be,r=new be,a=new lt,o=new cr({depthPacking:Gl}),c=new hr,l={},h=t.maxTextureSize,d={[un]:Tt,[Tt]:un,[en]:en},p=new Nt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new be},radius:{value:4}},vertexShader:nm,fragmentShader:im}),f=p.clone();f.defines.HORIZONTAL_PASS=1;let _=new Ct;_.setAttribute("position",new Ut(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let x=new mt(_,p),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=eo;let u=this.type;this.render=function(w,I,U){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;let M=i.getRenderTarget(),S=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),B=i.state;B.setBlending(mn),B.buffers.depth.getReversed()?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);let O=u!==jt&&this.type===jt,V=u===jt&&this.type!==jt;for(let $=0,H=w.length;$<H;$++){let ne=w[$],G=ne.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",ne,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;s.copy(G.mapSize);let ie=G.getFrameExtents();if(s.multiply(ie),r.copy(G.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/ie.x),s.x=r.x*ie.x,G.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/ie.y),s.y=r.y*ie.y,G.mapSize.y=r.y)),G.map===null||O===!0||V===!0){let Te=this.type!==jt?{minFilter:kt,magFilter:kt}:{};G.map!==null&&G.map.dispose(),G.map=new Qt(s.x,s.y,Te),G.map.texture.name=ne.name+".shadowMap",G.camera.updateProjectionMatrix()}i.setRenderTarget(G.map),i.clear();let ae=G.getViewportCount();for(let Te=0;Te<ae;Te++){let Ne=G.getViewport(Te);a.set(r.x*Ne.x,r.y*Ne.y,r.x*Ne.z,r.y*Ne.w),B.viewport(a),G.updateMatrices(ne,Te),n=G.getFrustum(),y(I,U,G.camera,ne,this.type)}G.isPointLightShadow!==!0&&this.type===jt&&T(G,U),G.needsUpdate=!1}u=this.type,m.needsUpdate=!1,i.setRenderTarget(M,S,C)};function T(w,I){let U=e.update(x);p.defines.VSM_SAMPLES!==w.blurSamples&&(p.defines.VSM_SAMPLES=w.blurSamples,f.defines.VSM_SAMPLES=w.blurSamples,p.needsUpdate=!0,f.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Qt(s.x,s.y)),p.uniforms.shadow_pass.value=w.map.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(I,null,U,p,x,null),f.uniforms.shadow_pass.value=w.mapPass.texture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(I,null,U,f,x,null)}function E(w,I,U,M){let S=null,C=U.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(C!==void 0)S=C;else if(S=U.isPointLight===!0?c:o,i.localClippingEnabled&&I.clipShadows===!0&&Array.isArray(I.clippingPlanes)&&I.clippingPlanes.length!==0||I.displacementMap&&I.displacementScale!==0||I.alphaMap&&I.alphaTest>0||I.map&&I.alphaTest>0||I.alphaToCoverage===!0){let B=S.uuid,O=I.uuid,V=l[B];V===void 0&&(V={},l[B]=V);let $=V[O];$===void 0&&($=S.clone(),V[O]=$,I.addEventListener("dispose",R)),S=$}if(S.visible=I.visible,S.wireframe=I.wireframe,M===jt?S.side=I.shadowSide!==null?I.shadowSide:I.side:S.side=I.shadowSide!==null?I.shadowSide:d[I.side],S.alphaMap=I.alphaMap,S.alphaTest=I.alphaToCoverage===!0?.5:I.alphaTest,S.map=I.map,S.clipShadows=I.clipShadows,S.clippingPlanes=I.clippingPlanes,S.clipIntersection=I.clipIntersection,S.displacementMap=I.displacementMap,S.displacementScale=I.displacementScale,S.displacementBias=I.displacementBias,S.wireframeLinewidth=I.wireframeLinewidth,S.linewidth=I.linewidth,U.isPointLight===!0&&S.isMeshDistanceMaterial===!0){let B=i.properties.get(S);B.light=U}return S}function y(w,I,U,M,S){if(w.visible===!1)return;if(w.layers.test(I.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&S===jt)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(U.matrixWorldInverse,w.matrixWorld);let O=e.update(w),V=w.material;if(Array.isArray(V)){let $=O.groups;for(let H=0,ne=$.length;H<ne;H++){let G=$[H],ie=V[G.materialIndex];if(ie&&ie.visible){let ae=E(w,ie,M,S);w.onBeforeShadow(i,w,I,U,O,ae,G),i.renderBufferDirect(U,null,O,ae,w,G),w.onAfterShadow(i,w,I,U,O,ae,G)}}}else if(V.visible){let $=E(w,V,M,S);w.onBeforeShadow(i,w,I,U,O,$,null),i.renderBufferDirect(U,null,O,$,w,null),w.onAfterShadow(i,w,I,U,O,$,null)}}let B=w.children;for(let O=0,V=B.length;O<V;O++)y(B[O],I,U,M,S)}function R(w){w.target.removeEventListener("dispose",R);for(let U in l){let M=l[U],S=w.target.uuid;S in M&&(M[S].dispose(),delete M[S])}}}var rm={[Mr]:Sr,[br]:wr,[Er]:Ar,[Xn]:Tr,[Sr]:Mr,[wr]:br,[Ar]:Er,[Tr]:Xn};function am(i,e){function t(){let P=!1,te=new lt,le=null,ge=new lt(0,0,0,0);return{setMask:function(j){le!==j&&!P&&(i.colorMask(j,j,j,j),le=j)},setLocked:function(j){P=j},setClear:function(j,Z,ye,Fe,nt){nt===!0&&(j*=Fe,Z*=Fe,ye*=Fe),te.set(j,Z,ye,Fe),ge.equals(te)===!1&&(i.clearColor(j,Z,ye,Fe),ge.copy(te))},reset:function(){P=!1,le=null,ge.set(-1,0,0,0)}}}function n(){let P=!1,te=!1,le=null,ge=null,j=null;return{setReversed:function(Z){if(te!==Z){let ye=e.get("EXT_clip_control");Z?ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.ZERO_TO_ONE_EXT):ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.NEGATIVE_ONE_TO_ONE_EXT),te=Z;let Fe=j;j=null,this.setClear(Fe)}},getReversed:function(){return te},setTest:function(Z){Z?re(i.DEPTH_TEST):Ie(i.DEPTH_TEST)},setMask:function(Z){le!==Z&&!P&&(i.depthMask(Z),le=Z)},setFunc:function(Z){if(te&&(Z=rm[Z]),ge!==Z){switch(Z){case Mr:i.depthFunc(i.NEVER);break;case Sr:i.depthFunc(i.ALWAYS);break;case br:i.depthFunc(i.LESS);break;case Xn:i.depthFunc(i.LEQUAL);break;case Er:i.depthFunc(i.EQUAL);break;case Tr:i.depthFunc(i.GEQUAL);break;case wr:i.depthFunc(i.GREATER);break;case Ar:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ge=Z}},setLocked:function(Z){P=Z},setClear:function(Z){j!==Z&&(te&&(Z=1-Z),i.clearDepth(Z),j=Z)},reset:function(){P=!1,le=null,ge=null,j=null,te=!1}}}function s(){let P=!1,te=null,le=null,ge=null,j=null,Z=null,ye=null,Fe=null,nt=null;return{setTest:function(Je){P||(Je?re(i.STENCIL_TEST):Ie(i.STENCIL_TEST))},setMask:function(Je){te!==Je&&!P&&(i.stencilMask(Je),te=Je)},setFunc:function(Je,sn,$t){(le!==Je||ge!==sn||j!==$t)&&(i.stencilFunc(Je,sn,$t),le=Je,ge=sn,j=$t)},setOp:function(Je,sn,$t){(Z!==Je||ye!==sn||Fe!==$t)&&(i.stencilOp(Je,sn,$t),Z=Je,ye=sn,Fe=$t)},setLocked:function(Je){P=Je},setClear:function(Je){nt!==Je&&(i.clearStencil(Je),nt=Je)},reset:function(){P=!1,te=null,le=null,ge=null,j=null,Z=null,ye=null,Fe=null,nt=null}}}let r=new t,a=new n,o=new s,c=new WeakMap,l=new WeakMap,h={},d={},p=new WeakMap,f=[],_=null,x=!1,m=null,u=null,T=null,E=null,y=null,R=null,w=null,I=new He(0,0,0),U=0,M=!1,S=null,C=null,B=null,O=null,V=null,$=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),H=!1,ne=0,G=i.getParameter(i.VERSION);G.indexOf("WebGL")!==-1?(ne=parseFloat(/^WebGL (\d)/.exec(G)[1]),H=ne>=1):G.indexOf("OpenGL ES")!==-1&&(ne=parseFloat(/^OpenGL ES (\d)/.exec(G)[1]),H=ne>=2);let ie=null,ae={},Te=i.getParameter(i.SCISSOR_BOX),Ne=i.getParameter(i.VIEWPORT),Ge=new lt().fromArray(Te),Ze=new lt().fromArray(Ne);function Y(P,te,le,ge){let j=new Uint8Array(4),Z=i.createTexture();i.bindTexture(P,Z),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ye=0;ye<le;ye++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(te,0,i.RGBA,1,1,ge,0,i.RGBA,i.UNSIGNED_BYTE,j):i.texImage2D(te+ye,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,j);return Z}let ce={};ce[i.TEXTURE_2D]=Y(i.TEXTURE_2D,i.TEXTURE_2D,1),ce[i.TEXTURE_CUBE_MAP]=Y(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ce[i.TEXTURE_2D_ARRAY]=Y(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ce[i.TEXTURE_3D]=Y(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),re(i.DEPTH_TEST),a.setFunc(Xn),Xe(!1),Ee(ja),re(i.CULL_FACE),Ke(mn);function re(P){h[P]!==!0&&(i.enable(P),h[P]=!0)}function Ie(P){h[P]!==!1&&(i.disable(P),h[P]=!1)}function Ae(P,te){return d[P]!==te?(i.bindFramebuffer(P,te),d[P]=te,P===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=te),P===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=te),!0):!1}function Ue(P,te){let le=f,ge=!1;if(P){le=p.get(te),le===void 0&&(le=[],p.set(te,le));let j=P.textures;if(le.length!==j.length||le[0]!==i.COLOR_ATTACHMENT0){for(let Z=0,ye=j.length;Z<ye;Z++)le[Z]=i.COLOR_ATTACHMENT0+Z;le.length=j.length,ge=!0}}else le[0]!==i.BACK&&(le[0]=i.BACK,ge=!0);ge&&i.drawBuffers(le)}function it(P){return _!==P?(i.useProgram(P),_=P,!0):!1}let ze={[wn]:i.FUNC_ADD,[gl]:i.FUNC_SUBTRACT,[_l]:i.FUNC_REVERSE_SUBTRACT};ze[xl]=i.MIN,ze[vl]=i.MAX;let A={[yl]:i.ZERO,[Ml]:i.ONE,[Sl]:i.SRC_COLOR,[qs]:i.SRC_ALPHA,[Rl]:i.SRC_ALPHA_SATURATE,[wl]:i.DST_COLOR,[El]:i.DST_ALPHA,[bl]:i.ONE_MINUS_SRC_COLOR,[Ys]:i.ONE_MINUS_SRC_ALPHA,[Al]:i.ONE_MINUS_DST_COLOR,[Tl]:i.ONE_MINUS_DST_ALPHA,[Cl]:i.CONSTANT_COLOR,[Il]:i.ONE_MINUS_CONSTANT_COLOR,[Pl]:i.CONSTANT_ALPHA,[Ll]:i.ONE_MINUS_CONSTANT_ALPHA};function Ke(P,te,le,ge,j,Z,ye,Fe,nt,Je){if(P===mn){x===!0&&(Ie(i.BLEND),x=!1);return}if(x===!1&&(re(i.BLEND),x=!0),P!==ml){if(P!==m||Je!==M){if((u!==wn||y!==wn)&&(i.blendEquation(i.FUNC_ADD),u=wn,y=wn),Je)switch(P){case Wn:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ms:i.blendFunc(i.ONE,i.ONE);break;case to:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case no:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case Wn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ms:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case to:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case no:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}T=null,E=null,R=null,w=null,I.set(0,0,0),U=0,m=P,M=Je}return}j=j||te,Z=Z||le,ye=ye||ge,(te!==u||j!==y)&&(i.blendEquationSeparate(ze[te],ze[j]),u=te,y=j),(le!==T||ge!==E||Z!==R||ye!==w)&&(i.blendFuncSeparate(A[le],A[ge],A[Z],A[ye]),T=le,E=ge,R=Z,w=ye),(Fe.equals(I)===!1||nt!==U)&&(i.blendColor(Fe.r,Fe.g,Fe.b,nt),I.copy(Fe),U=nt),m=P,M=!1}function Re(P,te){P.side===en?Ie(i.CULL_FACE):re(i.CULL_FACE);let le=P.side===Tt;te&&(le=!le),Xe(le),P.blending===Wn&&P.transparent===!1?Ke(mn):Ke(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),r.setMask(P.colorWrite);let ge=P.stencilWrite;o.setTest(ge),ge&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),X(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?re(i.SAMPLE_ALPHA_TO_COVERAGE):Ie(i.SAMPLE_ALPHA_TO_COVERAGE)}function Xe(P){S!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),S=P)}function Ee(P){P!==dl?(re(i.CULL_FACE),P!==C&&(P===ja?i.cullFace(i.BACK):P===fl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Ie(i.CULL_FACE),C=P}function et(P){P!==B&&(H&&i.lineWidth(P),B=P)}function X(P,te,le){P?(re(i.POLYGON_OFFSET_FILL),(O!==te||V!==le)&&(i.polygonOffset(te,le),O=te,V=le)):Ie(i.POLYGON_OFFSET_FILL)}function oe(P){P?re(i.SCISSOR_TEST):Ie(i.SCISSOR_TEST)}function _e(P){P===void 0&&(P=i.TEXTURE0+$-1),ie!==P&&(i.activeTexture(P),ie=P)}function pe(P,te,le){le===void 0&&(ie===null?le=i.TEXTURE0+$-1:le=ie);let ge=ae[le];ge===void 0&&(ge={type:void 0,texture:void 0},ae[le]=ge),(ge.type!==P||ge.texture!==te)&&(ie!==le&&(i.activeTexture(le),ie=le),i.bindTexture(P,te||ce[P]),ge.type=P,ge.texture=te)}function b(){let P=ae[ie];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function g(){try{i.compressedTexImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function L(){try{i.compressedTexImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function W(){try{i.texSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function J(){try{i.texSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function q(){try{i.compressedTexSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Me(){try{i.compressedTexSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function se(){try{i.texStorage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function xe(){try{i.texStorage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Q(){try{i.texImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function K(){try{i.texImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function he(P){Ge.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),Ge.copy(P))}function we(P){Ze.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),Ze.copy(P))}function Se(P,te){let le=l.get(te);le===void 0&&(le=new WeakMap,l.set(te,le));let ge=le.get(P);ge===void 0&&(ge=i.getUniformBlockIndex(te,P.name),le.set(P,ge))}function ue(P,te){let ge=l.get(te).get(P);c.get(te)!==ge&&(i.uniformBlockBinding(te,ge,P.__bindingPointIndex),c.set(te,ge))}function Be(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},ie=null,ae={},d={},p=new WeakMap,f=[],_=null,x=!1,m=null,u=null,T=null,E=null,y=null,R=null,w=null,I=new He(0,0,0),U=0,M=!1,S=null,C=null,B=null,O=null,V=null,Ge.set(0,0,i.canvas.width,i.canvas.height),Ze.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:re,disable:Ie,bindFramebuffer:Ae,drawBuffers:Ue,useProgram:it,setBlending:Ke,setMaterial:Re,setFlipSided:Xe,setCullFace:Ee,setLineWidth:et,setPolygonOffset:X,setScissorTest:oe,activeTexture:_e,bindTexture:pe,unbindTexture:b,compressedTexImage2D:g,compressedTexImage3D:L,texImage2D:Q,texImage3D:K,updateUBOMapping:Se,uniformBlockBinding:ue,texStorage2D:se,texStorage3D:xe,texSubImage2D:W,texSubImage3D:J,compressedTexSubImage2D:q,compressedTexSubImage3D:Me,scissor:he,viewport:we,reset:Be}}function om(i,e,t,n,s,r,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new be,h=new WeakMap,d,p=new WeakMap,f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(b,g){return f?new OffscreenCanvas(b,g):Ki("canvas")}function x(b,g,L){let W=1,J=pe(b);if((J.width>L||J.height>L)&&(W=L/Math.max(J.width,J.height)),W<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){let q=Math.floor(W*J.width),Me=Math.floor(W*J.height);d===void 0&&(d=_(q,Me));let se=g?_(q,Me):d;return se.width=q,se.height=Me,se.getContext("2d").drawImage(b,0,0,q,Me),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+q+"x"+Me+")."),se}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),b;return b}function m(b){return b.generateMipmaps}function u(b){i.generateMipmap(b)}function T(b){return b.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?i.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function E(b,g,L,W,J=!1){if(b!==null){if(i[b]!==void 0)return i[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let q=g;if(g===i.RED&&(L===i.FLOAT&&(q=i.R32F),L===i.HALF_FLOAT&&(q=i.R16F),L===i.UNSIGNED_BYTE&&(q=i.R8)),g===i.RED_INTEGER&&(L===i.UNSIGNED_BYTE&&(q=i.R8UI),L===i.UNSIGNED_SHORT&&(q=i.R16UI),L===i.UNSIGNED_INT&&(q=i.R32UI),L===i.BYTE&&(q=i.R8I),L===i.SHORT&&(q=i.R16I),L===i.INT&&(q=i.R32I)),g===i.RG&&(L===i.FLOAT&&(q=i.RG32F),L===i.HALF_FLOAT&&(q=i.RG16F),L===i.UNSIGNED_BYTE&&(q=i.RG8)),g===i.RG_INTEGER&&(L===i.UNSIGNED_BYTE&&(q=i.RG8UI),L===i.UNSIGNED_SHORT&&(q=i.RG16UI),L===i.UNSIGNED_INT&&(q=i.RG32UI),L===i.BYTE&&(q=i.RG8I),L===i.SHORT&&(q=i.RG16I),L===i.INT&&(q=i.RG32I)),g===i.RGB_INTEGER&&(L===i.UNSIGNED_BYTE&&(q=i.RGB8UI),L===i.UNSIGNED_SHORT&&(q=i.RGB16UI),L===i.UNSIGNED_INT&&(q=i.RGB32UI),L===i.BYTE&&(q=i.RGB8I),L===i.SHORT&&(q=i.RGB16I),L===i.INT&&(q=i.RGB32I)),g===i.RGBA_INTEGER&&(L===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),L===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),L===i.UNSIGNED_INT&&(q=i.RGBA32UI),L===i.BYTE&&(q=i.RGBA8I),L===i.SHORT&&(q=i.RGBA16I),L===i.INT&&(q=i.RGBA32I)),g===i.RGB&&L===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),g===i.RGBA){let Me=J?Ji:qe.getTransfer(W);L===i.FLOAT&&(q=i.RGBA32F),L===i.HALF_FLOAT&&(q=i.RGBA16F),L===i.UNSIGNED_BYTE&&(q=Me===$e?i.SRGB8_ALPHA8:i.RGBA8),L===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),L===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function y(b,g){let L;return b?g===null||g===Fn||g===Li?L=i.DEPTH24_STENCIL8:g===tn?L=i.DEPTH32F_STENCIL8:g===Ii&&(L=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Fn||g===Li?L=i.DEPTH_COMPONENT24:g===tn?L=i.DEPTH_COMPONENT32F:g===Ii&&(L=i.DEPTH_COMPONENT16),L}function R(b,g){return m(b)===!0||b.isFramebufferTexture&&b.minFilter!==kt&&b.minFilter!==qt?Math.log2(Math.max(g.width,g.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?g.mipmaps.length:1}function w(b){let g=b.target;g.removeEventListener("dispose",w),U(g),g.isVideoTexture&&h.delete(g)}function I(b){let g=b.target;g.removeEventListener("dispose",I),S(g)}function U(b){let g=n.get(b);if(g.__webglInit===void 0)return;let L=b.source,W=p.get(L);if(W){let J=W[g.__cacheKey];J.usedTimes--,J.usedTimes===0&&M(b),Object.keys(W).length===0&&p.delete(L)}n.remove(b)}function M(b){let g=n.get(b);i.deleteTexture(g.__webglTexture);let L=b.source,W=p.get(L);delete W[g.__cacheKey],a.memory.textures--}function S(b){let g=n.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),n.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(g.__webglFramebuffer[W]))for(let J=0;J<g.__webglFramebuffer[W].length;J++)i.deleteFramebuffer(g.__webglFramebuffer[W][J]);else i.deleteFramebuffer(g.__webglFramebuffer[W]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[W])}else{if(Array.isArray(g.__webglFramebuffer))for(let W=0;W<g.__webglFramebuffer.length;W++)i.deleteFramebuffer(g.__webglFramebuffer[W]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let W=0;W<g.__webglColorRenderbuffer.length;W++)g.__webglColorRenderbuffer[W]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[W]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}let L=b.textures;for(let W=0,J=L.length;W<J;W++){let q=n.get(L[W]);q.__webglTexture&&(i.deleteTexture(q.__webglTexture),a.memory.textures--),n.remove(L[W])}n.remove(b)}let C=0;function B(){C=0}function O(){let b=C;return b>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+s.maxTextures),C+=1,b}function V(b){let g=[];return g.push(b.wrapS),g.push(b.wrapT),g.push(b.wrapR||0),g.push(b.magFilter),g.push(b.minFilter),g.push(b.anisotropy),g.push(b.internalFormat),g.push(b.format),g.push(b.type),g.push(b.generateMipmaps),g.push(b.premultiplyAlpha),g.push(b.flipY),g.push(b.unpackAlignment),g.push(b.colorSpace),g.join()}function $(b,g){let L=n.get(b);if(b.isVideoTexture&&oe(b),b.isRenderTargetTexture===!1&&b.isExternalTexture!==!0&&b.version>0&&L.__version!==b.version){let W=b.image;if(W===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ce(L,b,g);return}}else b.isExternalTexture&&(L.__webglTexture=b.sourceTexture?b.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,L.__webglTexture,i.TEXTURE0+g)}function H(b,g){let L=n.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&L.__version!==b.version){ce(L,b,g);return}t.bindTexture(i.TEXTURE_2D_ARRAY,L.__webglTexture,i.TEXTURE0+g)}function ne(b,g){let L=n.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&L.__version!==b.version){ce(L,b,g);return}t.bindTexture(i.TEXTURE_3D,L.__webglTexture,i.TEXTURE0+g)}function G(b,g){let L=n.get(b);if(b.version>0&&L.__version!==b.version){re(L,b,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,L.__webglTexture,i.TEXTURE0+g)}let ie={[yi]:i.REPEAT,[Tn]:i.CLAMP_TO_EDGE,[Zs]:i.MIRRORED_REPEAT},ae={[kt]:i.NEAREST,[Vl]:i.NEAREST_MIPMAP_NEAREST,[_s]:i.NEAREST_MIPMAP_LINEAR,[qt]:i.LINEAR,[Pr]:i.LINEAR_MIPMAP_NEAREST,[Nn]:i.LINEAR_MIPMAP_LINEAR},Te={[Xl]:i.NEVER,[Kl]:i.ALWAYS,[ql]:i.LESS,[mo]:i.LEQUAL,[Yl]:i.EQUAL,[$l]:i.GEQUAL,[Zl]:i.GREATER,[Jl]:i.NOTEQUAL};function Ne(b,g){if(g.type===tn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===qt||g.magFilter===Pr||g.magFilter===_s||g.magFilter===Nn||g.minFilter===qt||g.minFilter===Pr||g.minFilter===_s||g.minFilter===Nn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(b,i.TEXTURE_WRAP_S,ie[g.wrapS]),i.texParameteri(b,i.TEXTURE_WRAP_T,ie[g.wrapT]),(b===i.TEXTURE_3D||b===i.TEXTURE_2D_ARRAY)&&i.texParameteri(b,i.TEXTURE_WRAP_R,ie[g.wrapR]),i.texParameteri(b,i.TEXTURE_MAG_FILTER,ae[g.magFilter]),i.texParameteri(b,i.TEXTURE_MIN_FILTER,ae[g.minFilter]),g.compareFunction&&(i.texParameteri(b,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(b,i.TEXTURE_COMPARE_FUNC,Te[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===kt||g.minFilter!==_s&&g.minFilter!==Nn||g.type===tn&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){let L=e.get("EXT_texture_filter_anisotropic");i.texParameterf(b,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Ge(b,g){let L=!1;b.__webglInit===void 0&&(b.__webglInit=!0,g.addEventListener("dispose",w));let W=g.source,J=p.get(W);J===void 0&&(J={},p.set(W,J));let q=V(g);if(q!==b.__cacheKey){J[q]===void 0&&(J[q]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,L=!0),J[q].usedTimes++;let Me=J[b.__cacheKey];Me!==void 0&&(J[b.__cacheKey].usedTimes--,Me.usedTimes===0&&M(g)),b.__cacheKey=q,b.__webglTexture=J[q].texture}return L}function Ze(b,g,L){return Math.floor(Math.floor(b/L)/g)}function Y(b,g,L,W){let q=b.updateRanges;if(q.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,L,W,g.data);else{q.sort((K,he)=>K.start-he.start);let Me=0;for(let K=1;K<q.length;K++){let he=q[Me],we=q[K],Se=he.start+he.count,ue=Ze(we.start,g.width,4),Be=Ze(he.start,g.width,4);we.start<=Se+1&&ue===Be&&Ze(we.start+we.count-1,g.width,4)===ue?he.count=Math.max(he.count,we.start+we.count-he.start):(++Me,q[Me]=we)}q.length=Me+1;let se=i.getParameter(i.UNPACK_ROW_LENGTH),xe=i.getParameter(i.UNPACK_SKIP_PIXELS),Q=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let K=0,he=q.length;K<he;K++){let we=q[K],Se=Math.floor(we.start/4),ue=Math.ceil(we.count/4),Be=Se%g.width,P=Math.floor(Se/g.width),te=ue,le=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Be),i.pixelStorei(i.UNPACK_SKIP_ROWS,P),t.texSubImage2D(i.TEXTURE_2D,0,Be,P,te,le,L,W,g.data)}b.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,se),i.pixelStorei(i.UNPACK_SKIP_PIXELS,xe),i.pixelStorei(i.UNPACK_SKIP_ROWS,Q)}}function ce(b,g,L){let W=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(W=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(W=i.TEXTURE_3D);let J=Ge(b,g),q=g.source;t.bindTexture(W,b.__webglTexture,i.TEXTURE0+L);let Me=n.get(q);if(q.version!==Me.__version||J===!0){t.activeTexture(i.TEXTURE0+L);let se=qe.getPrimaries(qe.workingColorSpace),xe=g.colorSpace===_n?null:qe.getPrimaries(g.colorSpace),Q=g.colorSpace===_n||se===xe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);let K=x(g.image,!1,s.maxTextureSize);K=_e(g,K);let he=r.convert(g.format,g.colorSpace),we=r.convert(g.type),Se=E(g.internalFormat,he,we,g.colorSpace,g.isVideoTexture);Ne(W,g);let ue,Be=g.mipmaps,P=g.isVideoTexture!==!0,te=Me.__version===void 0||J===!0,le=q.dataReady,ge=R(g,K);if(g.isDepthTexture)Se=y(g.format===Di,g.type),te&&(P?t.texStorage2D(i.TEXTURE_2D,1,Se,K.width,K.height):t.texImage2D(i.TEXTURE_2D,0,Se,K.width,K.height,0,he,we,null));else if(g.isDataTexture)if(Be.length>0){P&&te&&t.texStorage2D(i.TEXTURE_2D,ge,Se,Be[0].width,Be[0].height);for(let j=0,Z=Be.length;j<Z;j++)ue=Be[j],P?le&&t.texSubImage2D(i.TEXTURE_2D,j,0,0,ue.width,ue.height,he,we,ue.data):t.texImage2D(i.TEXTURE_2D,j,Se,ue.width,ue.height,0,he,we,ue.data);g.generateMipmaps=!1}else P?(te&&t.texStorage2D(i.TEXTURE_2D,ge,Se,K.width,K.height),le&&Y(g,K,he,we)):t.texImage2D(i.TEXTURE_2D,0,Se,K.width,K.height,0,he,we,K.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){P&&te&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ge,Se,Be[0].width,Be[0].height,K.depth);for(let j=0,Z=Be.length;j<Z;j++)if(ue=Be[j],g.format!==Vt)if(he!==null)if(P){if(le)if(g.layerUpdates.size>0){let ye=bo(ue.width,ue.height,g.format,g.type);for(let Fe of g.layerUpdates){let nt=ue.data.subarray(Fe*ye/ue.data.BYTES_PER_ELEMENT,(Fe+1)*ye/ue.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,Fe,ue.width,ue.height,1,he,nt)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,ue.width,ue.height,K.depth,he,ue.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,j,Se,ue.width,ue.height,K.depth,0,ue.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else P?le&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,ue.width,ue.height,K.depth,he,we,ue.data):t.texImage3D(i.TEXTURE_2D_ARRAY,j,Se,ue.width,ue.height,K.depth,0,he,we,ue.data)}else{P&&te&&t.texStorage2D(i.TEXTURE_2D,ge,Se,Be[0].width,Be[0].height);for(let j=0,Z=Be.length;j<Z;j++)ue=Be[j],g.format!==Vt?he!==null?P?le&&t.compressedTexSubImage2D(i.TEXTURE_2D,j,0,0,ue.width,ue.height,he,ue.data):t.compressedTexImage2D(i.TEXTURE_2D,j,Se,ue.width,ue.height,0,ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):P?le&&t.texSubImage2D(i.TEXTURE_2D,j,0,0,ue.width,ue.height,he,we,ue.data):t.texImage2D(i.TEXTURE_2D,j,Se,ue.width,ue.height,0,he,we,ue.data)}else if(g.isDataArrayTexture)if(P){if(te&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ge,Se,K.width,K.height,K.depth),le)if(g.layerUpdates.size>0){let j=bo(K.width,K.height,g.format,g.type);for(let Z of g.layerUpdates){let ye=K.data.subarray(Z*j/K.data.BYTES_PER_ELEMENT,(Z+1)*j/K.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Z,K.width,K.height,1,he,we,ye)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,K.width,K.height,K.depth,he,we,K.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Se,K.width,K.height,K.depth,0,he,we,K.data);else if(g.isData3DTexture)P?(te&&t.texStorage3D(i.TEXTURE_3D,ge,Se,K.width,K.height,K.depth),le&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,K.width,K.height,K.depth,he,we,K.data)):t.texImage3D(i.TEXTURE_3D,0,Se,K.width,K.height,K.depth,0,he,we,K.data);else if(g.isFramebufferTexture){if(te)if(P)t.texStorage2D(i.TEXTURE_2D,ge,Se,K.width,K.height);else{let j=K.width,Z=K.height;for(let ye=0;ye<ge;ye++)t.texImage2D(i.TEXTURE_2D,ye,Se,j,Z,0,he,we,null),j>>=1,Z>>=1}}else if(Be.length>0){if(P&&te){let j=pe(Be[0]);t.texStorage2D(i.TEXTURE_2D,ge,Se,j.width,j.height)}for(let j=0,Z=Be.length;j<Z;j++)ue=Be[j],P?le&&t.texSubImage2D(i.TEXTURE_2D,j,0,0,he,we,ue):t.texImage2D(i.TEXTURE_2D,j,Se,he,we,ue);g.generateMipmaps=!1}else if(P){if(te){let j=pe(K);t.texStorage2D(i.TEXTURE_2D,ge,Se,j.width,j.height)}le&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,he,we,K)}else t.texImage2D(i.TEXTURE_2D,0,Se,he,we,K);m(g)&&u(W),Me.__version=q.version,g.onUpdate&&g.onUpdate(g)}b.__version=g.version}function re(b,g,L){if(g.image.length!==6)return;let W=Ge(b,g),J=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,b.__webglTexture,i.TEXTURE0+L);let q=n.get(J);if(J.version!==q.__version||W===!0){t.activeTexture(i.TEXTURE0+L);let Me=qe.getPrimaries(qe.workingColorSpace),se=g.colorSpace===_n?null:qe.getPrimaries(g.colorSpace),xe=g.colorSpace===_n||Me===se?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe);let Q=g.isCompressedTexture||g.image[0].isCompressedTexture,K=g.image[0]&&g.image[0].isDataTexture,he=[];for(let Z=0;Z<6;Z++)!Q&&!K?he[Z]=x(g.image[Z],!0,s.maxCubemapSize):he[Z]=K?g.image[Z].image:g.image[Z],he[Z]=_e(g,he[Z]);let we=he[0],Se=r.convert(g.format,g.colorSpace),ue=r.convert(g.type),Be=E(g.internalFormat,Se,ue,g.colorSpace),P=g.isVideoTexture!==!0,te=q.__version===void 0||W===!0,le=J.dataReady,ge=R(g,we);Ne(i.TEXTURE_CUBE_MAP,g);let j;if(Q){P&&te&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ge,Be,we.width,we.height);for(let Z=0;Z<6;Z++){j=he[Z].mipmaps;for(let ye=0;ye<j.length;ye++){let Fe=j[ye];g.format!==Vt?Se!==null?P?le&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye,0,0,Fe.width,Fe.height,Se,Fe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye,Be,Fe.width,Fe.height,0,Fe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye,0,0,Fe.width,Fe.height,Se,ue,Fe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye,Be,Fe.width,Fe.height,0,Se,ue,Fe.data)}}}else{if(j=g.mipmaps,P&&te){j.length>0&&ge++;let Z=pe(he[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ge,Be,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(K){P?le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,he[Z].width,he[Z].height,Se,ue,he[Z].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Be,he[Z].width,he[Z].height,0,Se,ue,he[Z].data);for(let ye=0;ye<j.length;ye++){let nt=j[ye].image[Z].image;P?le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye+1,0,0,nt.width,nt.height,Se,ue,nt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye+1,Be,nt.width,nt.height,0,Se,ue,nt.data)}}else{P?le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Se,ue,he[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Be,Se,ue,he[Z]);for(let ye=0;ye<j.length;ye++){let Fe=j[ye];P?le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye+1,0,0,Se,ue,Fe.image[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ye+1,Be,Se,ue,Fe.image[Z])}}}m(g)&&u(i.TEXTURE_CUBE_MAP),q.__version=J.version,g.onUpdate&&g.onUpdate(g)}b.__version=g.version}function Ie(b,g,L,W,J,q){let Me=r.convert(L.format,L.colorSpace),se=r.convert(L.type),xe=E(L.internalFormat,Me,se,L.colorSpace),Q=n.get(g),K=n.get(L);if(K.__renderTarget=g,!Q.__hasExternalTextures){let he=Math.max(1,g.width>>q),we=Math.max(1,g.height>>q);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?t.texImage3D(J,q,xe,he,we,g.depth,0,Me,se,null):t.texImage2D(J,q,xe,he,we,0,Me,se,null)}t.bindFramebuffer(i.FRAMEBUFFER,b),X(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,J,K.__webglTexture,0,et(g)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,W,J,K.__webglTexture,q),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ae(b,g,L){if(i.bindRenderbuffer(i.RENDERBUFFER,b),g.depthBuffer){let W=g.depthTexture,J=W&&W.isDepthTexture?W.type:null,q=y(g.stencilBuffer,J),Me=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,se=et(g);X(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,se,q,g.width,g.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,se,q,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,q,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Me,i.RENDERBUFFER,b)}else{let W=g.textures;for(let J=0;J<W.length;J++){let q=W[J],Me=r.convert(q.format,q.colorSpace),se=r.convert(q.type),xe=E(q.internalFormat,Me,se,q.colorSpace),Q=et(g);L&&X(g)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Q,xe,g.width,g.height):X(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Q,xe,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,xe,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Ue(b,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,b),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let W=n.get(g.depthTexture);W.__renderTarget=g,(!W.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),$(g.depthTexture,0);let J=W.__webglTexture,q=et(g);if(g.depthTexture.format===Mi)X(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0);else if(g.depthTexture.format===Di)X(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function it(b){let g=n.get(b),L=b.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==b.depthTexture){let W=b.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),W){let J=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,W.removeEventListener("dispose",J)};W.addEventListener("dispose",J),g.__depthDisposeCallback=J}g.__boundDepthTexture=W}if(b.depthTexture&&!g.__autoAllocateDepthBuffer){if(L)throw new Error("target.depthTexture not supported in Cube render targets");let W=b.texture.mipmaps;W&&W.length>0?Ue(g.__webglFramebuffer[0],b):Ue(g.__webglFramebuffer,b)}else if(L){g.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[W]),g.__webglDepthbuffer[W]===void 0)g.__webglDepthbuffer[W]=i.createRenderbuffer(),Ae(g.__webglDepthbuffer[W],b,!1);else{let J=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=g.__webglDepthbuffer[W];i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,q)}}else{let W=b.texture.mipmaps;if(W&&W.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),Ae(g.__webglDepthbuffer,b,!1);else{let J=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,q)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function ze(b,g,L){let W=n.get(b);g!==void 0&&Ie(W.__webglFramebuffer,b,b.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),L!==void 0&&it(b)}function A(b){let g=b.texture,L=n.get(b),W=n.get(g);b.addEventListener("dispose",I);let J=b.textures,q=b.isWebGLCubeRenderTarget===!0,Me=J.length>1;if(Me||(W.__webglTexture===void 0&&(W.__webglTexture=i.createTexture()),W.__version=g.version,a.memory.textures++),q){L.__webglFramebuffer=[];for(let se=0;se<6;se++)if(g.mipmaps&&g.mipmaps.length>0){L.__webglFramebuffer[se]=[];for(let xe=0;xe<g.mipmaps.length;xe++)L.__webglFramebuffer[se][xe]=i.createFramebuffer()}else L.__webglFramebuffer[se]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){L.__webglFramebuffer=[];for(let se=0;se<g.mipmaps.length;se++)L.__webglFramebuffer[se]=i.createFramebuffer()}else L.__webglFramebuffer=i.createFramebuffer();if(Me)for(let se=0,xe=J.length;se<xe;se++){let Q=n.get(J[se]);Q.__webglTexture===void 0&&(Q.__webglTexture=i.createTexture(),a.memory.textures++)}if(b.samples>0&&X(b)===!1){L.__webglMultisampledFramebuffer=i.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let se=0;se<J.length;se++){let xe=J[se];L.__webglColorRenderbuffer[se]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,L.__webglColorRenderbuffer[se]);let Q=r.convert(xe.format,xe.colorSpace),K=r.convert(xe.type),he=E(xe.internalFormat,Q,K,xe.colorSpace,b.isXRRenderTarget===!0),we=et(b);i.renderbufferStorageMultisample(i.RENDERBUFFER,we,he,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+se,i.RENDERBUFFER,L.__webglColorRenderbuffer[se])}i.bindRenderbuffer(i.RENDERBUFFER,null),b.depthBuffer&&(L.__webglDepthRenderbuffer=i.createRenderbuffer(),Ae(L.__webglDepthRenderbuffer,b,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),Ne(i.TEXTURE_CUBE_MAP,g);for(let se=0;se<6;se++)if(g.mipmaps&&g.mipmaps.length>0)for(let xe=0;xe<g.mipmaps.length;xe++)Ie(L.__webglFramebuffer[se][xe],b,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+se,xe);else Ie(L.__webglFramebuffer[se],b,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0);m(g)&&u(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Me){for(let se=0,xe=J.length;se<xe;se++){let Q=J[se],K=n.get(Q),he=i.TEXTURE_2D;(b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(he=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(he,K.__webglTexture),Ne(he,Q),Ie(L.__webglFramebuffer,b,Q,i.COLOR_ATTACHMENT0+se,he,0),m(Q)&&u(he)}t.unbindTexture()}else{let se=i.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(se=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(se,W.__webglTexture),Ne(se,g),g.mipmaps&&g.mipmaps.length>0)for(let xe=0;xe<g.mipmaps.length;xe++)Ie(L.__webglFramebuffer[xe],b,g,i.COLOR_ATTACHMENT0,se,xe);else Ie(L.__webglFramebuffer,b,g,i.COLOR_ATTACHMENT0,se,0);m(g)&&u(se),t.unbindTexture()}b.depthBuffer&&it(b)}function Ke(b){let g=b.textures;for(let L=0,W=g.length;L<W;L++){let J=g[L];if(m(J)){let q=T(b),Me=n.get(J).__webglTexture;t.bindTexture(q,Me),u(q),t.unbindTexture()}}}let Re=[],Xe=[];function Ee(b){if(b.samples>0){if(X(b)===!1){let g=b.textures,L=b.width,W=b.height,J=i.COLOR_BUFFER_BIT,q=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Me=n.get(b),se=g.length>1;if(se)for(let Q=0;Q<g.length;Q++)t.bindFramebuffer(i.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Q,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Q,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Me.__webglMultisampledFramebuffer);let xe=b.texture.mipmaps;xe&&xe.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Me.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Me.__webglFramebuffer);for(let Q=0;Q<g.length;Q++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),se){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Me.__webglColorRenderbuffer[Q]);let K=n.get(g[Q]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,K,0)}i.blitFramebuffer(0,0,L,W,0,0,L,W,J,i.NEAREST),c===!0&&(Re.length=0,Xe.length=0,Re.push(i.COLOR_ATTACHMENT0+Q),b.depthBuffer&&b.resolveDepthBuffer===!1&&(Re.push(q),Xe.push(q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Xe)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Re))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),se)for(let Q=0;Q<g.length;Q++){t.bindFramebuffer(i.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Q,i.RENDERBUFFER,Me.__webglColorRenderbuffer[Q]);let K=n.get(g[Q]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Q,i.TEXTURE_2D,K,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Me.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&c){let g=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function et(b){return Math.min(s.maxSamples,b.samples)}function X(b){let g=n.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function oe(b){let g=a.render.frame;h.get(b)!==g&&(h.set(b,g),b.update())}function _e(b,g){let L=b.colorSpace,W=b.format,J=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||L!==qn&&L!==_n&&(qe.getTransfer(L)===$e?(W!==Vt||J!==Zt)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",L)),g}function pe(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(l.width=b.naturalWidth||b.width,l.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(l.width=b.displayWidth,l.height=b.displayHeight):(l.width=b.width,l.height=b.height),l}this.allocateTextureUnit=O,this.resetTextureUnits=B,this.setTexture2D=$,this.setTexture2DArray=H,this.setTexture3D=ne,this.setTextureCube=G,this.rebindTextures=ze,this.setupRenderTarget=A,this.updateRenderTargetMipmap=Ke,this.updateMultisampleRenderTarget=Ee,this.setupDepthRenderbuffer=it,this.setupFrameBufferTexture=Ie,this.useMultisampledRTT=X}function lm(i,e){function t(n,s=_n){let r,a=qe.getTransfer(s);if(n===Zt)return i.UNSIGNED_BYTE;if(n===Dr)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Ur)return i.UNSIGNED_SHORT_5_5_5_1;if(n===oo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===ro)return i.BYTE;if(n===ao)return i.SHORT;if(n===Ii)return i.UNSIGNED_SHORT;if(n===Lr)return i.INT;if(n===Fn)return i.UNSIGNED_INT;if(n===tn)return i.FLOAT;if(n===Pi)return i.HALF_FLOAT;if(n===lo)return i.ALPHA;if(n===co)return i.RGB;if(n===Vt)return i.RGBA;if(n===Mi)return i.DEPTH_COMPONENT;if(n===Di)return i.DEPTH_STENCIL;if(n===ho)return i.RED;if(n===Nr)return i.RED_INTEGER;if(n===uo)return i.RG;if(n===Fr)return i.RG_INTEGER;if(n===Or)return i.RGBA_INTEGER;if(n===xs||n===vs||n===ys||n===Ms)if(a===$e)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===xs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===vs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ys)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ms)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===xs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===vs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ys)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ms)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Br||n===zr||n===kr||n===Vr)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Br)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===zr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===kr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Vr)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Hr||n===Gr||n===Wr)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Hr||n===Gr)return a===$e?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Wr)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Xr||n===qr||n===Yr||n===Zr||n===Jr||n===$r||n===Kr||n===Qr||n===jr||n===ea||n===ta||n===na||n===ia||n===sa)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Xr)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===qr)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Yr)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Zr)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Jr)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===$r)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Kr)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Qr)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===jr)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ea)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ta)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===na)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ia)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===sa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ss||n===ra||n===aa)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ss)return a===$e?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ra)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===aa)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===fo||n===oa||n===la||n===ca)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Ss)return r.COMPRESSED_RED_RGTC1_EXT;if(n===oa)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===la)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ca)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Li?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}var pa=class extends Rt{constructor(e=null){super(),this.sourceTexture=e,this.isExternalTexture=!0}},cm=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`,Fo=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new pa(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Nt({vertexShader:cm,fragmentShader:hm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new mt(new Zn(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Oo=class extends dn{constructor(e,t){super();let n=this,s=null,r=1,a=null,o="local-floor",c=1,l=null,h=null,d=null,p=null,f=null,_=null,x=new Fo,m={},u=t.getContextAttributes(),T=null,E=null,y=[],R=[],w=new be,I=null,U=new vt;U.viewport=new lt;let M=new vt;M.viewport=new lt;let S=[U,M],C=new yr,B=null,O=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let ce=y[Y];return ce===void 0&&(ce=new wi,y[Y]=ce),ce.getTargetRaySpace()},this.getControllerGrip=function(Y){let ce=y[Y];return ce===void 0&&(ce=new wi,y[Y]=ce),ce.getGripSpace()},this.getHand=function(Y){let ce=y[Y];return ce===void 0&&(ce=new wi,y[Y]=ce),ce.getHandSpace()};function V(Y){let ce=R.indexOf(Y.inputSource);if(ce===-1)return;let re=y[ce];re!==void 0&&(re.update(Y.inputSource,Y.frame,l||a),re.dispatchEvent({type:Y.type,data:Y.inputSource}))}function $(){s.removeEventListener("select",V),s.removeEventListener("selectstart",V),s.removeEventListener("selectend",V),s.removeEventListener("squeeze",V),s.removeEventListener("squeezestart",V),s.removeEventListener("squeezeend",V),s.removeEventListener("end",$),s.removeEventListener("inputsourceschange",H);for(let Y=0;Y<y.length;Y++){let ce=R[Y];ce!==null&&(R[Y]=null,y[Y].disconnect(ce))}B=null,O=null,x.reset();for(let Y in m)delete m[Y];e.setRenderTarget(T),f=null,p=null,d=null,s=null,E=null,Ze.stop(),n.isPresenting=!1,e.setPixelRatio(I),e.setSize(w.width,w.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){r=Y,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){o=Y,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(Y){l=Y},this.getBaseLayer=function(){return p!==null?p:f},this.getBinding=function(){return d},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(Y){if(s=Y,s!==null){if(T=e.getRenderTarget(),s.addEventListener("select",V),s.addEventListener("selectstart",V),s.addEventListener("selectend",V),s.addEventListener("squeeze",V),s.addEventListener("squeezestart",V),s.addEventListener("squeezeend",V),s.addEventListener("end",$),s.addEventListener("inputsourceschange",H),u.xrCompatible!==!0&&await t.makeXRCompatible(),I=e.getPixelRatio(),e.getSize(w),typeof XRWebGLBinding<"u"&&(d=new XRWebGLBinding(s,t)),d!==null&&"createProjectionLayer"in XRWebGLBinding.prototype){let re=null,Ie=null,Ae=null;u.depth&&(Ae=u.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,re=u.stencil?Di:Mi,Ie=u.stencil?Li:Fn);let Ue={colorFormat:t.RGBA8,depthFormat:Ae,scaleFactor:r};p=d.createProjectionLayer(Ue),s.updateRenderState({layers:[p]}),e.setPixelRatio(1),e.setSize(p.textureWidth,p.textureHeight,!1),E=new Qt(p.textureWidth,p.textureHeight,{format:Vt,type:Zt,depthTexture:new rs(p.textureWidth,p.textureHeight,Ie,void 0,void 0,void 0,void 0,void 0,void 0,re),stencilBuffer:u.stencil,colorSpace:e.outputColorSpace,samples:u.antialias?4:0,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}else{let re={antialias:u.antialias,alpha:!0,depth:u.depth,stencil:u.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,t,re),s.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),E=new Qt(f.framebufferWidth,f.framebufferHeight,{format:Vt,type:Zt,colorSpace:e.outputColorSpace,stencilBuffer:u.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await s.requestReferenceSpace(o),Ze.setContext(s),Ze.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return x.getDepthTexture()};function H(Y){for(let ce=0;ce<Y.removed.length;ce++){let re=Y.removed[ce],Ie=R.indexOf(re);Ie>=0&&(R[Ie]=null,y[Ie].disconnect(re))}for(let ce=0;ce<Y.added.length;ce++){let re=Y.added[ce],Ie=R.indexOf(re);if(Ie===-1){for(let Ue=0;Ue<y.length;Ue++)if(Ue>=R.length){R.push(re),Ie=Ue;break}else if(R[Ue]===null){R[Ue]=re,Ie=Ue;break}if(Ie===-1)break}let Ae=y[Ie];Ae&&Ae.connect(re)}}let ne=new D,G=new D;function ie(Y,ce,re){ne.setFromMatrixPosition(ce.matrixWorld),G.setFromMatrixPosition(re.matrixWorld);let Ie=ne.distanceTo(G),Ae=ce.projectionMatrix.elements,Ue=re.projectionMatrix.elements,it=Ae[14]/(Ae[10]-1),ze=Ae[14]/(Ae[10]+1),A=(Ae[9]+1)/Ae[5],Ke=(Ae[9]-1)/Ae[5],Re=(Ae[8]-1)/Ae[0],Xe=(Ue[8]+1)/Ue[0],Ee=it*Re,et=it*Xe,X=Ie/(-Re+Xe),oe=X*-Re;if(ce.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(oe),Y.translateZ(X),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),Ae[10]===-1)Y.projectionMatrix.copy(ce.projectionMatrix),Y.projectionMatrixInverse.copy(ce.projectionMatrixInverse);else{let _e=it+X,pe=ze+X,b=Ee-oe,g=et+(Ie-oe),L=A*ze/pe*_e,W=Ke*ze/pe*_e;Y.projectionMatrix.makePerspective(b,g,L,W,_e,pe),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function ae(Y,ce){ce===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(ce.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(s===null)return;let ce=Y.near,re=Y.far;x.texture!==null&&(x.depthNear>0&&(ce=x.depthNear),x.depthFar>0&&(re=x.depthFar)),C.near=M.near=U.near=ce,C.far=M.far=U.far=re,(B!==C.near||O!==C.far)&&(s.updateRenderState({depthNear:C.near,depthFar:C.far}),B=C.near,O=C.far),C.layers.mask=Y.layers.mask|6,U.layers.mask=C.layers.mask&3,M.layers.mask=C.layers.mask&5;let Ie=Y.parent,Ae=C.cameras;ae(C,Ie);for(let Ue=0;Ue<Ae.length;Ue++)ae(Ae[Ue],Ie);Ae.length===2?ie(C,U,M):C.projectionMatrix.copy(U.projectionMatrix),Te(Y,C,Ie)};function Te(Y,ce,re){re===null?Y.matrix.copy(ce.matrixWorld):(Y.matrix.copy(re.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(ce.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(ce.projectionMatrix),Y.projectionMatrixInverse.copy(ce.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=Si*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return C},this.getFoveation=function(){if(!(p===null&&f===null))return c},this.setFoveation=function(Y){c=Y,p!==null&&(p.fixedFoveation=Y),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=Y)},this.hasDepthSensing=function(){return x.texture!==null},this.getDepthSensingMesh=function(){return x.getMesh(C)},this.getCameraTexture=function(Y){return m[Y]};let Ne=null;function Ge(Y,ce){if(h=ce.getViewerPose(l||a),_=ce,h!==null){let re=h.views;f!==null&&(e.setRenderTargetFramebuffer(E,f.framebuffer),e.setRenderTarget(E));let Ie=!1;re.length!==C.cameras.length&&(C.cameras.length=0,Ie=!0);for(let ze=0;ze<re.length;ze++){let A=re[ze],Ke=null;if(f!==null)Ke=f.getViewport(A);else{let Xe=d.getViewSubImage(p,A);Ke=Xe.viewport,ze===0&&(e.setRenderTargetTextures(E,Xe.colorTexture,Xe.depthStencilTexture),e.setRenderTarget(E))}let Re=S[ze];Re===void 0&&(Re=new vt,Re.layers.enable(ze),Re.viewport=new lt,S[ze]=Re),Re.matrix.fromArray(A.transform.matrix),Re.matrix.decompose(Re.position,Re.quaternion,Re.scale),Re.projectionMatrix.fromArray(A.projectionMatrix),Re.projectionMatrixInverse.copy(Re.projectionMatrix).invert(),Re.viewport.set(Ke.x,Ke.y,Ke.width,Ke.height),ze===0&&(C.matrix.copy(Re.matrix),C.matrix.decompose(C.position,C.quaternion,C.scale)),Ie===!0&&C.cameras.push(Re)}let Ae=s.enabledFeatures;if(Ae&&Ae.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&d){let ze=d.getDepthInformation(re[0]);ze&&ze.isValid&&ze.texture&&x.init(ze,s.renderState)}if(Ae&&Ae.includes("camera-access")&&(e.state.unbindTexture(),d))for(let ze=0;ze<re.length;ze++){let A=re[ze].camera;if(A){let Ke=m[A];Ke||(Ke=new pa,m[A]=Ke);let Re=d.getCameraImage(A);Ke.sourceTexture=Re}}}for(let re=0;re<y.length;re++){let Ie=R[re],Ae=y[re];Ie!==null&&Ae!==void 0&&Ae.update(Ie,ce,l||a)}Ne&&Ne(Y,ce),ce.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ce}),_=null}let Ze=new wc;Ze.setAnimationLoop(Ge),this.setAnimationLoop=function(Y){Ne=Y},this.dispose=function(){}}},ni=new Yt,um=new ht;function dm(i,e){function t(m,u){m.matrixAutoUpdate===!0&&m.updateMatrix(),u.value.copy(m.matrix)}function n(m,u){u.color.getRGB(m.fogColor.value,vo(i)),u.isFog?(m.fogNear.value=u.near,m.fogFar.value=u.far):u.isFogExp2&&(m.fogDensity.value=u.density)}function s(m,u,T,E,y){u.isMeshBasicMaterial||u.isMeshLambertMaterial?r(m,u):u.isMeshToonMaterial?(r(m,u),d(m,u)):u.isMeshPhongMaterial?(r(m,u),h(m,u)):u.isMeshStandardMaterial?(r(m,u),p(m,u),u.isMeshPhysicalMaterial&&f(m,u,y)):u.isMeshMatcapMaterial?(r(m,u),_(m,u)):u.isMeshDepthMaterial?r(m,u):u.isMeshDistanceMaterial?(r(m,u),x(m,u)):u.isMeshNormalMaterial?r(m,u):u.isLineBasicMaterial?(a(m,u),u.isLineDashedMaterial&&o(m,u)):u.isPointsMaterial?c(m,u,T,E):u.isSpriteMaterial?l(m,u):u.isShadowMaterial?(m.color.value.copy(u.color),m.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function r(m,u){m.opacity.value=u.opacity,u.color&&m.diffuse.value.copy(u.color),u.emissive&&m.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(m.map.value=u.map,t(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.bumpMap&&(m.bumpMap.value=u.bumpMap,t(u.bumpMap,m.bumpMapTransform),m.bumpScale.value=u.bumpScale,u.side===Tt&&(m.bumpScale.value*=-1)),u.normalMap&&(m.normalMap.value=u.normalMap,t(u.normalMap,m.normalMapTransform),m.normalScale.value.copy(u.normalScale),u.side===Tt&&m.normalScale.value.negate()),u.displacementMap&&(m.displacementMap.value=u.displacementMap,t(u.displacementMap,m.displacementMapTransform),m.displacementScale.value=u.displacementScale,m.displacementBias.value=u.displacementBias),u.emissiveMap&&(m.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,m.emissiveMapTransform)),u.specularMap&&(m.specularMap.value=u.specularMap,t(u.specularMap,m.specularMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest);let T=e.get(u),E=T.envMap,y=T.envMapRotation;E&&(m.envMap.value=E,ni.copy(y),ni.x*=-1,ni.y*=-1,ni.z*=-1,E.isCubeTexture&&E.isRenderTargetTexture===!1&&(ni.y*=-1,ni.z*=-1),m.envMapRotation.value.setFromMatrix4(um.makeRotationFromEuler(ni)),m.flipEnvMap.value=E.isCubeTexture&&E.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=u.reflectivity,m.ior.value=u.ior,m.refractionRatio.value=u.refractionRatio),u.lightMap&&(m.lightMap.value=u.lightMap,m.lightMapIntensity.value=u.lightMapIntensity,t(u.lightMap,m.lightMapTransform)),u.aoMap&&(m.aoMap.value=u.aoMap,m.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,m.aoMapTransform))}function a(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,u.map&&(m.map.value=u.map,t(u.map,m.mapTransform))}function o(m,u){m.dashSize.value=u.dashSize,m.totalSize.value=u.dashSize+u.gapSize,m.scale.value=u.scale}function c(m,u,T,E){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.size.value=u.size*T,m.scale.value=E*.5,u.map&&(m.map.value=u.map,t(u.map,m.uvTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function l(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.rotation.value=u.rotation,u.map&&(m.map.value=u.map,t(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function h(m,u){m.specular.value.copy(u.specular),m.shininess.value=Math.max(u.shininess,1e-4)}function d(m,u){u.gradientMap&&(m.gradientMap.value=u.gradientMap)}function p(m,u){m.metalness.value=u.metalness,u.metalnessMap&&(m.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,m.metalnessMapTransform)),m.roughness.value=u.roughness,u.roughnessMap&&(m.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,m.roughnessMapTransform)),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)}function f(m,u,T){m.ior.value=u.ior,u.sheen>0&&(m.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),m.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(m.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,m.sheenColorMapTransform)),u.sheenRoughnessMap&&(m.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,m.sheenRoughnessMapTransform))),u.clearcoat>0&&(m.clearcoat.value=u.clearcoat,m.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(m.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,m.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(m.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Tt&&m.clearcoatNormalScale.value.negate())),u.dispersion>0&&(m.dispersion.value=u.dispersion),u.iridescence>0&&(m.iridescence.value=u.iridescence,m.iridescenceIOR.value=u.iridescenceIOR,m.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(m.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,m.iridescenceMapTransform)),u.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),u.transmission>0&&(m.transmission.value=u.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),u.transmissionMap&&(m.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,m.transmissionMapTransform)),m.thickness.value=u.thickness,u.thicknessMap&&(m.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=u.attenuationDistance,m.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(m.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(m.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=u.specularIntensity,m.specularColor.value.copy(u.specularColor),u.specularColorMap&&(m.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,m.specularColorMapTransform)),u.specularIntensityMap&&(m.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,u){u.matcap&&(m.matcap.value=u.matcap)}function x(m,u){let T=e.get(u).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function fm(i,e,t,n){let s={},r={},a=[],o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(T,E){let y=E.program;n.uniformBlockBinding(T,y)}function l(T,E){let y=s[T.id];y===void 0&&(_(T),y=h(T),s[T.id]=y,T.addEventListener("dispose",m));let R=E.program;n.updateUBOMapping(T,R);let w=e.render.frame;r[T.id]!==w&&(p(T),r[T.id]=w)}function h(T){let E=d();T.__bindingPointIndex=E;let y=i.createBuffer(),R=T.__size,w=T.usage;return i.bindBuffer(i.UNIFORM_BUFFER,y),i.bufferData(i.UNIFORM_BUFFER,R,w),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,E,y),y}function d(){for(let T=0;T<o;T++)if(a.indexOf(T)===-1)return a.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function p(T){let E=s[T.id],y=T.uniforms,R=T.__cache;i.bindBuffer(i.UNIFORM_BUFFER,E);for(let w=0,I=y.length;w<I;w++){let U=Array.isArray(y[w])?y[w]:[y[w]];for(let M=0,S=U.length;M<S;M++){let C=U[M];if(f(C,w,M,R)===!0){let B=C.__offset,O=Array.isArray(C.value)?C.value:[C.value],V=0;for(let $=0;$<O.length;$++){let H=O[$],ne=x(H);typeof H=="number"||typeof H=="boolean"?(C.__data[0]=H,i.bufferSubData(i.UNIFORM_BUFFER,B+V,C.__data)):H.isMatrix3?(C.__data[0]=H.elements[0],C.__data[1]=H.elements[1],C.__data[2]=H.elements[2],C.__data[3]=0,C.__data[4]=H.elements[3],C.__data[5]=H.elements[4],C.__data[6]=H.elements[5],C.__data[7]=0,C.__data[8]=H.elements[6],C.__data[9]=H.elements[7],C.__data[10]=H.elements[8],C.__data[11]=0):(H.toArray(C.__data,V),V+=ne.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,B,C.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(T,E,y,R){let w=T.value,I=E+"_"+y;if(R[I]===void 0)return typeof w=="number"||typeof w=="boolean"?R[I]=w:R[I]=w.clone(),!0;{let U=R[I];if(typeof w=="number"||typeof w=="boolean"){if(U!==w)return R[I]=w,!0}else if(U.equals(w)===!1)return U.copy(w),!0}return!1}function _(T){let E=T.uniforms,y=0,R=16;for(let I=0,U=E.length;I<U;I++){let M=Array.isArray(E[I])?E[I]:[E[I]];for(let S=0,C=M.length;S<C;S++){let B=M[S],O=Array.isArray(B.value)?B.value:[B.value];for(let V=0,$=O.length;V<$;V++){let H=O[V],ne=x(H),G=y%R,ie=G%ne.boundary,ae=G+ie;y+=ie,ae!==0&&R-ae<ne.storage&&(y+=R-ae),B.__data=new Float32Array(ne.storage/Float32Array.BYTES_PER_ELEMENT),B.__offset=y,y+=ne.storage}}}let w=y%R;return w>0&&(y+=R-w),T.__size=y,T.__cache={},this}function x(T){let E={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(E.boundary=4,E.storage=4):T.isVector2?(E.boundary=8,E.storage=8):T.isVector3||T.isColor?(E.boundary=16,E.storage=12):T.isVector4?(E.boundary=16,E.storage=16):T.isMatrix3?(E.boundary=48,E.storage=48):T.isMatrix4?(E.boundary=64,E.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),E}function m(T){let E=T.target;E.removeEventListener("dispose",m);let y=a.indexOf(E.__bindingPointIndex);a.splice(y,1),i.deleteBuffer(s[E.id]),delete s[E.id],delete r[E.id]}function u(){for(let T in s)i.deleteBuffer(s[T]);a=[],s={},r={}}return{bind:c,update:l,dispose:u}}var ma=class{constructor(e={}){let{canvas:t=Ql(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:p=!1}=e;this.isWebGLRenderer=!0;let f;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=n.getContextAttributes().alpha}else f=a;let _=new Uint32Array(4),x=new Int32Array(4),m=null,u=null,T=[],E=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=gn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let y=this,R=!1;this._outputColorSpace=xt;let w=0,I=0,U=null,M=-1,S=null,C=new lt,B=new lt,O=null,V=new He(0),$=0,H=t.width,ne=t.height,G=1,ie=null,ae=null,Te=new lt(0,0,H,ne),Ne=new lt(0,0,H,ne),Ge=!1,Ze=new Ai,Y=!1,ce=!1,re=new ht,Ie=new D,Ae=new lt,Ue={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},it=!1;function ze(){return U===null?G:1}let A=n;function Ke(v,N){return t.getContext(v,N)}try{let v={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${"179"}`),t.addEventListener("webglcontextlost",le,!1),t.addEventListener("webglcontextrestored",ge,!1),t.addEventListener("webglcontextcreationerror",j,!1),A===null){let N="webgl2";if(A=Ke(N,v),A===null)throw Ke(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(v){throw console.error("THREE.WebGLRenderer: "+v.message),v}let Re,Xe,Ee,et,X,oe,_e,pe,b,g,L,W,J,q,Me,se,xe,Q,K,he,we,Se,ue,Be;function P(){Re=new Pf(A),Re.init(),Se=new lm(A,Re),Xe=new Ef(A,Re,e,Se),Ee=new am(A,Re),Xe.reversedDepthBuffer&&p&&Ee.buffers.depth.setReversed(!0),et=new Uf(A),X=new Yp,oe=new om(A,Re,Ee,X,Xe,Se,et),_e=new wf(y),pe=new If(y),b=new zh(A),ue=new Sf(A,b),g=new Lf(A,b,et,ue),L=new Ff(A,g,b,et),K=new Nf(A,Xe,oe),se=new Tf(X),W=new qp(y,_e,pe,Re,Xe,ue,se),J=new dm(y,X),q=new Jp,Me=new tm(Re),Q=new Mf(y,_e,pe,Ee,L,f,c),xe=new sm(y,L,Xe),Be=new fm(A,et,Xe,Ee),he=new bf(A,Re,et),we=new Df(A,Re,et),et.programs=W.programs,y.capabilities=Xe,y.extensions=Re,y.properties=X,y.renderLists=q,y.shadowMap=xe,y.state=Ee,y.info=et}P();let te=new Oo(y,A);this.xr=te,this.getContext=function(){return A},this.getContextAttributes=function(){return A.getContextAttributes()},this.forceContextLoss=function(){let v=Re.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){let v=Re.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return G},this.setPixelRatio=function(v){v!==void 0&&(G=v,this.setSize(H,ne,!1))},this.getSize=function(v){return v.set(H,ne)},this.setSize=function(v,N,z=!0){if(te.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}H=v,ne=N,t.width=Math.floor(v*G),t.height=Math.floor(N*G),z===!0&&(t.style.width=v+"px",t.style.height=N+"px"),this.setViewport(0,0,v,N)},this.getDrawingBufferSize=function(v){return v.set(H*G,ne*G).floor()},this.setDrawingBufferSize=function(v,N,z){H=v,ne=N,G=z,t.width=Math.floor(v*z),t.height=Math.floor(N*z),this.setViewport(0,0,v,N)},this.getCurrentViewport=function(v){return v.copy(C)},this.getViewport=function(v){return v.copy(Te)},this.setViewport=function(v,N,z,k){v.isVector4?Te.set(v.x,v.y,v.z,v.w):Te.set(v,N,z,k),Ee.viewport(C.copy(Te).multiplyScalar(G).round())},this.getScissor=function(v){return v.copy(Ne)},this.setScissor=function(v,N,z,k){v.isVector4?Ne.set(v.x,v.y,v.z,v.w):Ne.set(v,N,z,k),Ee.scissor(B.copy(Ne).multiplyScalar(G).round())},this.getScissorTest=function(){return Ge},this.setScissorTest=function(v){Ee.setScissorTest(Ge=v)},this.setOpaqueSort=function(v){ie=v},this.setTransparentSort=function(v){ae=v},this.getClearColor=function(v){return v.copy(Q.getClearColor())},this.setClearColor=function(){Q.setClearColor(...arguments)},this.getClearAlpha=function(){return Q.getClearAlpha()},this.setClearAlpha=function(){Q.setClearAlpha(...arguments)},this.clear=function(v=!0,N=!0,z=!0){let k=0;if(v){let F=!1;if(U!==null){let ee=U.texture.format;F=ee===Or||ee===Fr||ee===Nr}if(F){let ee=U.texture.type,fe=ee===Zt||ee===Fn||ee===Ii||ee===Li||ee===Dr||ee===Ur,ve=Q.getClearColor(),me=Q.getClearAlpha(),Le=ve.r,De=ve.g,Ce=ve.b;fe?(_[0]=Le,_[1]=De,_[2]=Ce,_[3]=me,A.clearBufferuiv(A.COLOR,0,_)):(x[0]=Le,x[1]=De,x[2]=Ce,x[3]=me,A.clearBufferiv(A.COLOR,0,x))}else k|=A.COLOR_BUFFER_BIT}N&&(k|=A.DEPTH_BUFFER_BIT),z&&(k|=A.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),A.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",le,!1),t.removeEventListener("webglcontextrestored",ge,!1),t.removeEventListener("webglcontextcreationerror",j,!1),Q.dispose(),q.dispose(),Me.dispose(),X.dispose(),_e.dispose(),pe.dispose(),L.dispose(),ue.dispose(),Be.dispose(),W.dispose(),te.dispose(),te.removeEventListener("sessionstart",$t),te.removeEventListener("sessionend",zo),On.stop()};function le(v){v.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),R=!0}function ge(){console.log("THREE.WebGLRenderer: Context Restored."),R=!1;let v=et.autoReset,N=xe.enabled,z=xe.autoUpdate,k=xe.needsUpdate,F=xe.type;P(),et.autoReset=v,xe.enabled=N,xe.autoUpdate=z,xe.needsUpdate=k,xe.type=F}function j(v){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function Z(v){let N=v.target;N.removeEventListener("dispose",Z),ye(N)}function ye(v){Fe(v),X.remove(v)}function Fe(v){let N=X.get(v).programs;N!==void 0&&(N.forEach(function(z){W.releaseProgram(z)}),v.isShaderMaterial&&W.releaseShaderCache(v))}this.renderBufferDirect=function(v,N,z,k,F,ee){N===null&&(N=Ue);let fe=F.isMesh&&F.matrixWorld.determinant()<0,ve=Lc(v,N,z,k,F);Ee.setMaterial(k,fe);let me=z.index,Le=1;if(k.wireframe===!0){if(me=g.getWireframeAttribute(z),me===void 0)return;Le=2}let De=z.drawRange,Ce=z.attributes.position,We=De.start*Le,Qe=(De.start+De.count)*Le;ee!==null&&(We=Math.max(We,ee.start*Le),Qe=Math.min(Qe,(ee.start+ee.count)*Le)),me!==null?(We=Math.max(We,0),Qe=Math.min(Qe,me.count)):Ce!=null&&(We=Math.max(We,0),Qe=Math.min(Qe,Ce.count));let ct=Qe-We;if(ct<0||ct===1/0)return;ue.setup(F,k,ve,z,me);let st,tt=he;if(me!==null&&(st=b.get(me),tt=we,tt.setIndex(st)),F.isMesh)k.wireframe===!0?(Ee.setLineWidth(k.wireframeLinewidth*ze()),tt.setMode(A.LINES)):tt.setMode(A.TRIANGLES);else if(F.isLine){let Pe=k.linewidth;Pe===void 0&&(Pe=1),Ee.setLineWidth(Pe*ze()),F.isLineSegments?tt.setMode(A.LINES):F.isLineLoop?tt.setMode(A.LINE_LOOP):tt.setMode(A.LINE_STRIP)}else F.isPoints?tt.setMode(A.POINTS):F.isSprite&&tt.setMode(A.TRIANGLES);if(F.isBatchedMesh)if(F._multiDrawInstances!==null)Yn("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),tt.renderMultiDrawInstances(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount,F._multiDrawInstances);else if(Re.get("WEBGL_multi_draw"))tt.renderMultiDraw(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount);else{let Pe=F._multiDrawStarts,at=F._multiDrawCounts,Ye=F._multiDrawCount,It=me?b.get(me).bytesPerElement:1,ri=X.get(k).currentProgram.getUniforms();for(let Pt=0;Pt<Ye;Pt++)ri.setValue(A,"_gl_DrawID",Pt),tt.render(Pe[Pt]/It,at[Pt])}else if(F.isInstancedMesh)tt.renderInstances(We,ct,F.count);else if(z.isInstancedBufferGeometry){let Pe=z._maxInstanceCount!==void 0?z._maxInstanceCount:1/0,at=Math.min(z.instanceCount,Pe);tt.renderInstances(We,ct,at)}else tt.render(We,ct)};function nt(v,N,z){v.transparent===!0&&v.side===en&&v.forceSinglePass===!1?(v.side=Tt,v.needsUpdate=!0,Ts(v,N,z),v.side=un,v.needsUpdate=!0,Ts(v,N,z),v.side=en):Ts(v,N,z)}this.compile=function(v,N,z=null){z===null&&(z=v),u=Me.get(z),u.init(N),E.push(u),z.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(u.pushLight(F),F.castShadow&&u.pushShadow(F))}),v!==z&&v.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(u.pushLight(F),F.castShadow&&u.pushShadow(F))}),u.setupLights();let k=new Set;return v.traverse(function(F){if(!(F.isMesh||F.isPoints||F.isLine||F.isSprite))return;let ee=F.material;if(ee)if(Array.isArray(ee))for(let fe=0;fe<ee.length;fe++){let ve=ee[fe];nt(ve,z,F),k.add(ve)}else nt(ee,z,F),k.add(ee)}),u=E.pop(),k},this.compileAsync=function(v,N,z=null){let k=this.compile(v,N,z);return new Promise(F=>{function ee(){if(k.forEach(function(fe){X.get(fe).currentProgram.isReady()&&k.delete(fe)}),k.size===0){F(v);return}setTimeout(ee,10)}Re.get("KHR_parallel_shader_compile")!==null?ee():setTimeout(ee,10)})};let Je=null;function sn(v){Je&&Je(v)}function $t(){On.stop()}function zo(){On.start()}let On=new wc;On.setAnimationLoop(sn),typeof self<"u"&&On.setContext(self),this.setAnimationLoop=function(v){Je=v,te.setAnimationLoop(v),v===null?On.stop():On.start()},te.addEventListener("sessionstart",$t),te.addEventListener("sessionend",zo),this.render=function(v,N){if(N!==void 0&&N.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),te.enabled===!0&&te.isPresenting===!0&&(te.cameraAutoUpdate===!0&&te.updateCamera(N),N=te.getCamera()),v.isScene===!0&&v.onBeforeRender(y,v,N,U),u=Me.get(v,E.length),u.init(N),E.push(u),re.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),Ze.setFromProjectionMatrix(re,Xt,N.reversedDepth),ce=this.localClippingEnabled,Y=se.init(this.clippingPlanes,ce),m=q.get(v,T.length),m.init(),T.push(m),te.enabled===!0&&te.isPresenting===!0){let ee=y.xr.getDepthSensingMesh();ee!==null&&_a(ee,N,-1/0,y.sortObjects)}_a(v,N,0,y.sortObjects),m.finish(),y.sortObjects===!0&&m.sort(ie,ae),it=te.enabled===!1||te.isPresenting===!1||te.hasDepthSensing()===!1,it&&Q.addToRenderList(m,v),this.info.render.frame++,Y===!0&&se.beginShadows();let z=u.state.shadowsArray;xe.render(z,v,N),Y===!0&&se.endShadows(),this.info.autoReset===!0&&this.info.reset();let k=m.opaque,F=m.transmissive;if(u.setupLights(),N.isArrayCamera){let ee=N.cameras;if(F.length>0)for(let fe=0,ve=ee.length;fe<ve;fe++){let me=ee[fe];Vo(k,F,v,me)}it&&Q.render(v);for(let fe=0,ve=ee.length;fe<ve;fe++){let me=ee[fe];ko(m,v,me,me.viewport)}}else F.length>0&&Vo(k,F,v,N),it&&Q.render(v),ko(m,v,N);U!==null&&I===0&&(oe.updateMultisampleRenderTarget(U),oe.updateRenderTargetMipmap(U)),v.isScene===!0&&v.onAfterRender(y,v,N),ue.resetDefaultState(),M=-1,S=null,E.pop(),E.length>0?(u=E[E.length-1],Y===!0&&se.setGlobalState(y.clippingPlanes,u.state.camera)):u=null,T.pop(),T.length>0?m=T[T.length-1]:m=null};function _a(v,N,z,k){if(v.visible===!1)return;if(v.layers.test(N.layers)){if(v.isGroup)z=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(N);else if(v.isLight)u.pushLight(v),v.castShadow&&u.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||Ze.intersectsSprite(v)){k&&Ae.setFromMatrixPosition(v.matrixWorld).applyMatrix4(re);let fe=L.update(v),ve=v.material;ve.visible&&m.push(v,fe,ve,z,Ae.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||Ze.intersectsObject(v))){let fe=L.update(v),ve=v.material;if(k&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),Ae.copy(v.boundingSphere.center)):(fe.boundingSphere===null&&fe.computeBoundingSphere(),Ae.copy(fe.boundingSphere.center)),Ae.applyMatrix4(v.matrixWorld).applyMatrix4(re)),Array.isArray(ve)){let me=fe.groups;for(let Le=0,De=me.length;Le<De;Le++){let Ce=me[Le],We=ve[Ce.materialIndex];We&&We.visible&&m.push(v,fe,We,z,Ae.z,Ce)}}else ve.visible&&m.push(v,fe,ve,z,Ae.z,null)}}let ee=v.children;for(let fe=0,ve=ee.length;fe<ve;fe++)_a(ee[fe],N,z,k)}function ko(v,N,z,k){let F=v.opaque,ee=v.transmissive,fe=v.transparent;u.setupLightsView(z),Y===!0&&se.setGlobalState(y.clippingPlanes,z),k&&Ee.viewport(C.copy(k)),F.length>0&&Es(F,N,z),ee.length>0&&Es(ee,N,z),fe.length>0&&Es(fe,N,z),Ee.buffers.depth.setTest(!0),Ee.buffers.depth.setMask(!0),Ee.buffers.color.setMask(!0),Ee.setPolygonOffset(!1)}function Vo(v,N,z,k){if((z.isScene===!0?z.overrideMaterial:null)!==null)return;u.state.transmissionRenderTarget[k.id]===void 0&&(u.state.transmissionRenderTarget[k.id]=new Qt(1,1,{generateMipmaps:!0,type:Re.has("EXT_color_buffer_half_float")||Re.has("EXT_color_buffer_float")?Pi:Zt,minFilter:Nn,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:qe.workingColorSpace}));let ee=u.state.transmissionRenderTarget[k.id],fe=k.viewport||C;ee.setSize(fe.z*y.transmissionResolutionScale,fe.w*y.transmissionResolutionScale);let ve=y.getRenderTarget(),me=y.getActiveCubeFace(),Le=y.getActiveMipmapLevel();y.setRenderTarget(ee),y.getClearColor(V),$=y.getClearAlpha(),$<1&&y.setClearColor(16777215,.5),y.clear(),it&&Q.render(z);let De=y.toneMapping;y.toneMapping=gn;let Ce=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),u.setupLightsView(k),Y===!0&&se.setGlobalState(y.clippingPlanes,k),Es(v,z,k),oe.updateMultisampleRenderTarget(ee),oe.updateRenderTargetMipmap(ee),Re.has("WEBGL_multisampled_render_to_texture")===!1){let We=!1;for(let Qe=0,ct=N.length;Qe<ct;Qe++){let st=N[Qe],tt=st.object,Pe=st.geometry,at=st.material,Ye=st.group;if(at.side===en&&tt.layers.test(k.layers)){let It=at.side;at.side=Tt,at.needsUpdate=!0,Ho(tt,z,k,Pe,at,Ye),at.side=It,at.needsUpdate=!0,We=!0}}We===!0&&(oe.updateMultisampleRenderTarget(ee),oe.updateRenderTargetMipmap(ee))}y.setRenderTarget(ve,me,Le),y.setClearColor(V,$),Ce!==void 0&&(k.viewport=Ce),y.toneMapping=De}function Es(v,N,z){let k=N.isScene===!0?N.overrideMaterial:null;for(let F=0,ee=v.length;F<ee;F++){let fe=v[F],ve=fe.object,me=fe.geometry,Le=fe.group,De=fe.material;De.allowOverride===!0&&k!==null&&(De=k),ve.layers.test(z.layers)&&Ho(ve,N,z,me,De,Le)}}function Ho(v,N,z,k,F,ee){v.onBeforeRender(y,N,z,k,F,ee),v.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),F.onBeforeRender(y,N,z,k,v,ee),F.transparent===!0&&F.side===en&&F.forceSinglePass===!1?(F.side=Tt,F.needsUpdate=!0,y.renderBufferDirect(z,N,k,F,v,ee),F.side=un,F.needsUpdate=!0,y.renderBufferDirect(z,N,k,F,v,ee),F.side=en):y.renderBufferDirect(z,N,k,F,v,ee),v.onAfterRender(y,N,z,k,F,ee)}function Ts(v,N,z){N.isScene!==!0&&(N=Ue);let k=X.get(v),F=u.state.lights,ee=u.state.shadowsArray,fe=F.state.version,ve=W.getParameters(v,F.state,ee,N,z),me=W.getProgramCacheKey(ve),Le=k.programs;k.environment=v.isMeshStandardMaterial?N.environment:null,k.fog=N.fog,k.envMap=(v.isMeshStandardMaterial?pe:_e).get(v.envMap||k.environment),k.envMapRotation=k.environment!==null&&v.envMap===null?N.environmentRotation:v.envMapRotation,Le===void 0&&(v.addEventListener("dispose",Z),Le=new Map,k.programs=Le);let De=Le.get(me);if(De!==void 0){if(k.currentProgram===De&&k.lightsStateVersion===fe)return Wo(v,ve),De}else ve.uniforms=W.getUniforms(v),v.onBeforeCompile(ve,y),De=W.acquireProgram(ve,me),Le.set(me,De),k.uniforms=ve.uniforms;let Ce=k.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(Ce.clippingPlanes=se.uniform),Wo(v,ve),k.needsLights=Uc(v),k.lightsStateVersion=fe,k.needsLights&&(Ce.ambientLightColor.value=F.state.ambient,Ce.lightProbe.value=F.state.probe,Ce.directionalLights.value=F.state.directional,Ce.directionalLightShadows.value=F.state.directionalShadow,Ce.spotLights.value=F.state.spot,Ce.spotLightShadows.value=F.state.spotShadow,Ce.rectAreaLights.value=F.state.rectArea,Ce.ltc_1.value=F.state.rectAreaLTC1,Ce.ltc_2.value=F.state.rectAreaLTC2,Ce.pointLights.value=F.state.point,Ce.pointLightShadows.value=F.state.pointShadow,Ce.hemisphereLights.value=F.state.hemi,Ce.directionalShadowMap.value=F.state.directionalShadowMap,Ce.directionalShadowMatrix.value=F.state.directionalShadowMatrix,Ce.spotShadowMap.value=F.state.spotShadowMap,Ce.spotLightMatrix.value=F.state.spotLightMatrix,Ce.spotLightMap.value=F.state.spotLightMap,Ce.pointShadowMap.value=F.state.pointShadowMap,Ce.pointShadowMatrix.value=F.state.pointShadowMatrix),k.currentProgram=De,k.uniformsList=null,De}function Go(v){if(v.uniformsList===null){let N=v.currentProgram.getUniforms();v.uniformsList=Oi.seqWithValue(N.seq,v.uniforms)}return v.uniformsList}function Wo(v,N){let z=X.get(v);z.outputColorSpace=N.outputColorSpace,z.batching=N.batching,z.batchingColor=N.batchingColor,z.instancing=N.instancing,z.instancingColor=N.instancingColor,z.instancingMorph=N.instancingMorph,z.skinning=N.skinning,z.morphTargets=N.morphTargets,z.morphNormals=N.morphNormals,z.morphColors=N.morphColors,z.morphTargetsCount=N.morphTargetsCount,z.numClippingPlanes=N.numClippingPlanes,z.numIntersection=N.numClipIntersection,z.vertexAlphas=N.vertexAlphas,z.vertexTangents=N.vertexTangents,z.toneMapping=N.toneMapping}function Lc(v,N,z,k,F){N.isScene!==!0&&(N=Ue),oe.resetTextureUnits();let ee=N.fog,fe=k.isMeshStandardMaterial?N.environment:null,ve=U===null?y.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:qn,me=(k.isMeshStandardMaterial?pe:_e).get(k.envMap||fe),Le=k.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,De=!!z.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),Ce=!!z.morphAttributes.position,We=!!z.morphAttributes.normal,Qe=!!z.morphAttributes.color,ct=gn;k.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(ct=y.toneMapping);let st=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,tt=st!==void 0?st.length:0,Pe=X.get(k),at=u.state.lights;if(Y===!0&&(ce===!0||v!==S)){let St=v===S&&k.id===M;se.setState(k,v,St)}let Ye=!1;k.version===Pe.__version?(Pe.needsLights&&Pe.lightsStateVersion!==at.state.version||Pe.outputColorSpace!==ve||F.isBatchedMesh&&Pe.batching===!1||!F.isBatchedMesh&&Pe.batching===!0||F.isBatchedMesh&&Pe.batchingColor===!0&&F.colorTexture===null||F.isBatchedMesh&&Pe.batchingColor===!1&&F.colorTexture!==null||F.isInstancedMesh&&Pe.instancing===!1||!F.isInstancedMesh&&Pe.instancing===!0||F.isSkinnedMesh&&Pe.skinning===!1||!F.isSkinnedMesh&&Pe.skinning===!0||F.isInstancedMesh&&Pe.instancingColor===!0&&F.instanceColor===null||F.isInstancedMesh&&Pe.instancingColor===!1&&F.instanceColor!==null||F.isInstancedMesh&&Pe.instancingMorph===!0&&F.morphTexture===null||F.isInstancedMesh&&Pe.instancingMorph===!1&&F.morphTexture!==null||Pe.envMap!==me||k.fog===!0&&Pe.fog!==ee||Pe.numClippingPlanes!==void 0&&(Pe.numClippingPlanes!==se.numPlanes||Pe.numIntersection!==se.numIntersection)||Pe.vertexAlphas!==Le||Pe.vertexTangents!==De||Pe.morphTargets!==Ce||Pe.morphNormals!==We||Pe.morphColors!==Qe||Pe.toneMapping!==ct||Pe.morphTargetsCount!==tt)&&(Ye=!0):(Ye=!0,Pe.__version=k.version);let It=Pe.currentProgram;Ye===!0&&(It=Ts(k,N,F));let ri=!1,Pt=!1,zi=!1,ot=It.getUniforms(),Ot=Pe.uniforms;if(Ee.useProgram(It.program)&&(ri=!0,Pt=!0,zi=!0),k.id!==M&&(M=k.id,Pt=!0),ri||S!==v){Ee.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),ot.setValue(A,"projectionMatrix",v.projectionMatrix),ot.setValue(A,"viewMatrix",v.matrixWorldInverse);let wt=ot.map.cameraPosition;wt!==void 0&&wt.setValue(A,Ie.setFromMatrixPosition(v.matrixWorld)),Xe.logarithmicDepthBuffer&&ot.setValue(A,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&ot.setValue(A,"isOrthographic",v.isOrthographicCamera===!0),S!==v&&(S=v,Pt=!0,zi=!0)}if(F.isSkinnedMesh){ot.setOptional(A,F,"bindMatrix"),ot.setOptional(A,F,"bindMatrixInverse");let St=F.skeleton;St&&(St.boneTexture===null&&St.computeBoneTexture(),ot.setValue(A,"boneTexture",St.boneTexture,oe))}F.isBatchedMesh&&(ot.setOptional(A,F,"batchingTexture"),ot.setValue(A,"batchingTexture",F._matricesTexture,oe),ot.setOptional(A,F,"batchingIdTexture"),ot.setValue(A,"batchingIdTexture",F._indirectTexture,oe),ot.setOptional(A,F,"batchingColorTexture"),F._colorsTexture!==null&&ot.setValue(A,"batchingColorTexture",F._colorsTexture,oe));let Bt=z.morphAttributes;if((Bt.position!==void 0||Bt.normal!==void 0||Bt.color!==void 0)&&K.update(F,z,It),(Pt||Pe.receiveShadow!==F.receiveShadow)&&(Pe.receiveShadow=F.receiveShadow,ot.setValue(A,"receiveShadow",F.receiveShadow)),k.isMeshGouraudMaterial&&k.envMap!==null&&(Ot.envMap.value=me,Ot.flipEnvMap.value=me.isCubeTexture&&me.isRenderTargetTexture===!1?-1:1),k.isMeshStandardMaterial&&k.envMap===null&&N.environment!==null&&(Ot.envMapIntensity.value=N.environmentIntensity),Pt&&(ot.setValue(A,"toneMappingExposure",y.toneMappingExposure),Pe.needsLights&&Dc(Ot,zi),ee&&k.fog===!0&&J.refreshFogUniforms(Ot,ee),J.refreshMaterialUniforms(Ot,k,G,ne,u.state.transmissionRenderTarget[v.id]),Oi.upload(A,Go(Pe),Ot,oe)),k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(Oi.upload(A,Go(Pe),Ot,oe),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&ot.setValue(A,"center",F.center),ot.setValue(A,"modelViewMatrix",F.modelViewMatrix),ot.setValue(A,"normalMatrix",F.normalMatrix),ot.setValue(A,"modelMatrix",F.matrixWorld),k.isShaderMaterial||k.isRawShaderMaterial){let St=k.uniformsGroups;for(let wt=0,xa=St.length;wt<xa;wt++){let Bn=St[wt];Be.update(Bn,It),Be.bind(Bn,It)}}return It}function Dc(v,N){v.ambientLightColor.needsUpdate=N,v.lightProbe.needsUpdate=N,v.directionalLights.needsUpdate=N,v.directionalLightShadows.needsUpdate=N,v.pointLights.needsUpdate=N,v.pointLightShadows.needsUpdate=N,v.spotLights.needsUpdate=N,v.spotLightShadows.needsUpdate=N,v.rectAreaLights.needsUpdate=N,v.hemisphereLights.needsUpdate=N}function Uc(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return w},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(v,N,z){let k=X.get(v);k.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,k.__autoAllocateDepthBuffer===!1&&(k.__useRenderToTexture=!1),X.get(v.texture).__webglTexture=N,X.get(v.depthTexture).__webglTexture=k.__autoAllocateDepthBuffer?void 0:z,k.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,N){let z=X.get(v);z.__webglFramebuffer=N,z.__useDefaultFramebuffer=N===void 0};let Nc=A.createFramebuffer();this.setRenderTarget=function(v,N=0,z=0){U=v,w=N,I=z;let k=!0,F=null,ee=!1,fe=!1;if(v){let me=X.get(v);if(me.__useDefaultFramebuffer!==void 0)Ee.bindFramebuffer(A.FRAMEBUFFER,null),k=!1;else if(me.__webglFramebuffer===void 0)oe.setupRenderTarget(v);else if(me.__hasExternalTextures)oe.rebindTextures(v,X.get(v.texture).__webglTexture,X.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){let Ce=v.depthTexture;if(me.__boundDepthTexture!==Ce){if(Ce!==null&&X.has(Ce)&&(v.width!==Ce.image.width||v.height!==Ce.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");oe.setupDepthRenderbuffer(v)}}let Le=v.texture;(Le.isData3DTexture||Le.isDataArrayTexture||Le.isCompressedArrayTexture)&&(fe=!0);let De=X.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(De[N])?F=De[N][z]:F=De[N],ee=!0):v.samples>0&&oe.useMultisampledRTT(v)===!1?F=X.get(v).__webglMultisampledFramebuffer:Array.isArray(De)?F=De[z]:F=De,C.copy(v.viewport),B.copy(v.scissor),O=v.scissorTest}else C.copy(Te).multiplyScalar(G).floor(),B.copy(Ne).multiplyScalar(G).floor(),O=Ge;if(z!==0&&(F=Nc),Ee.bindFramebuffer(A.FRAMEBUFFER,F)&&k&&Ee.drawBuffers(v,F),Ee.viewport(C),Ee.scissor(B),Ee.setScissorTest(O),ee){let me=X.get(v.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_CUBE_MAP_POSITIVE_X+N,me.__webglTexture,z)}else if(fe){let me=N;for(let Le=0;Le<v.textures.length;Le++){let De=X.get(v.textures[Le]);A.framebufferTextureLayer(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0+Le,De.__webglTexture,z,me)}}else if(v!==null&&z!==0){let me=X.get(v.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,me.__webglTexture,z)}M=-1},this.readRenderTargetPixels=function(v,N,z,k,F,ee,fe,ve=0){if(!(v&&v.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let me=X.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&fe!==void 0&&(me=me[fe]),me){Ee.bindFramebuffer(A.FRAMEBUFFER,me);try{let Le=v.textures[ve],De=Le.format,Ce=Le.type;if(!Xe.textureFormatReadable(De)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Xe.textureTypeReadable(Ce)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=v.width-k&&z>=0&&z<=v.height-F&&(v.textures.length>1&&A.readBuffer(A.COLOR_ATTACHMENT0+ve),A.readPixels(N,z,k,F,Se.convert(De),Se.convert(Ce),ee))}finally{let Le=U!==null?X.get(U).__webglFramebuffer:null;Ee.bindFramebuffer(A.FRAMEBUFFER,Le)}}},this.readRenderTargetPixelsAsync=async function(v,N,z,k,F,ee,fe,ve=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let me=X.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&fe!==void 0&&(me=me[fe]),me)if(N>=0&&N<=v.width-k&&z>=0&&z<=v.height-F){Ee.bindFramebuffer(A.FRAMEBUFFER,me);let Le=v.textures[ve],De=Le.format,Ce=Le.type;if(!Xe.textureFormatReadable(De))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Xe.textureTypeReadable(Ce))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let We=A.createBuffer();A.bindBuffer(A.PIXEL_PACK_BUFFER,We),A.bufferData(A.PIXEL_PACK_BUFFER,ee.byteLength,A.STREAM_READ),v.textures.length>1&&A.readBuffer(A.COLOR_ATTACHMENT0+ve),A.readPixels(N,z,k,F,Se.convert(De),Se.convert(Ce),0);let Qe=U!==null?X.get(U).__webglFramebuffer:null;Ee.bindFramebuffer(A.FRAMEBUFFER,Qe);let ct=A.fenceSync(A.SYNC_GPU_COMMANDS_COMPLETE,0);return A.flush(),await jl(A,ct,4),A.bindBuffer(A.PIXEL_PACK_BUFFER,We),A.getBufferSubData(A.PIXEL_PACK_BUFFER,0,ee),A.deleteBuffer(We),A.deleteSync(ct),ee}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,N=null,z=0){let k=Math.pow(2,-z),F=Math.floor(v.image.width*k),ee=Math.floor(v.image.height*k),fe=N!==null?N.x:0,ve=N!==null?N.y:0;oe.setTexture2D(v,0),A.copyTexSubImage2D(A.TEXTURE_2D,z,0,0,fe,ve,F,ee),Ee.unbindTexture()};let Fc=A.createFramebuffer(),Oc=A.createFramebuffer();this.copyTextureToTexture=function(v,N,z=null,k=null,F=0,ee=null){ee===null&&(F!==0?(Yn("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ee=F,F=0):ee=0);let fe,ve,me,Le,De,Ce,We,Qe,ct,st=v.isCompressedTexture?v.mipmaps[ee]:v.image;if(z!==null)fe=z.max.x-z.min.x,ve=z.max.y-z.min.y,me=z.isBox3?z.max.z-z.min.z:1,Le=z.min.x,De=z.min.y,Ce=z.isBox3?z.min.z:0;else{let Bt=Math.pow(2,-F);fe=Math.floor(st.width*Bt),ve=Math.floor(st.height*Bt),v.isDataArrayTexture?me=st.depth:v.isData3DTexture?me=Math.floor(st.depth*Bt):me=1,Le=0,De=0,Ce=0}k!==null?(We=k.x,Qe=k.y,ct=k.z):(We=0,Qe=0,ct=0);let tt=Se.convert(N.format),Pe=Se.convert(N.type),at;N.isData3DTexture?(oe.setTexture3D(N,0),at=A.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(oe.setTexture2DArray(N,0),at=A.TEXTURE_2D_ARRAY):(oe.setTexture2D(N,0),at=A.TEXTURE_2D),A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL,N.flipY),A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),A.pixelStorei(A.UNPACK_ALIGNMENT,N.unpackAlignment);let Ye=A.getParameter(A.UNPACK_ROW_LENGTH),It=A.getParameter(A.UNPACK_IMAGE_HEIGHT),ri=A.getParameter(A.UNPACK_SKIP_PIXELS),Pt=A.getParameter(A.UNPACK_SKIP_ROWS),zi=A.getParameter(A.UNPACK_SKIP_IMAGES);A.pixelStorei(A.UNPACK_ROW_LENGTH,st.width),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,st.height),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Le),A.pixelStorei(A.UNPACK_SKIP_ROWS,De),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Ce);let ot=v.isDataArrayTexture||v.isData3DTexture,Ot=N.isDataArrayTexture||N.isData3DTexture;if(v.isDepthTexture){let Bt=X.get(v),St=X.get(N),wt=X.get(Bt.__renderTarget),xa=X.get(St.__renderTarget);Ee.bindFramebuffer(A.READ_FRAMEBUFFER,wt.__webglFramebuffer),Ee.bindFramebuffer(A.DRAW_FRAMEBUFFER,xa.__webglFramebuffer);for(let Bn=0;Bn<me;Bn++)ot&&(A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,X.get(v).__webglTexture,F,Ce+Bn),A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,X.get(N).__webglTexture,ee,ct+Bn)),A.blitFramebuffer(Le,De,fe,ve,We,Qe,fe,ve,A.DEPTH_BUFFER_BIT,A.NEAREST);Ee.bindFramebuffer(A.READ_FRAMEBUFFER,null),Ee.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else if(F!==0||v.isRenderTargetTexture||X.has(v)){let Bt=X.get(v),St=X.get(N);Ee.bindFramebuffer(A.READ_FRAMEBUFFER,Fc),Ee.bindFramebuffer(A.DRAW_FRAMEBUFFER,Oc);for(let wt=0;wt<me;wt++)ot?A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Bt.__webglTexture,F,Ce+wt):A.framebufferTexture2D(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,Bt.__webglTexture,F),Ot?A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,St.__webglTexture,ee,ct+wt):A.framebufferTexture2D(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,St.__webglTexture,ee),F!==0?A.blitFramebuffer(Le,De,fe,ve,We,Qe,fe,ve,A.COLOR_BUFFER_BIT,A.NEAREST):Ot?A.copyTexSubImage3D(at,ee,We,Qe,ct+wt,Le,De,fe,ve):A.copyTexSubImage2D(at,ee,We,Qe,Le,De,fe,ve);Ee.bindFramebuffer(A.READ_FRAMEBUFFER,null),Ee.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else Ot?v.isDataTexture||v.isData3DTexture?A.texSubImage3D(at,ee,We,Qe,ct,fe,ve,me,tt,Pe,st.data):N.isCompressedArrayTexture?A.compressedTexSubImage3D(at,ee,We,Qe,ct,fe,ve,me,tt,st.data):A.texSubImage3D(at,ee,We,Qe,ct,fe,ve,me,tt,Pe,st):v.isDataTexture?A.texSubImage2D(A.TEXTURE_2D,ee,We,Qe,fe,ve,tt,Pe,st.data):v.isCompressedTexture?A.compressedTexSubImage2D(A.TEXTURE_2D,ee,We,Qe,st.width,st.height,tt,st.data):A.texSubImage2D(A.TEXTURE_2D,ee,We,Qe,fe,ve,tt,Pe,st);A.pixelStorei(A.UNPACK_ROW_LENGTH,Ye),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,It),A.pixelStorei(A.UNPACK_SKIP_PIXELS,ri),A.pixelStorei(A.UNPACK_SKIP_ROWS,Pt),A.pixelStorei(A.UNPACK_SKIP_IMAGES,zi),ee===0&&N.generateMipmaps&&A.generateMipmap(at),Ee.unbindTexture()},this.copyTextureToTexture3D=function(v,N,z=null,k=null,F=0){return Yn('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(v,N,z,k,F)},this.initRenderTarget=function(v){X.get(v).__webglFramebuffer===void 0&&oe.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?oe.setTextureCube(v,0):v.isData3DTexture?oe.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?oe.setTexture2DArray(v,0):oe.setTexture2D(v,0),Ee.unbindTexture()},this.resetState=function(){w=0,I=0,U=null,Ee.reset(),ue.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Xt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=qe._getDrawingBufferColorSpace(e),t.unpackColorSpace=qe._getUnpackColorSpace()}};function Pc(i){if(!i)return()=>{};let e="#e9bd86",t="#56d39a",n=window.matchMedia("(prefers-reduced-motion: reduce)"),s=new Set,r=[],a,o,c,l,h,d,p,f,_,x,m,u=0,T=!1,E=!0,y=!1,R=n.matches,w=0,I=0,U=0,M=0,S=!1,C=null,B=null,O={x:0,y:0},V=[],$=i.dataset.preview||i.closest("[data-preview]")?.dataset.preview,H=new He($==="attention"?t:e),ne=H.clone(),G=performance.now();function ie(X){return s.add(X),X}function ae(X,oe,_e,pe){X.addEventListener(oe,_e,pe),r.push(()=>X.removeEventListener(oe,_e,pe))}function Te(){T||(T=!0,cancelAnimationFrame(u),u=0,x?.disconnect(),m?.disconnect(),r.splice(0).forEach(X=>X()),s.forEach(X=>X.dispose()),s.clear(),a&&(a.domElement.remove(),a.dispose(),a.forceContextLoss()))}function Ne(){i.dataset.robotState="unavailable",i.setAttribute("aria-disabled","true"),i.tabIndex=-1,Te()}function Ge(){T||u||!E||document.hidden||!w||!I||(u=requestAnimationFrame(ce))}function Ze(){document.hidden||!E?(cancelAnimationFrame(u),u=0):(U=0,M=0,Ge())}function Y(X,oe){let _e=(X-G)/1e3,pe=R?1:1-Math.exp(-10*oe),b=R?1:1-Math.exp(-15*oe),g=R?0:Math.sin(_e*1.35)*.011;l.position.x=Jt.lerp(l.position.x,O.x*.055,pe),l.position.y=Jt.lerp(l.position.y,-.3+g,pe),l.rotation.x=Jt.lerp(l.rotation.x,-O.y*.055,pe),l.rotation.y=Jt.lerp(l.rotation.y,-O.x*.11,pe),l.rotation.z=Jt.lerp(l.rotation.z,-O.x*.045,pe),h.rotation.y=Jt.lerp(h.rotation.y,O.x*.39,b),h.rotation.x=Jt.lerp(h.rotation.x,-O.y*.19,b);let L=(_e+1.1)%4.1,W=!R&&!S&&L<.25?Math.max(.075,1-Math.sin(L/.25*Math.PI)):1;V.forEach(J=>{J.normal.visible=!S,J.heart.visible=S,J.group.scale.set(1.1,1.1*W,1.1)}),H.lerp(ne,R?1:1-Math.exp(-7*oe)),p.color.copy(H),f.color.copy(H),f.emissive.copy(H),d.uniforms.color.value.copy(H),_.color.copy(H)}function ce(X){if(u=0,T||!E||document.hidden)return;let oe=1e3/45;if(!R&&M&&X-M<oe-.5){Ge();return}let _e=U?Math.min((X-U)/1e3,.08):1/45;U=X,M=M?X-(X-M)%oe:X;try{Y(X,_e),a.render(o,c),y||(y=!0,i.dataset.robotState="ready")}catch{Ne();return}R||Ge()}function re(){T||(S=!S,i.setAttribute("aria-pressed",String(S)),Ge())}function Ie(){C=null,B=null,O.x=O.y=0,Ge()}function Ae(){if(!C||T)return;let X=i.getBoundingClientRect();if(!X.width||!X.height)return;let oe=X.left+X.width/2,_e=X.top+X.height/2,pe=C.x-oe,b=C.y-_e;O.x=Jt.clamp(pe/Math.max(1,pe<0?oe:window.innerWidth-oe),-1,1),O.y=Jt.clamp(-b/Math.max(1,b<0?_e:window.innerHeight-_e),-1,1),Ge()}function Ue(X){T||X.isPrimary===!1||(B&&X.pointerId===B.id&&Math.hypot(X.clientX-B.x,X.clientY-B.y)>=12&&(B.moved=!0),!(X.pointerType==="touch"&&!i.contains(X.target))&&(C={x:X.clientX,y:X.clientY},Ae()))}function it(){if(T)return;let X=i.getBoundingClientRect();w=Math.round(X.width),I=Math.round(X.height),!(!w||!I)&&(a.setPixelRatio(Math.min(window.devicePixelRatio||1,1.5)),a.setSize(w,I,!1),c.aspect=w/I,c.updateProjectionMatrix(),Ae(),Ge())}function ze(X){return ie(new hs(X))}function A(X,oe,_e,pe,b){let g=new mt(ie(oe),_e);return pe&&g.position.set(...pe),b&&g.rotation.set(...b),X.add(g),g}function Ke(){let X=document.createElement("canvas");X.width=X.height=256;let oe=X.getContext("2d");if(!oe)return null;oe.fillStyle="#f1eade",oe.fillRect(0,0,256,256);let _e=4197,pe=()=>(_e=_e*1664525+1013904223>>>0,_e/4294967296);for(let g=0;g<2400;g+=1)oe.beginPath(),oe.arc(pe()*256,pe()*256,.3+pe()*.6,0,Math.PI*2),oe.fillStyle=pe()>.2?"rgba(78,64,44,.25)":"rgba(255,251,243,.7)",oe.fill();let b=ie(new Ri(X));return b.colorSpace=xt,b.wrapS=b.wrapT=yi,b.repeat.set(4,2),b}function Re(){let X=document.createElement("canvas");X.width=X.height=128;let oe=X.getContext("2d");if(!oe)return;let _e=oe.createRadialGradient(64,64,5,64,64,62);_e.addColorStop(0,"rgba(0,0,0,.64)"),_e.addColorStop(.45,"rgba(0,0,0,.24)"),_e.addColorStop(1,"rgba(0,0,0,0)"),oe.fillStyle=_e,oe.fillRect(0,0,128,128);let pe=ie(new Ri(X)),b=ie(new pn({map:pe,transparent:!0,depthWrite:!1,opacity:.75}));A(o,new Zn(1.35,.9),b,[0,-.744,0],[-Math.PI/2,0,0])}function Xe(X,oe,_e,pe){let b=_e?-1:1,g=new At;g.position.set(oe,0,0),g.scale.setScalar(1.3),X.add(g),A(g,new Cn(.04,.04,.025,24),pe.earBase,null,[0,0,Math.PI/2]),A(g,new Ci(.032,.008,10,24),pe.gold,[b*.012,0,0],[0,Math.PI/2,0]),A(g,new Cn(.025,.025,.006,24),pe.earCenter,[b*.017,0,0],[0,0,Math.PI/2]);let L=new At;L.position.set(b*.015,.035,0),L.rotation.x=-.4,g.add(L),A(L,new Cn(.006,.008,.02,12),pe.gold,[0,.01,0]),A(L,new Cn(.003,.003,.1,8),pe.gold,[0,.06,0]),A(L,new Ln(.008,12,8),f,[0,.11,0])}function Ee(X){let oe=new os,_e=.025,pe=.035,b=.02,g=.005,L=(W,J)=>new D(W,J*X,0);return oe.add(new In(L(-_e,g),L(-_e,pe-b))),oe.add(new Pn(L(-_e,pe-b),L(-_e,pe),L(-_e+b,pe))),oe.add(new In(L(-_e+b,pe),L(_e-b,pe))),oe.add(new Pn(L(_e-b,pe),L(_e,pe),L(_e,pe-b))),oe.add(new In(L(_e,pe-b),L(_e,g))),oe}function et(X,oe,_e,pe,b){let g=new At;g.position.set(X,-.02,.29),g.rotation.y=oe,g.scale.setScalar(1.1),h.add(g);let L=new At;g.add(L),L.add(new mt(_e,p)),L.add(new mt(pe,p));let W=new mt(b,p);W.visible=!1,g.add(W),V.push({group:g,normal:L,heart:W})}try{i.dataset.robotState="loading",i.setAttribute("aria-pressed","false"),a=new ma({alpha:!0,antialias:!0,powerPreference:"low-power"}),a.outputColorSpace=xt,a.toneMapping=Rr,a.toneMappingExposure=1.12,a.setClearColor(0,0);let X=a.domElement;X.className="robot-canvas research-robot-canvas",X.setAttribute("aria-hidden","true"),Object.assign(X.style,{position:"absolute",inset:"0",width:"100%",height:"100%",display:"block",pointerEvents:"none"}),i.prepend(X),ae(X,"webglcontextlost",Q=>{Q.preventDefault(),Ne()}),o=new ss,c=new vt(34,1,.1,20),c.position.set(0,.045,2.82),c.lookAt(0,-.055,0),o.add(new fs("#fff0d8","#504938",1.1));let oe=new Kn("#ffe8c6",2.6);oe.position.set(3,4,5),o.add(oe);let _e=new Kn("#fff4e3",1.35);_e.position.set(-3,1,3),o.add(_e);let pe=new Kn("#e9bd86",3.1);pe.position.set(-1,3,-3),o.add(pe);let b=Ke(),g=ze({color:"#d8ccb8",map:b,roughness:.52,metalness:.1}),L={gold:ze({color:"#b49a72",roughness:.31,metalness:.54}),earBase:ze({color:"#c9bda9",roughness:.43,metalness:.24}),earCenter:ze({color:"#75654e",roughness:.65,metalness:.24})};p=ie(new pn({color:H,toneMapped:!1})),f=ze({color:H,emissive:H,emissiveIntensity:.4,roughness:.28,metalness:.2}),_=ie(new pn({color:H,transparent:!0,opacity:.09,depthWrite:!1,toneMapped:!1})),d=ie(new Nt({uniforms:{color:{value:H.clone()},power:{value:3.8},intensity:{value:.55}},transparent:!0,blending:ms,depthWrite:!1,vertexShader:`
        varying vec3 vNormal;
        varying vec3 vViewPosition;
        void main() {
      ...
      `})),l=new At,l.position.y=-.3,o.add(l),A(l,new Ln(.43,48,32,0,Math.PI*2,Math.PI*.15,Math.PI*.85),g),A(l,new Ci(.235,.025,12,48),L.gold,[0,.34,0],[Math.PI/2,0,0]);let W=[[.1,-.05],[.215,-.05],[.28,.02],[.295,.045],[.27,.055],[.1,.055],[.1,.055]].map(([Q,K])=>new be(Q,K));A(l,new ls(W,48),L.gold,[0,.38,0]),h=new At,h.position.y=.6,l.add(h);let J=ze({color:"#101110",roughness:.36,metalness:.16});A(h,new Ln(.28,48,32),J),A(h,new Ln(.3,48,32),d);class q extends Et{getPoint(K,he=new D){let we=K*Math.PI*2,Se=16*Math.pow(Math.sin(we),3),ue=13*Math.cos(we)-5*Math.cos(2*we)-2*Math.cos(3*we)-Math.cos(4*we);return he.set(Se*.002,(ue+6)*.002,0)}}let Me=ie(new Jn(Ee(1),20,.0042,8,!1)),se=ie(new Jn(Ee(-1),20,.0042,8,!1)),xe=ie(new Jn(new q,48,.0038,8,!0));et(-.07,-.2,Me,se,xe),et(.07,.2,Me,se,xe),Xe(h,-.29,!0,L),Xe(h,.29,!1,L),A(o,new cs(.37,.375,72),_,[0,-.741,0],[-Math.PI/2,0,0]),Re(),ae(document,"pointermove",Ue,{passive:!0,capture:!0}),ae(document,"pointerleave",Ie,{passive:!0}),ae(window,"blur",Ie),ae(window,"scroll",Ae,{passive:!0,capture:!0}),ae(i,"pointerleave",()=>{B=null},{passive:!0}),ae(i,"pointerdown",Q=>{Q.button!==0||Q.isPrimary===!1||Q.target.closest?.("a, button, input, select")||(Ue(Q),B={id:Q.pointerId,x:Q.clientX,y:Q.clientY,at:performance.now(),moved:!1})},{passive:!0}),ae(i,"pointerup",Q=>{if(!B||B.id!==Q.pointerId)return;let K=i.getBoundingClientRect(),he=Q.clientX>=K.left&&Q.clientX<=K.right&&Q.clientY>=K.top&&Q.clientY<=K.bottom,we=Math.hypot(Q.clientX-B.x,Q.clientY-B.y);he&&!B.moved&&we<12&&performance.now()-B.at<700&&re(),B=null},{passive:!0}),ae(i,"pointercancel",()=>{B=null},{passive:!0}),ae(i,"keydown",Q=>{Q.target.closest?.("a, button, input, select")&&Q.target!==i||(Q.key==="Enter"||Q.key===" "?(Q.preventDefault(),Q.repeat||re()):Q.key.startsWith("Arrow")?(Q.preventDefault(),Q.key==="ArrowLeft"&&(O.x=Math.max(-1,O.x-.35)),Q.key==="ArrowRight"&&(O.x=Math.min(1,O.x+.35)),Q.key==="ArrowUp"&&(O.y=Math.min(1,O.y+.35)),Q.key==="ArrowDown"&&(O.y=Math.max(-1,O.y-.35)),Ge()):Q.key==="Escape"&&(O.x=O.y=0,Ge()))}),ae(i,"research-preview-change",Q=>{ne.set(Q.detail?.preview==="attention"?t:e),Ge()}),ae(n,"change",()=>{R=n.matches,U=0,Ge()}),ae(document,"visibilitychange",Ze),ae(window,"resize",it,{passive:!0}),"ResizeObserver"in window&&(x=new ResizeObserver(it),x.observe(i)),"IntersectionObserver"in window&&(m=new IntersectionObserver(Q=>{E=Q[0]?.isIntersecting??!0,Ze()},{rootMargin:"80px"}),m.observe(i)),it()}catch{Ne()}return()=>{Te(),i.dataset.robotState="unavailable"}}var mm=document.getElementById("research-robot"),gm=Pc(mm);window.addEventListener("pagehide",i=>{i.persisted||gm()},{once:!0});
