# Backer Research robot entry

Requested September 6, 2026. Publish to the existing GitHub Pages research.html route.

## Experience

- Shared desktop and mobile Backer Research menu entries navigate directly to research.html. Remove the Attention Observatory submenu.
- Apply the requested palette redesign: warm ivory body, graphite face, champagne details, gold eyes and muted green attention mode.
...
- Show the exact labels: `01 / Trading Behavior Research Preview` and `02 / Human Attention Attention Prediction Preview`.
...
- Pointer tracking stays within the central area; touch and keyboard can trigger a robot response. Reduced-motion and unavailable WebGL retain working preview navigation.
- Desktop and mobile show readable labels, clear focus/selection states and no horizontal overflow.
